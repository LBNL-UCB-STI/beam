...
case class UberHourSpeed(hour: Int, speedMean: Float, speedAvg: Float, maxDev: Float)case class UberHourSpeed(hour: Int, speedMean: Float, speedAvg: Float, maxDev: Float)
