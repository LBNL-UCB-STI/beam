...
gradle deploy -PbeamConfigs=production/sfbay/base.conf -PbeamCommit=d0de374f3c9498c470a064de3b791dd548812a44 -Pbatch=false -PrunName=baselineCongestionForUrbansimTeam -PdeployMode=config
