...
object AddExcludedModes extends App with LazyLogging {
  val reader = IOUtils.getBufferedReader("/home/crixal/Downloads/sfbay/population.csv.gz")
  val writer = IOUtils.getBufferedWriter("/home/crixal/Downloads/sfbay/population_new.csv.gz")
