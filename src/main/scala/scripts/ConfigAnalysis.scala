...
./gradlew :execute -PmainClass=scripts.ConfigAnalysis -PappArgs="['test/input/beamville','src/main/resources/beam-template.conf']"
or
./gradlew :execute -PmainClass=scripts.ConfigAnalysis -PappArgs="['test/input/beamville','src/main/resources/beam-template.conf', '2']"
 */
