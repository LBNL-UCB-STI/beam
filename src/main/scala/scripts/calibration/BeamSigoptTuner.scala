package scripts.calibration

import scripts.experiment.{ExperimentDef, Factor, Level}
import beam.utils.OptionalUtils.JavaOptionals.toRichOptional
import com.google.common.collect.Lists
import com.sigopt.Sigopt
import com.sigopt.exception.SigoptException
import com.sigopt.model.{Client, Experiment, Parameter}
import scripts.calibration.Bounded.getBounds
