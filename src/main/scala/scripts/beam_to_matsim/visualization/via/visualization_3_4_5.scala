...
import scripts.beam_to_matsim.events_filter.{MutableSamplingFilter, MutableVehiclesFilter, VehicleSample}
import scripts.beam_to_matsim.io.{HashSetReader, Reader, Writer}
import scripts.beam_to_matsim.via_event.ViaEvent

object visualization_3_4_5 extends App {
  ...
  val viaOutputBaseFilePath = "D:/Work/BEAM/visualizations/v3_4_5.it20.events.bridge_cap_5000.half.popSize" + sampleSize
