...
x0,y0 .___________. x1, y0
    ...
    val envelopePoints = Array[GpxPoint](
      map.GpxPoint("x0,y0", new Coord(envelope.getMinX, envelope.getMinY)),
      map.GpxPoint("x0,y1", new Coord(envelope.getMinX, envelope.getMaxY)),
      map.GpxPoint("x1,y1", new Coord(envelope.getMaxX, envelope.getMaxY)),
      map.GpxPoint("x1,y0", new Coord(envelope.getMaxX, envelope.getMinY))
    )
