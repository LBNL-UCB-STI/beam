...
import scripts.map.R5NetworkPlayground.prepareConfig
...
object TazTravelTimeAnalyzer extends LazyLogging {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val tazTreeMap: TAZTreeMap = TAZTreeMap.getTazTreeMap(beamConfig.beam.agentsim.taz.filePath, geoUtils.localCRS)
