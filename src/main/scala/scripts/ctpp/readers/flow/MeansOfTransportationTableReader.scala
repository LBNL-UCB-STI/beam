...
import scripts.ctpp.models.{FlowGeoParser, MeansOfTransportation, OD, ResidenceToWorkplaceFlowGeography}
import scripts.ctpp.readers.BaseTableReader
import scripts.ctpp.readers.BaseTableReader.CTPPDatabaseInfo
import scripts.ctpp.readers.BaseTableReader.Table.Flow.MeanOfTransportation
...
) extends BaseTableReader(dbInfo, MeanOfTransportation, Some(residenceToWorkplaceFlowGeography.level)) {
