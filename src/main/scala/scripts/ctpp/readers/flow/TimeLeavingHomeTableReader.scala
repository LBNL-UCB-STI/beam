...
import scripts.ctpp.readers.BaseTableReader.Table.Flow.TimeLeavingHome
...
) extends BaseTableReader(dbInfo, TimeLeavingHome, Some(residenceToWorkplaceFlowGeography.level)) {
  /*
