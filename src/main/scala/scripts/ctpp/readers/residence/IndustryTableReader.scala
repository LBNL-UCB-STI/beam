...
import scripts.ctpp.models.{ResidenceGeography, ResidentialGeoParser}
import scripts.ctpp.readers.BaseTableReader
import scripts.ctpp.readers.BaseTableReader.CTPPDatabaseInfo
import scripts.ctpp.readers.BaseTableReader.Table.Residence.OccupationByIndustry
