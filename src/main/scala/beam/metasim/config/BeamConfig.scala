// generated by tscfg 0.8.0 on Wed Feb 22 00:04:05 PST 2017
// source: src/main/resources/config-main.conf

package beam.metasim.config

case class BeamConfig(
  BEAM_OUTPUTS       : java.lang.String,
  BEAM_SHARED_INPUTS : java.lang.String,
...
object BeamConfig {
  ...
  def apply(c: com.typesafe.config.Config): BeamConfig = {
    BeamConfig(
      BEAM_OUTPUTS       = if(c.hasPathOrNull("BEAM_OUTPUTS")) c.getString("BEAM_OUTPUTS") else "/Users/sfeygin/remote_files/beam_outputs/",
      BEAM_SHARED_INPUTS = if(c.hasPathOrNull("BEAM_SHARED_INPUTS")) c.getString("BEAM_SHARED_INPUTS") else "/Users/sfeygin/remote_files/beam_inputs/",
