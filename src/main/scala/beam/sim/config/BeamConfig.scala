// generated by tscfg 0.8.1 on Wed Sep 20 21:18:37 PDT 2017
...
object BeamConfig {
    ...
    object Outputs {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Outputs = {
        BeamConfig.Beam.Outputs(
          defaultLoggingLevel     = if(c.hasPathOrNull("defaultLoggingLevel")) c.getString("defaultLoggingLevel") else "SHORT",
      ...
      object R5 {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing.R5 = {
          BeamConfig.Beam.Routing.R5(
            ...
            directory       = if(c.hasPathOrNull("directory")) c.getString("directory") else "/Users/critter/Dropbox/ucb/vto/beam-all/beam/test/input/beam-developers/model-inputs/r5",
            osmFile         = if(c.hasPathOrNull("osmFile")) c.getString("osmFile") else "/Users/critter/Dropbox/ucb/vto/beam-all/beam/test/input/beam-developers/model-inputs/r5/bay_area_all_roads.osm.pbf",
            osmMapdbFile    = if(c.hasPathOrNull("osmMapdbFile")) c.getString("osmMapdbFile") else "/Users/critter/Dropbox/ucb/vto/beam-all/beam/test/input/beam-developers/model-inputs/r5/osm.mapdb"
          )
        }
      }
  ...
  case class Matsim(
    levels  : BeamConfig.Matsim.Levels,
    modules : BeamConfig.Matsim.Modules
  )
  object Matsim {
    case class Levels(
      dependencyLoggingLevel : java.lang.String
    )
    object Levels {
      def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Levels = {
        BeamConfig.Matsim.Levels(
          dependencyLoggingLevel = if(c.hasPathOrNull("dependencyLoggingLevel")) c.getString("dependencyLoggingLevel") else ""
        )
      }
    }
    ...
    def apply(c: com.typesafe.config.Config): BeamConfig.Matsim = {
      BeamConfig.Matsim(
        levels  = BeamConfig.Matsim.Levels(c.getConfig("levels")),
  ...
  case class R5(
    packages : scala.List[java.lang.String]
  )
  object R5 {
    def apply(c: com.typesafe.config.Config): BeamConfig.R5 = {
      BeamConfig.R5(
        packages = $_L$_str(c.getList("packages"))
      )
    }
  }
  ...
  def apply(c: com.typesafe.config.Config): BeamConfig = {
    BeamConfig(
      ...
      r5                = BeamConfig.R5(c.getConfig("r5"))
    )
  }
}
