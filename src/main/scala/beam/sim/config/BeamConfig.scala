// generated by tscfg 0.9.4 on Mon Jul 15 16:36:33 EDT 2019
    ...
    object Agentsim {
      ...
      object Agents {
        ...
        case class RideHail(
          ...
          mnl: BeamConfig.Beam.Agentsim.Agents.RideHail.Mnl,
        ...
        object RideHail {
          ...
          object Mnl {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Mnl = {
              BeamConfig.Beam.Agentsim.Agents.RideHail.Mnl(
                beta1 = if (c.hasPathOrNull("beta1")) c.getInt("beta1") else 1,
                beta2 = if (c.hasPathOrNull("beta2")) c.getInt("beta2") else 1,
                beta3 = if (c.hasPathOrNull("beta3")) c.getDouble("beta3") else 0.001
              )
            }
          }
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail = {
            BeamConfig.Beam.Agentsim.Agents.RideHail(
              ...
              mnl = BeamConfig.Beam.Agentsim.Agents.RideHail.Mnl(
                if (c.hasPathOrNull("mnl")) c.getConfig("mnl")
                else com.typesafe.config.ConfigFactory.parseString("mnl{}")
              ),
