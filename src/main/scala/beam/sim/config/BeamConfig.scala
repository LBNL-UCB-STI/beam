// generated by tscfg 0.9.4 on Sat Apr 18 12:37:28 CDT 2020
    ...
    object Agentsim {
          ...
          object MulitnomialLogit {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.TripBehaviors.MulitnomialLogit = {
              BeamConfig.Beam.Agentsim.Agents.TripBehaviors.MulitnomialLogit(
                activity_file_path              = if(c.hasPathOrNull("activity_file_path")) c.getString("activity_file_path") else "/test/input/beamville/activity-params.csv",
                ...
                generate_secondary_activities   = if(c.hasPathOrNull("generate_secondary_activities")) c.getString("generate_secondary_activities") else "false",
                intercept_file_path             = if(c.hasPathOrNull("intercept_file_path")) c.getString("intercept_file_path") else "/test/input/beamville/activity-intercepts.csv",
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim = {
        BeamConfig.Beam.Agentsim(
          ...
          collectEventsIntervalInSeconds          = if(c.hasPathOrNull("collectEventsIntervalInSeconds")) c.getInt("collectEventsIntervalInSeconds") else 300,
