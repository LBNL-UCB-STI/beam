    ...
    object Agentsim {
      ...
      object Taz {
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Taz = {
          BeamConfig.Beam.Agentsim.Taz(
            ...
            parking =
              if (c.hasPathOrNull("parking")) c.getString("parking")
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim = {
        BeamConfig.Beam.Agentsim(
          ...
          scheduler = BeamConfig.Beam.Agentsim.Scheduler(
            if (c.hasPathOrNull("scheduler")) c.getConfig("scheduler")
            else com.typesafe.config.ConfigFactory.parseString("scheduler{}")
          ),
          simulationName =
    ...
    object Conversion {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Conversion = {
        BeamConfig.Matsim.Conversion(
          ...
          generateVehicles = !c.hasPathOrNull("generateVehicles") || c.getBoolean(
            "generateVehicles"
          ),
          matsimNetworkFile =
