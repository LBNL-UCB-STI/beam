// generated by tscfg 0.9.4 on Tue Jun 09 12:20:02 MSK 2020
...
object BeamConfig {
  ...
  object Beam {
    ...
    object Calibration {
      ...
      case class Google(
        apiKey: scala.Option[java.lang.String],
      ...
      object Google {
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Calibration.Google = {
          BeamConfig.Beam.Calibration.Google(
            apiKey = if (c.hasPathOrNull("apiKey")) Some(c.getString("apiKey")) else None,
            travelTimes = BeamConfig.Beam.Calibration.Google.TravelTimes(
