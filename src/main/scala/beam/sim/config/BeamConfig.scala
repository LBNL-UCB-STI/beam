        ...
        object TravelTimes {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Calibration.RoadNetwork.TravelTimes = {
            BeamConfig.Beam.Calibration.RoadNetwork.TravelTimes(
              benchmarkFileAggregates =
                if (c.hasPathOrNull("benchmarkFileAggregates")) c.getString("benchmarkFileAggregates") else "",
              benchmarkFileCensustracts =
                if (c.hasPathOrNull("benchmarkFileCensustracts")) c.getString("benchmarkFileCensustracts") else "",
