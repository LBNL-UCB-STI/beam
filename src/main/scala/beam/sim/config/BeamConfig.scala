// generated by tscfg 0.9.4 on Tue Feb 25 19:31:29 IST 2020
  ...
  object Beam {
    ...
    object Agentsim {
      ...
      object Agents {
        ...
        case class Vehicles(
          collectChargingEvents: scala.Boolean,
          collectChargingEventsIntervalInSeconds: scala.Int,
        ...
        object Vehicles {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles = {
            BeamConfig.Beam.Agentsim.Agents.Vehicles(
              collectChargingEvents = !c.hasPathOrNull("collectChargingEvents") || c.getBoolean(
                "collectChargingEvents"
              ),
              collectChargingEventsIntervalInSeconds =
                if (c.hasPathOrNull("collectChargingEventsIntervalInSeconds"))
                  c.getInt("collectChargingEventsIntervalInSeconds")
                else 300,
              downsamplingMethod =
