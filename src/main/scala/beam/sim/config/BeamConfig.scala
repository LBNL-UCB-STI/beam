  ...
  object Beam {
    ...
    object Agentsim {
      ...
      object Agents {
        ...
        object Activities {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Activities = {
            BeamConfig.Beam.Agentsim.Agents.Activities(
              activityTypeToFixedDurationMap = if(c.hasPathOrNull("activityTypeToFixedDurationMap")) scala.Some($_L$_str(c.getList("activityTypeToFixedDurationMap"))) else None
            )
          }
        }
        ...
        object Freight {
          ...
          object Replanning {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Freight.Replanning = {
              BeamConfig.Beam.Agentsim.Agents.Freight.Replanning(
                ...
                disableAfterIteration = if(c.hasPathOrNull("disableAfterIteration")) c.getInt("disableAfterIteration") else -1,
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Freight = {
            BeamConfig.Beam.Agentsim.Agents.Freight(
              ...
              carriersFilePath                 = if(c.hasPathOrNull("carriersFilePath")) c.getString("carriersFilePath") else "/test/input/beamville/freight/freight-carriers.csv",
              enabled                          = c.hasPathOrNull("enabled") && c.getBoolean("enabled"),
              generateFixedActivitiesDurations = c.hasPathOrNull("generateFixedActivitiesDurations") && c.getBoolean("generateFixedActivitiesDurations"),
              isWgs                            = c.hasPathOrNull("isWgs") && c.getBoolean("isWgs"),
              name                             = if(c.hasPathOrNull("name")) c.getString("name") else "Freight",
              plansFilePath                    = if(c.hasPathOrNull("plansFilePath")) c.getString("plansFilePath") else "/test/input/beamville/freight/payload-plans.csv",
              reader                           = if(c.hasPathOrNull("reader")) c.getString("reader") else "Generic",
              replanning                       = BeamConfig.Beam.Agentsim.Agents.Freight.Replanning(if(c.hasPathOrNull("replanning")) c.getConfig("replanning") else com.typesafe.config.ConfigFactory.parseString("replanning{}")),
              tourSampleSizeAsFractionOfTotal  = if(c.hasPathOrNull("tourSampleSizeAsFractionOfTotal")) c.getDouble("tourSampleSizeAsFractionOfTotal") else 1.0,
              toursFilePath                    = if(c.hasPathOrNull("toursFilePath")) c.getString("toursFilePath") else "/test/input/beamville/freight/freight-tours.csv",
              vehicleTypesFilePath             = if(c.hasPathOrNull("vehicleTypesFilePath")) Some(c.getString("vehicleTypesFilePath")) else None
            )
          }
        }
        ...
        object Households {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Households = {
            BeamConfig.Beam.Agentsim.Agents.Households(
              inputFilePath                    = if(c.hasPathOrNull("inputFilePath")) c.getString("inputFilePath") else "/test/input/beamville/households.xml.gz",
              inputHouseholdAttributesFilePath = if(c.hasPathOrNull("inputHouseholdAttributesFilePath")) c.getString("inputHouseholdAttributesFilePath") else "/test/input/beamville/householdAttributes.xml.gz"
            )
          }
        }
        ...
        object ModalBehaviors {
          ...
          object BikeMultiplier {
            ...
            object Commute {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.BikeMultiplier.Commute = {
            ...
            object Noncommute {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.BikeMultiplier.Noncommute = {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.BikeMultiplier = {
              BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.BikeMultiplier(
                ...
                noncommute = BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.BikeMultiplier.Noncommute(if(c.hasPathOrNull("noncommute")) c.getConfig("noncommute") else com.typesafe.config.ConfigFactory.parseString("noncommute{}"))
              )
            }
          }
          ...
          object HighTimeSensitivity {
            ...
            object HighCongestion {
              ...
              object HighwayFactor {
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.HighTimeSensitivity.HighCongestion.HighwayFactor = {
              ...
              object NonHighwayFactor {
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.HighTimeSensitivity.HighCongestion.NonHighwayFactor = {
              ...
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.HighTimeSensitivity.HighCongestion = {
                BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.HighTimeSensitivity.HighCongestion(
                  ...
                  nonHighwayFactor = BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.HighTimeSensitivity.HighCongestion.NonHighwayFactor(if(c.hasPathOrNull("nonHighwayFactor")) c.getConfig("nonHighwayFactor") else com.typesafe.config.ConfigFactory.parseString("nonHighwayFactor{}"))
                )
              }
            }
            ...
            object LowCongestion {
              ...
              object HighwayFactor {
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.HighTimeSensitivity.LowCongestion.HighwayFactor = {
              ...
              object NonHighwayFactor {
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.HighTimeSensitivity.LowCongestion.NonHighwayFactor = {
              ...
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.HighTimeSensitivity.LowCongestion = {
                BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.HighTimeSensitivity.LowCongestion(
                  ...
                  nonHighwayFactor = BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.HighTimeSensitivity.LowCongestion.NonHighwayFactor(if(c.hasPathOrNull("nonHighwayFactor")) c.getConfig("nonHighwayFactor") else com.typesafe.config.ConfigFactory.parseString("nonHighwayFactor{}"))
                )
              }
            }
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.HighTimeSensitivity = {
              BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.HighTimeSensitivity(
                ...
                lowCongestion  = BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.HighTimeSensitivity.LowCongestion(if(c.hasPathOrNull("lowCongestion")) c.getConfig("lowCongestion") else com.typesafe.config.ConfigFactory.parseString("lowCongestion{}"))
              )
            }
          }
          ...
          object Lccm {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.Lccm = {
              BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.Lccm(
                filePath = if(c.hasPathOrNull("filePath")) c.getString("filePath") else "/test/input/beamville/lccm-long.csv"
              )
            }
          }
          ...
          object LowTimeSensitivity {
            ...
            object HighCongestion {
              ...
              object HighwayFactor {
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.LowTimeSensitivity.HighCongestion.HighwayFactor = {
              ...
              object NonHighwayFactor {
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.LowTimeSensitivity.HighCongestion.NonHighwayFactor = {
              ...
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.LowTimeSensitivity.HighCongestion = {
                BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.LowTimeSensitivity.HighCongestion(
                  ...
                  nonHighwayFactor = BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.LowTimeSensitivity.HighCongestion.NonHighwayFactor(if(c.hasPathOrNull("nonHighwayFactor")) c.getConfig("nonHighwayFactor") else com.typesafe.config.ConfigFactory.parseString("nonHighwayFactor{}"))
                )
              }
            }
            ...
            object LowCongestion {
              ...
              object HighwayFactor {
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.LowTimeSensitivity.LowCongestion.HighwayFactor = {
              ...
              object NonHighwayFactor {
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.LowTimeSensitivity.LowCongestion.NonHighwayFactor = {
              ...
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.LowTimeSensitivity.LowCongestion = {
                BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.LowTimeSensitivity.LowCongestion(
                  ...
                  nonHighwayFactor = BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.LowTimeSensitivity.LowCongestion.NonHighwayFactor(if(c.hasPathOrNull("nonHighwayFactor")) c.getConfig("nonHighwayFactor") else com.typesafe.config.ConfigFactory.parseString("nonHighwayFactor{}"))
                )
              }
            }
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.LowTimeSensitivity = {
              BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.LowTimeSensitivity(
                ...
                lowCongestion  = BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.LowTimeSensitivity.LowCongestion(if(c.hasPathOrNull("lowCongestion")) c.getConfig("lowCongestion") else com.typesafe.config.ConfigFactory.parseString("lowCongestion{}"))
              )
            }
          }
          ...
          object ModeVotMultiplier {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.ModeVotMultiplier = {
          ...
          object MultinomialLogit {
            ...
            object Params {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.MultinomialLogit.Params = {
                BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.MultinomialLogit.Params(
                  ...
                  bike_transit_intercept          = if(c.hasPathOrNull("bike_transit_intercept")) c.getDouble("bike_transit_intercept") else 0.0,
                  ...
                  ride_hail_intercept             = if(c.hasPathOrNull("ride_hail_intercept")) c.getDouble("ride_hail_intercept") else 0.0,
                  ride_hail_pooled_intercept      = if(c.hasPathOrNull("ride_hail_pooled_intercept")) c.getDouble("ride_hail_pooled_intercept") else 0.0,
                  ...
                  transit_crowding_VOT_multiplier = if(c.hasPathOrNull("transit_crowding_VOT_multiplier")) c.getDouble("transit_crowding_VOT_multiplier") else 0.0,
                  transit_crowding_VOT_threshold  = if(c.hasPathOrNull("transit_crowding_VOT_threshold")) c.getDouble("transit_crowding_VOT_threshold") else 0.5,
                  transit_crowding_percentile     = if(c.hasPathOrNull("transit_crowding_percentile")) c.getDouble("transit_crowding_percentile") else 90.0,
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.MultinomialLogit = {
              BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.MultinomialLogit(
                ...
                utility_scale_factor = if(c.hasPathOrNull("utility_scale_factor")) c.getDouble("utility_scale_factor") else 1.0
              )
            }
          }
          ...
          object PoolingMultiplier {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.PoolingMultiplier = {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors = {
            BeamConfig.Beam.Agentsim.Agents.ModalBehaviors(
              ...
              highTimeSensitivity               = BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.HighTimeSensitivity(if(c.hasPathOrNull("highTimeSensitivity")) c.getConfig("highTimeSensitivity") else com.typesafe.config.ConfigFactory.parseString("highTimeSensitivity{}")),
              ...
              lowTimeSensitivity                = BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.LowTimeSensitivity(if(c.hasPathOrNull("lowTimeSensitivity")) c.getConfig("lowTimeSensitivity") else com.typesafe.config.ConfigFactory.parseString("lowTimeSensitivity{}")),
              maximumNumberOfReplanningAttempts = if(c.hasPathOrNull("maximumNumberOfReplanningAttempts")) c.getInt("maximumNumberOfReplanningAttempts") else 3,
              minimumValueOfTime                = if(c.hasPathOrNull("minimumValueOfTime")) c.getDouble("minimumValueOfTime") else 7.25,
              modeChoiceClass                   = if(c.hasPathOrNull("modeChoiceClass")) c.getString("modeChoiceClass") else "ModeChoiceMultinomialLogit",
              modeVotMultiplier                 = BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.ModeVotMultiplier(if(c.hasPathOrNull("modeVotMultiplier")) c.getConfig("modeVotMultiplier") else com.typesafe.config.ConfigFactory.parseString("modeVotMultiplier{}")),
              multinomialLogit                  = BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.MultinomialLogit(if(c.hasPathOrNull("multinomialLogit")) c.getConfig("multinomialLogit") else com.typesafe.config.ConfigFactory.parseString("multinomialLogit{}")),
              overrideAutomationForVOTT         = c.hasPathOrNull("overrideAutomationForVOTT") && c.getBoolean("overrideAutomationForVOTT"),
              overrideAutomationLevel           = if(c.hasPathOrNull("overrideAutomationLevel")) c.getInt("overrideAutomationLevel") else 1,
              poolingMultiplier                 = BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.PoolingMultiplier(if(c.hasPathOrNull("poolingMultiplier")) c.getConfig("poolingMultiplier") else com.typesafe.config.ConfigFactory.parseString("poolingMultiplier{}")),
              transitVehicleTypeVOTMultipliers  = if(c.hasPathOrNull("transitVehicleTypeVOTMultipliers")) scala.Some($_L$_str(c.getList("transitVehicleTypeVOTMultipliers"))) else None
            )
          }
        }
        ...
        case class Parking(
          ...
          search                                        : BeamConfig.Beam.Agentsim.Agents.Parking.Search
        )
        object Parking {
          case class MultinomialLogit(
          ...
          object MultinomialLogit {
            ...
            object Params {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Parking.MultinomialLogit.Params = {
                BeamConfig.Beam.Agentsim.Agents.Parking.MultinomialLogit.Params(
                  distanceMultiplier              = if(c.hasPathOrNull("distanceMultiplier")) c.getDouble("distanceMultiplier") else -0.086,
                  enrouteDetourMultiplier         = if(c.hasPathOrNull("enrouteDetourMultiplier")) c.getDouble("enrouteDetourMultiplier") else -0.05,
                  parkingPriceMultiplier          = if(c.hasPathOrNull("parkingPriceMultiplier")) c.getDouble("parkingPriceMultiplier") else -0.005,
                  parkingTypePreferenceMultiplier = if(c.hasPathOrNull("parkingTypePreferenceMultiplier")) c.getDouble("parkingTypePreferenceMultiplier") else 1.0,
                  rangeAnxietyMultiplier          = if(c.hasPathOrNull("rangeAnxietyMultiplier")) c.getDouble("rangeAnxietyMultiplier") else -0.5
                )
              }
            }
          ...
          case class Search(
            params : BeamConfig.Beam.Agentsim.Agents.Parking.Search.Params
          )
          object Search {
            case class Params(
            ...
            object Params {
              ...
              object Freight {
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Parking.Search.Params.Freight = {
                  BeamConfig.Beam.Agentsim.Agents.Parking.Search.Params.Freight(
                    maxSearchRadius = if(c.hasPathOrNull("maxSearchRadius")) c.getDouble("maxSearchRadius") else 2000.00,
              ...
              object Passenger {
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Parking.Search.Params.Passenger = {
                  BeamConfig.Beam.Agentsim.Agents.Parking.Search.Params.Passenger(
              ...
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Parking.Search.Params = {
                BeamConfig.Beam.Agentsim.Agents.Parking.Search.Params(
                  enableLinkBasedSearch                  = c.hasPathOrNull("enableLinkBasedSearch") && c.getBoolean("enableLinkBasedSearch"),
                  freight                                = BeamConfig.Beam.Agentsim.Agents.Parking.Search.Params.Freight(if(c.hasPathOrNull("freight")) c.getConfig("freight") else com.typesafe.config.ConfigFactory.parseString("freight{}")),
                  passenger                              = BeamConfig.Beam.Agentsim.Agents.Parking.Search.Params.Passenger(if(c.hasPathOrNull("passenger")) c.getConfig("passenger") else com.typesafe.config.ConfigFactory.parseString("passenger{}")),
                  searchDoubleParkingRadius              = if(c.hasPathOrNull("searchDoubleParkingRadius")) c.getDouble("searchDoubleParkingRadius") else 0.0,
                  searchMaxDistanceRelativeToEllipseFoci = if(c.hasPathOrNull("searchMaxDistanceRelativeToEllipseFoci")) c.getDouble("searchMaxDistanceRelativeToEllipseFoci") else 4.0,
                  searchSampleSize                       = if(c.hasPathOrNull("searchSampleSize")) c.getInt("searchSampleSize") else 5000
                )
              }
            }
                  
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Parking.Search = {
              BeamConfig.Beam.Agentsim.Agents.Parking.Search(
                params = BeamConfig.Beam.Agentsim.Agents.Parking.Search.Params(if(c.hasPathOrNull("params")) c.getConfig("params") else com.typesafe.config.ConfigFactory.parseString("params{}"))
              )
            }
          }
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Parking = {
            BeamConfig.Beam.Agentsim.Agents.Parking(
              estimatedMeanEnRouteChargingDurationInSeconds = if(c.hasPathOrNull("estimatedMeanEnRouteChargingDurationInSeconds")) c.getDouble("estimatedMeanEnRouteChargingDurationInSeconds") else 1800.0,
              estimatedMinParkingDurationInSeconds          = if(c.hasPathOrNull("estimatedMinParkingDurationInSeconds")) c.getDouble("estimatedMinParkingDurationInSeconds") else 60.0,
              fractionOfSameTypeZones                       = if(c.hasPathOrNull("fractionOfSameTypeZones")) c.getDouble("fractionOfSameTypeZones") else 0.5,
              minNumberOfSameTypeZones                      = if(c.hasPathOrNull("minNumberOfSameTypeZones")) c.getInt("minNumberOfSameTypeZones") else 10,
              multinomialLogit                              = BeamConfig.Beam.Agentsim.Agents.Parking.MultinomialLogit(if(c.hasPathOrNull("multinomialLogit")) c.getConfig("multinomialLogit") else com.typesafe.config.ConfigFactory.parseString("multinomialLogit{}")),
              rangeAnxietyBuffer                            = if(c.hasPathOrNull("rangeAnxietyBuffer")) c.getDouble("rangeAnxietyBuffer") else 20000.0,
              search                                        = BeamConfig.Beam.Agentsim.Agents.Parking.Search(if(c.hasPathOrNull("search")) c.getConfig("search") else com.typesafe.config.ConfigFactory.parseString("search{}"))
            )
          }
        }
        ...
        object Plans {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Plans = {
            BeamConfig.Beam.Agentsim.Agents.Plans(
              ...
              inputPlansFilePath            = if(c.hasPathOrNull("inputPlansFilePath")) c.getString("inputPlansFilePath") else "/test/input/beamville/population.xml.gz",
              merge                         = BeamConfig.Beam.Agentsim.Agents.Plans.Merge(if(c.hasPathOrNull("merge")) c.getConfig("merge") else com.typesafe.config.ConfigFactory.parseString("merge{}"))
            )
          }
        }
        ...
        object Population {
          ...
          object IndustryRemovalProbabilty {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Population.IndustryRemovalProbabilty = {
              BeamConfig.Beam.Agentsim.Agents.Population.IndustryRemovalProbabilty(
                ...
                removalStrategy = if(c.hasPathOrNull("removalStrategy")) c.getString("removalStrategy") else "RemovePersonFromScenario"
              )
            }
          }
        ...
        object RideHail {
          ...
          object Cav {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Cav = {
              BeamConfig.Beam.Agentsim.Agents.RideHail.Cav(
                noRefuelThresholdInMeters       = if(c.hasPathOrNull("noRefuelThresholdInMeters")) c.getInt("noRefuelThresholdInMeters") else 96540,
                refuelRequiredThresholdInMeters = if(c.hasPathOrNull("refuelRequiredThresholdInMeters")) c.getInt("refuelRequiredThresholdInMeters") else 16090,
          ...
          object Charging {
            ...
            object MultinomialLogit {
              ...
              object Params {
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Charging.MultinomialLogit.Params = {
                  BeamConfig.Beam.Agentsim.Agents.RideHail.Charging.MultinomialLogit.Params(
                    chargingTimeMultiplier      = if(c.hasPathOrNull("chargingTimeMultiplier")) c.getDouble("chargingTimeMultiplier") else -0.01666667,
                    drivingTimeMultiplier       = if(c.hasPathOrNull("drivingTimeMultiplier")) c.getDouble("drivingTimeMultiplier") else -0.01666667,
                    insufficientRangeMultiplier = if(c.hasPathOrNull("insufficientRangeMultiplier")) c.getDouble("insufficientRangeMultiplier") else -60.0,
                    queueingTimeMultiplier      = if(c.hasPathOrNull("queueingTimeMultiplier")) c.getDouble("queueingTimeMultiplier") else -0.01666667
                  )
                }
              }
                    
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Charging.MultinomialLogit = {
                BeamConfig.Beam.Agentsim.Agents.RideHail.Charging.MultinomialLogit(
                  params = BeamConfig.Beam.Agentsim.Agents.RideHail.Charging.MultinomialLogit.Params(if(c.hasPathOrNull("params")) c.getConfig("params") else com.typesafe.config.ConfigFactory.parseString("params{}"))
                )
              }
            }
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Charging = {
              BeamConfig.Beam.Agentsim.Agents.RideHail.Charging(
                multinomialLogit = BeamConfig.Beam.Agentsim.Agents.RideHail.Charging.MultinomialLogit(if(c.hasPathOrNull("multinomialLogit")) c.getConfig("multinomialLogit") else com.typesafe.config.ConfigFactory.parseString("multinomialLogit{}"))
              )
            }
          }
          ...
          object Human {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Human = {
              BeamConfig.Beam.Agentsim.Agents.RideHail.Human(
                noRefuelThresholdInMeters       = if(c.hasPathOrNull("noRefuelThresholdInMeters")) c.getInt("noRefuelThresholdInMeters") else 128720,
                refuelRequiredThresholdInMeters = if(c.hasPathOrNull("refuelRequiredThresholdInMeters")) c.getInt("refuelRequiredThresholdInMeters") else 32180
              )
            }
          }
          ...
          object Managers$Elm {
            ...
            object AllocationManager {
              ...
              object AlonsoMora {
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.AllocationManager.AlonsoMora = {
                  BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.AllocationManager.AlonsoMora(
                    maxRequestsPerVehicle = if(c.hasPathOrNull("maxRequestsPerVehicle")) c.getInt("maxRequestsPerVehicle") else 5
                  )
                }
              }
                    
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.AllocationManager = {
                BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.AllocationManager(
                  alonsoMora                                     = BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.AllocationManager.AlonsoMora(if(c.hasPathOrNull("alonsoMora")) c.getConfig("alonsoMora") else com.typesafe.config.ConfigFactory.parseString("alonsoMora{}")),
                  matchingAlgorithm                              = if(c.hasPathOrNull("matchingAlgorithm")) c.getString("matchingAlgorithm") else "ALONSO_MORA_MATCHING_WITH_ASYNC_GREEDY_ASSIGNMENT",
                  maxExcessRideTime                              = if(c.hasPathOrNull("maxExcessRideTime")) c.getDouble("maxExcessRideTime") else 0.5,
                  maxWaitingTimeInSec                            = if(c.hasPathOrNull("maxWaitingTimeInSec")) c.getInt("maxWaitingTimeInSec") else 900,
                  name                                           = if(c.hasPathOrNull("name")) c.getString("name") else "DEFAULT_MANAGER",
                  pooledRideHailIntervalAsMultipleOfSoloRideHail = if(c.hasPathOrNull("pooledRideHailIntervalAsMultipleOfSoloRideHail")) c.getInt("pooledRideHailIntervalAsMultipleOfSoloRideHail") else 1,
                  requestBufferTimeoutInSeconds                  = if(c.hasPathOrNull("requestBufferTimeoutInSeconds")) c.getInt("requestBufferTimeoutInSeconds") else 0
                )
              }
            }
            ...
            object Initialization {
              ...
              object Parking {
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.Initialization.Parking = {
              ...
              object Procedural {
                ...
                object InitialLocation {
                  ...
                  object Home {
                    def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.Initialization.Procedural.InitialLocation.Home = {
                  ...
                  def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.Initialization.Procedural.InitialLocation = {
                    BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.Initialization.Procedural.InitialLocation(
                      home = BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.Initialization.Procedural.InitialLocation.Home(if(c.hasPathOrNull("home")) c.getConfig("home") else com.typesafe.config.ConfigFactory.parseString("home{}")),
                      name = if(c.hasPathOrNull("name")) c.getString("name") else "HOME"
                    )
                  }
                }
                      
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.Initialization.Procedural = {
                  BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.Initialization.Procedural(
                    averageOnDutyHoursPerDay      = if(c.hasPathOrNull("averageOnDutyHoursPerDay")) c.getDouble("averageOnDutyHoursPerDay") else 3.52,
                    equivalentNumberOfDrivers     = if(c.hasPathOrNull("equivalentNumberOfDrivers")) c.getDouble("equivalentNumberOfDrivers") else 0.0,
                    ...
                    initialLocation               = BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.Initialization.Procedural.InitialLocation(if(c.hasPathOrNull("initialLocation")) c.getConfig("initialLocation") else com.typesafe.config.ConfigFactory.parseString("initialLocation{}")),
                    meanLogShiftDurationHours     = if(c.hasPathOrNull("meanLogShiftDurationHours")) c.getDouble("meanLogShiftDurationHours") else 1.02,
                    stdLogShiftDurationHours      = if(c.hasPathOrNull("stdLogShiftDurationHours")) c.getDouble("stdLogShiftDurationHours") else 0.44,
                    ...
                    vehicleTypePrefix             = if(c.hasPathOrNull("vehicleTypePrefix")) c.getString("vehicleTypePrefix") else "RH"
                  )
                }
              }
                    
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.Initialization = {
                BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.Initialization(
                  ...
                  parking    = BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.Initialization.Parking(if(c.hasPathOrNull("parking")) c.getConfig("parking") else com.typesafe.config.ConfigFactory.parseString("parking{}")),
                  procedural = BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.Initialization.Procedural(if(c.hasPathOrNull("procedural")) c.getConfig("procedural") else com.typesafe.config.ConfigFactory.parseString("procedural{}"))
                )
              }
            }
            ...
            object RepositioningManager {
              ...
              object DemandFollowingRepositioningManager {
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.RepositioningManager.DemandFollowingRepositioningManager = {
                  BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.RepositioningManager.DemandFollowingRepositioningManager(
                    fractionOfClosestClustersToConsider       = if(c.hasPathOrNull("fractionOfClosestClustersToConsider")) c.getDouble("fractionOfClosestClustersToConsider") else 0.2,
                    horizon                                   = if(c.hasPathOrNull("horizon")) c.getInt("horizon") else 1200,
                    numberOfClustersForDemand                 = if(c.hasPathOrNull("numberOfClustersForDemand")) c.getInt("numberOfClustersForDemand") else 30,
                    sensitivityOfRepositioningToDemand        = if(c.hasPathOrNull("sensitivityOfRepositioningToDemand")) c.getDouble("sensitivityOfRepositioningToDemand") else 1,
                    sensitivityOfRepositioningToDemandForCAVs = if(c.hasPathOrNull("sensitivityOfRepositioningToDemandForCAVs")) c.getDouble("sensitivityOfRepositioningToDemandForCAVs") else 1
                  )
                }
              }
              ...
              object InverseSquareDistanceRepositioningFactor {
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.RepositioningManager.InverseSquareDistanceRepositioningFactor = {
                  BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.RepositioningManager.InverseSquareDistanceRepositioningFactor(
                    ...
                    sensitivityOfRepositioningToDemand   = if(c.hasPathOrNull("sensitivityOfRepositioningToDemand")) c.getDouble("sensitivityOfRepositioningToDemand") else 0.4,
                    sensitivityOfRepositioningToDistance = if(c.hasPathOrNull("sensitivityOfRepositioningToDistance")) c.getDouble("sensitivityOfRepositioningToDistance") else 0.9
                  )
                }
              }
              ...
              object RepositionLowWaitingTimes {
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.RepositioningManager.RepositionLowWaitingTimes = {
              ...
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.RepositioningManager = {
                BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.RepositioningManager(
                  demandFollowingRepositioningManager      = BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.RepositioningManager.DemandFollowingRepositioningManager(if(c.hasPathOrNull("demandFollowingRepositioningManager")) c.getConfig("demandFollowingRepositioningManager") else com.typesafe.config.ConfigFactory.parseString("demandFollowingRepositioningManager{}")),
                  inverseSquareDistanceRepositioningFactor = BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.RepositioningManager.InverseSquareDistanceRepositioningFactor(if(c.hasPathOrNull("inverseSquareDistanceRepositioningFactor")) c.getConfig("inverseSquareDistanceRepositioningFactor") else com.typesafe.config.ConfigFactory.parseString("inverseSquareDistanceRepositioningFactor{}")),
                  name                                     = if(c.hasPathOrNull("name")) c.getString("name") else "DEFAULT_REPOSITIONING_MANAGER",
                  repositionLowWaitingTimes                = BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.RepositioningManager.RepositionLowWaitingTimes(if(c.hasPathOrNull("repositionLowWaitingTimes")) c.getConfig("repositionLowWaitingTimes") else com.typesafe.config.ConfigFactory.parseString("repositionLowWaitingTimes{}")),
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm = {
              BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm(
                allocationManager            = BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.AllocationManager(if(c.hasPathOrNull("allocationManager")) c.getConfig("allocationManager") else com.typesafe.config.ConfigFactory.parseString("allocationManager{}")),
                defaultBaseCost              = if(c.hasPathOrNull("defaultBaseCost")) c.getDouble("defaultBaseCost") else 1.8,
                defaultCostPerMile           = if(c.hasPathOrNull("defaultCostPerMile")) c.getDouble("defaultCostPerMile") else 0.91,
                defaultCostPerMinute         = if(c.hasPathOrNull("defaultCostPerMinute")) c.getDouble("defaultCostPerMinute") else 0.28,
                initialization               = BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.Initialization(if(c.hasPathOrNull("initialization")) c.getConfig("initialization") else com.typesafe.config.ConfigFactory.parseString("initialization{}")),
                maximumWalkDistanceToStopInM = if(c.hasPathOrNull("maximumWalkDistanceToStopInM")) c.getInt("maximumWalkDistanceToStopInM") else 800,
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail = {
            BeamConfig.Beam.Agentsim.Agents.RideHail(
              bestResponseType               = if(c.hasPathOrNull("bestResponseType")) c.getString("bestResponseType") else "MIN_COST",
              cav                            = BeamConfig.Beam.Agentsim.Agents.RideHail.Cav(if(c.hasPathOrNull("cav")) c.getConfig("cav") else com.typesafe.config.ConfigFactory.parseString("cav{}")),
              charging                       = BeamConfig.Beam.Agentsim.Agents.RideHail.Charging(if(c.hasPathOrNull("charging")) c.getConfig("charging") else com.typesafe.config.ConfigFactory.parseString("charging{}")),
              human                          = BeamConfig.Beam.Agentsim.Agents.RideHail.Human(if(c.hasPathOrNull("human")) c.getConfig("human") else com.typesafe.config.ConfigFactory.parseString("human{}")),
              ...
              linkFleetStateAcrossIterations = c.hasPathOrNull("linkFleetStateAcrossIterations") && c.getBoolean("linkFleetStateAcrossIterations"),
              managers                       = $_LBeamConfig_Beam_Agentsim_Agents_RideHail_Managers$Elm(c.getList("managers")),
              rangeBufferForDispatchInMeters = if(c.hasPathOrNull("rangeBufferForDispatchInMeters")) c.getInt("rangeBufferForDispatchInMeters") else 10000,
          ...
          private def $_LBeamConfig_Beam_Agentsim_Agents_RideHail_Managers$Elm(cl:com.typesafe.config.ConfigList): scala.List[BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm] = {
            import scala.collection.JavaConverters._
            cl.asScala.map(cv => BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm(cv.asInstanceOf[com.typesafe.config.ConfigObject].toConfig)).toList
          }
        }
        ...
        object RideHailTransit {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHailTransit = {
            BeamConfig.Beam.Agentsim.Agents.RideHailTransit(
              intermodalUse   = if(c.hasPathOrNull("intermodalUse")) c.getString("intermodalUse") else "AccessAndOrEgress",
        ...
        object TripBehaviors {
          ...
          object CarUsage {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.TripBehaviors.CarUsage = {
              BeamConfig.Beam.Agentsim.Agents.TripBehaviors.CarUsage(
                minDistanceToTrainStop = if(c.hasPathOrNull("minDistanceToTrainStop")) c.getDouble("minDistanceToTrainStop") else 0.0
              )
            }
          }
          ...
          object MultinomialLogit {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.TripBehaviors.MultinomialLogit = {
              BeamConfig.Beam.Agentsim.Agents.TripBehaviors.MultinomialLogit(
                activity_file_path              = if(c.hasPathOrNull("activity_file_path")) c.getString("activity_file_path") else "",
                additional_trip_utility         = if(c.hasPathOrNull("additional_trip_utility")) c.getDouble("additional_trip_utility") else 0.0,
                destination_nest_scale_factor   = if(c.hasPathOrNull("destination_nest_scale_factor")) c.getDouble("destination_nest_scale_factor") else 1.0,
                generate_secondary_activities   = c.hasPathOrNull("generate_secondary_activities") && c.getBoolean("generate_secondary_activities"),
                intercept_file_path             = if(c.hasPathOrNull("intercept_file_path")) c.getString("intercept_file_path") else "",
                max_destination_choice_set_size = if(c.hasPathOrNull("max_destination_choice_set_size")) c.getInt("max_destination_choice_set_size") else 20,
                max_destination_distance_meters = if(c.hasPathOrNull("max_destination_distance_meters")) c.getDouble("max_destination_distance_meters") else 32000,
                mode_nest_scale_factor          = if(c.hasPathOrNull("mode_nest_scale_factor")) c.getDouble("mode_nest_scale_factor") else 1.0,
                score_activities                = !c.hasPathOrNull("score_activities") || c.getBoolean("score_activities"),
                trip_nest_scale_factor          = if(c.hasPathOrNull("trip_nest_scale_factor")) c.getDouble("trip_nest_scale_factor") else 1.0
              )
            }
          }
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.TripBehaviors = {
            BeamConfig.Beam.Agentsim.Agents.TripBehaviors(
              ...
              multinomialLogit = BeamConfig.Beam.Agentsim.Agents.TripBehaviors.MultinomialLogit(if(c.hasPathOrNull("multinomialLogit")) c.getConfig("multinomialLogit") else com.typesafe.config.ConfigFactory.parseString("multinomialLogit{}"))
            )
          }
        }
        ...
        object Vehicles {
          ...
          object Destination {
            ...
            object Home {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles.Destination.Home = {
                BeamConfig.Beam.Agentsim.Agents.Vehicles.Destination.Home(
                  noRefuelThresholdInMeters       = if(c.hasPathOrNull("noRefuelThresholdInMeters")) c.getInt("noRefuelThresholdInMeters") else 482803,
                  refuelRequiredThresholdInMeters = if(c.hasPathOrNull("refuelRequiredThresholdInMeters")) c.getInt("refuelRequiredThresholdInMeters") else 482803
                )
              }
            }
            ...
            object Secondary {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles.Destination.Secondary = {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles.Destination = {
              BeamConfig.Beam.Agentsim.Agents.Vehicles.Destination(
                home                            = BeamConfig.Beam.Agentsim.Agents.Vehicles.Destination.Home(if(c.hasPathOrNull("home")) c.getConfig("home") else com.typesafe.config.ConfigFactory.parseString("home{}")),
                noRefuelThresholdInMeters       = if(c.hasPathOrNull("noRefuelThresholdInMeters")) c.getInt("noRefuelThresholdInMeters") else 482803,
                refuelRequiredThresholdInMeters = if(c.hasPathOrNull("refuelRequiredThresholdInMeters")) c.getInt("refuelRequiredThresholdInMeters") else 482803,
                secondary                       = BeamConfig.Beam.Agentsim.Agents.Vehicles.Destination.Secondary(if(c.hasPathOrNull("secondary")) c.getConfig("secondary") else com.typesafe.config.ConfigFactory.parseString("secondary{}")),
                work                            = BeamConfig.Beam.Agentsim.Agents.Vehicles.Destination.Work(if(c.hasPathOrNull("work")) c.getConfig("work") else com.typesafe.config.ConfigFactory.parseString("work{}"))
              )
            }
          }
          ...
          object DummySharedBike {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles.DummySharedBike = {
              BeamConfig.Beam.Agentsim.Agents.Vehicles.DummySharedBike(
                vehicleTypeId = if(c.hasPathOrNull("vehicleTypeId")) c.getString("vehicleTypeId") else "sharedVehicle-sharedBike"
              )
            }
          }
          ...
          object DummySharedCar {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles.DummySharedCar = {
              BeamConfig.Beam.Agentsim.Agents.Vehicles.DummySharedCar(
                vehicleTypeId = if(c.hasPathOrNull("vehicleTypeId")) c.getString("vehicleTypeId") else "sharedVehicle-sharedCar"
              )
            }
          }
          ...
          object Emissions {
            ...
            object RatesFilter {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles.Emissions.RatesFilter = {
                BeamConfig.Beam.Agentsim.Agents.Vehicles.Emissions.RatesFilter(
                  county       = if(c.hasPathOrNull("county")) c.getString("county") else "RUNEX,IDLEX,STREX,HOTSOAK,DIURN,RUNLOSS,PMTW,PMBW,PRDUST",
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles.Emissions = {
              BeamConfig.Beam.Agentsim.Agents.Vehicles.Emissions(
                ...
                pollutantsFilter        = if(c.hasPathOrNull("pollutantsFilter")) c.getString("pollutantsFilter") else "CH4,CO,CO2,HC,NH3,NOx,PM,PM10,PM2_5,ROG,SOx,TOG,BC,BCm,BCh",
                ratesFilter             = BeamConfig.Beam.Agentsim.Agents.Vehicles.Emissions.RatesFilter(if(c.hasPathOrNull("ratesFilter")) c.getConfig("ratesFilter") else com.typesafe.config.ConfigFactory.parseString("ratesFilter{}")),
                skims                   = !c.hasPathOrNull("skims") || c.getBoolean("skims"),
                workdayIdleTimeFraction = BeamConfig.Beam.Agentsim.Agents.Vehicles.Emissions.WorkdayIdleTimeFraction(if(c.hasPathOrNull("workdayIdleTimeFraction")) c.getConfig("workdayIdleTimeFraction") else com.typesafe.config.ConfigFactory.parseString("workdayIdleTimeFraction{}"))
              )
            }
          }
          ...
          object Enroute {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles.Enroute = {
              BeamConfig.Beam.Agentsim.Agents.Vehicles.Enroute(
                noRefuelAtRemainingDistanceThresholdInMeters = if(c.hasPathOrNull("noRefuelAtRemainingDistanceThresholdInMeters")) c.getInt("noRefuelAtRemainingDistanceThresholdInMeters") else 500,
                noRefuelThresholdOffsetInMeters              = if(c.hasPathOrNull("noRefuelThresholdOffsetInMeters")) c.getDouble("noRefuelThresholdOffsetInMeters") else 32186.9,
                refuelRequiredThresholdOffsetInMeters        = if(c.hasPathOrNull("refuelRequiredThresholdOffsetInMeters")) c.getInt("refuelRequiredThresholdOffsetInMeters") else 0,
                remainingDistanceWrtBatteryCapacityThreshold = if(c.hasPathOrNull("remainingDistanceWrtBatteryCapacityThreshold")) c.getInt("remainingDistanceWrtBatteryCapacityThreshold") else 2
              )
            }
          }
          ...
          case class SharedFleets$Elm(
            ...
            inexhaustible_reserving          : scala.Option[BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm.InexhaustibleReserving],
          ...
          object SharedFleets$Elm {
            ...
            object FixedNonReserving {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm.FixedNonReserving = {
                BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm.FixedNonReserving(
                  maxWalkingDistance = if(c.hasPathOrNull("maxWalkingDistance")) c.getInt("maxWalkingDistance") else 500,
                  vehicleTypeId      = if(c.hasPathOrNull("vehicleTypeId")) c.getString("vehicleTypeId") else "sharedVehicle-sharedCar"
                )
              }
            }
            ...
            object FixedNonReservingFleetByTaz {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm.FixedNonReservingFleetByTaz = {
                BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm.FixedNonReservingFleetByTaz(
                  ...
                  maxWalkingDistance         = if(c.hasPathOrNull("maxWalkingDistance")) c.getInt("maxWalkingDistance") else 500,
                  vehicleTypeId              = if(c.hasPathOrNull("vehicleTypeId")) c.getString("vehicleTypeId") else "sharedVehicle-sharedCar",
                  vehiclesSharePerTAZFromCSV = if(c.hasPathOrNull("vehiclesSharePerTAZFromCSV")) Some(c.getString("vehiclesSharePerTAZFromCSV")) else None
                )
              }
            }
            ...
            object InexhaustibleReserving {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm.InexhaustibleReserving = {
            ...
            object Reposition {
              ...
              object MinAvailabilityUndersupplyAlgorithm {
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm.Reposition.MinAvailabilityUndersupplyAlgorithm = {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm = {
              BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm(
                ...
                fixed_non_reserving_fleet_by_taz = if(c.hasPathOrNull("fixed-non-reserving-fleet-by-taz")) scala.Some(BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm.FixedNonReservingFleetByTaz(c.getConfig("fixed-non-reserving-fleet-by-taz"))) else None,
                inexhaustible_reserving          = if(c.hasPathOrNull("inexhaustible-reserving")) scala.Some(BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm.InexhaustibleReserving(c.getConfig("inexhaustible-reserving"))) else None,
                ...
                reposition                       = if(c.hasPathOrNull("reposition")) scala.Some(BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm.Reposition(c.getConfig("reposition"))) else None
              )
            }
          }
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles = {
            BeamConfig.Beam.Agentsim.Agents.Vehicles(
              destination                                         = BeamConfig.Beam.Agentsim.Agents.Vehicles.Destination(if(c.hasPathOrNull("destination")) c.getConfig("destination") else com.typesafe.config.ConfigFactory.parseString("destination{}")),
              downsamplingMethod                                  = if(c.hasPathOrNull("downsamplingMethod")) c.getString("downsamplingMethod") else "SECONDARY_VEHICLES_FIRST",
              dummySharedBike                                     = BeamConfig.Beam.Agentsim.Agents.Vehicles.DummySharedBike(if(c.hasPathOrNull("dummySharedBike")) c.getConfig("dummySharedBike") else com.typesafe.config.ConfigFactory.parseString("dummySharedBike{}")),
              dummySharedCar                                      = BeamConfig.Beam.Agentsim.Agents.Vehicles.DummySharedCar(if(c.hasPathOrNull("dummySharedCar")) c.getConfig("dummySharedCar") else com.typesafe.config.ConfigFactory.parseString("dummySharedCar{}")),
              emissions                                           = BeamConfig.Beam.Agentsim.Agents.Vehicles.Emissions(if(c.hasPathOrNull("emissions")) c.getConfig("emissions") else com.typesafe.config.ConfigFactory.parseString("emissions{}")),
              enroute                                             = BeamConfig.Beam.Agentsim.Agents.Vehicles.Enroute(if(c.hasPathOrNull("enroute")) c.getConfig("enroute") else com.typesafe.config.ConfigFactory.parseString("enroute{}")),
              fractionOfInitialVehicleFleet                       = if(c.hasPathOrNull("fractionOfInitialVehicleFleet")) c.getDouble("fractionOfInitialVehicleFleet") else 1.0,
              fractionOfPeopleWithBicycle                         = if(c.hasPathOrNull("fractionOfPeopleWithBicycle")) c.getDouble("fractionOfPeopleWithBicycle") else 1.0,
              fuelTypesFilePath                                   = if(c.hasPathOrNull("fuelTypesFilePath")) c.getString("fuelTypesFilePath") else "/test/input/beamville/beamFuelTypes.csv",
              generateEmergencyHouseholdVehicleWhenPlansRequireIt = c.hasPathOrNull("generateEmergencyHouseholdVehicleWhenPlansRequireIt") && c.getBoolean("generateEmergencyHouseholdVehicleWhenPlansRequireIt"),
              linkSocAcrossIterations                             = c.hasPathOrNull("linkSocAcrossIterations") && c.getBoolean("linkSocAcrossIterations"),
              linkToGradePercentFilePath                          = if(c.hasPathOrNull("linkToGradePercentFilePath")) c.getString("linkToGradePercentFilePath") else "",
              meanPrivateVehicleStartingSOC                       = if(c.hasPathOrNull("meanPrivateVehicleStartingSOC")) c.getDouble("meanPrivateVehicleStartingSOC") else 1.0,
              meanRidehailVehicleStartingSOC                      = if(c.hasPathOrNull("meanRidehailVehicleStartingSOC")) c.getDouble("meanRidehailVehicleStartingSOC") else 1.0,
              replanOnTheFlyWhenHouseholdVehiclesAreNotAvailable  = c.hasPathOrNull("replanOnTheFlyWhenHouseholdVehiclesAreNotAvailable") && c.getBoolean("replanOnTheFlyWhenHouseholdVehiclesAreNotAvailable"),
              roadRestrictionWeightMultiplier                     = if(c.hasPathOrNull("roadRestrictionWeightMultiplier")) c.getDouble("roadRestrictionWeightMultiplier") else 2.0,
              sharedFleets                                        = $_LBeamConfig_Beam_Agentsim_Agents_Vehicles_SharedFleets$Elm(c.getList("sharedFleets")),
              transitVehicleTypesByRouteFile                      = if(c.hasPathOrNull("transitVehicleTypesByRouteFile")) c.getString("transitVehicleTypesByRouteFile") else "",
              vehicleAdjustmentMethod                             = if(c.hasPathOrNull("vehicleAdjustmentMethod")) c.getString("vehicleAdjustmentMethod") else "UNIFORM",
              vehicleTypesFilePath                                = if(c.hasPathOrNull("vehicleTypesFilePath")) c.getString("vehicleTypesFilePath") else "/test/input/beamville/vehicleTypes.csv",
              vehiclesFilePath                                    = if(c.hasPathOrNull("vehiclesFilePath")) c.getString("vehiclesFilePath") else ""
            )
          }
          private def $_LBeamConfig_Beam_Agentsim_Agents_Vehicles_SharedFleets$Elm(cl:com.typesafe.config.ConfigList): scala.List[BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm] = {
            import scala.collection.JavaConverters._
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents = {
          BeamConfig.Beam.Agentsim.Agents(
            ...
            freight         = BeamConfig.Beam.Agentsim.Agents.Freight(if(c.hasPathOrNull("freight")) c.getConfig("freight") else com.typesafe.config.ConfigFactory.parseString("freight{}")),
            households      = BeamConfig.Beam.Agentsim.Agents.Households(if(c.hasPathOrNull("households")) c.getConfig("households") else com.typesafe.config.ConfigFactory.parseString("households{}")),
            ...
            modeIncentive   = BeamConfig.Beam.Agentsim.Agents.ModeIncentive(if(c.hasPathOrNull("modeIncentive")) c.getConfig("modeIncentive") else com.typesafe.config.ConfigFactory.parseString("modeIncentive{}")),
            parking         = BeamConfig.Beam.Agentsim.Agents.Parking(if(c.hasPathOrNull("parking")) c.getConfig("parking") else com.typesafe.config.ConfigFactory.parseString("parking{}")),
            plans           = BeamConfig.Beam.Agentsim.Agents.Plans(if(c.hasPathOrNull("plans")) c.getConfig("plans") else com.typesafe.config.ConfigFactory.parseString("plans{}")),
            ...
            ptFare          = BeamConfig.Beam.Agentsim.Agents.PtFare(if(c.hasPathOrNull("ptFare")) c.getConfig("ptFare") else com.typesafe.config.ConfigFactory.parseString("ptFare{}")),
            ...
            rideHailTransit = BeamConfig.Beam.Agentsim.Agents.RideHailTransit(if(c.hasPathOrNull("rideHailTransit")) c.getConfig("rideHailTransit") else com.typesafe.config.ConfigFactory.parseString("rideHailTransit{}")),
            tripBehaviors   = BeamConfig.Beam.Agentsim.Agents.TripBehaviors(if(c.hasPathOrNull("tripBehaviors")) c.getConfig("tripBehaviors") else com.typesafe.config.ConfigFactory.parseString("tripBehaviors{}")),
      ...
      case class ChargingNetworkManager(
        ...
        sitePowerManagerController      : scala.Option[BeamConfig.Beam.Agentsim.ChargingNetworkManager.SitePowerManagerController],
      ...
      object ChargingNetworkManager {
        ...
        object PowerManagerController {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.ChargingNetworkManager.PowerManagerController = {
            BeamConfig.Beam.Agentsim.ChargingNetworkManager.PowerManagerController(
              beamFederateName        = if(c.hasPathOrNull("beamFederateName")) c.getString("beamFederateName") else "BEAM_FED",
              beamFederatePublication = if(c.hasPathOrNull("beamFederatePublication")) c.getString("beamFederatePublication") else "LOAD_DEMAND",
              ...
              pmcFederateSubscription = if(c.hasPathOrNull("pmcFederateSubscription")) c.getString("pmcFederateSubscription") else "POWER_LIMITS",
        ...
        object ScaleUp {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.ChargingNetworkManager.ScaleUp = {
            BeamConfig.Beam.Agentsim.ChargingNetworkManager.ScaleUp(
              activitiesLocationFilePath = if(c.hasPathOrNull("activitiesLocationFilePath")) c.getString("activitiesLocationFilePath") else "",
              enabled                    = c.hasPathOrNull("enabled") && c.getBoolean("enabled"),
        ...
        object SitePowerManagerController {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.ChargingNetworkManager.SitePowerManagerController = {
            BeamConfig.Beam.Agentsim.ChargingNetworkManager.SitePowerManagerController(
              beamFederatePrefix      = if(c.hasPathOrNull("beamFederatePrefix")) c.getString("beamFederatePrefix") else "BEAM_FED",
              beamFederatePublication = if(c.hasPathOrNull("beamFederatePublication")) c.getString("beamFederatePublication") else "CHARGING_VEHICLES",
              brokerAddress           = if(c.hasPathOrNull("brokerAddress")) c.getString("brokerAddress") else "tcp://127.0.0.1",
              bufferSize              = if(c.hasPathOrNull("bufferSize")) c.getInt("bufferSize") else 10000000,
              connect                 = c.hasPathOrNull("connect") && c.getBoolean("connect"),
              coreType                = if(c.hasPathOrNull("coreType")) c.getString("coreType") else "zmq",
              ...
              spmFederatePrefix       = if(c.hasPathOrNull("spmFederatePrefix")) c.getString("spmFederatePrefix") else "SPM_FED",
              spmFederateSubscription = if(c.hasPathOrNull("spmFederateSubscription")) c.getString("spmFederateSubscription") else "CHARGING_COMMANDS",
              timeDeltaProperty       = if(c.hasPathOrNull("timeDeltaProperty")) c.getDouble("timeDeltaProperty") else 1.0
            )
          }
        }
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.ChargingNetworkManager = {
          BeamConfig.Beam.Agentsim.ChargingNetworkManager(
            ...
            chargingPointCountScalingFactor = if(c.hasPathOrNull("chargingPointCountScalingFactor")) c.getDouble("chargingPointCountScalingFactor") else 1.0,
            chargingPointFilePath           = if(c.hasPathOrNull("chargingPointFilePath")) c.getString("chargingPointFilePath") else "",
            overnightChargingEnabled        = c.hasPathOrNull("overnightChargingEnabled") && c.getBoolean("overnightChargingEnabled"),
            powerManagerController          = if(c.hasPathOrNull("powerManagerController")) scala.Some(BeamConfig.Beam.Agentsim.ChargingNetworkManager.PowerManagerController(c.getConfig("powerManagerController"))) else None,
            scaleUp                         = BeamConfig.Beam.Agentsim.ChargingNetworkManager.ScaleUp(if(c.hasPathOrNull("scaleUp")) c.getConfig("scaleUp") else com.typesafe.config.ConfigFactory.parseString("scaleUp{}")),
            sitePowerManagerController      = if(c.hasPathOrNull("sitePowerManagerController")) scala.Some(BeamConfig.Beam.Agentsim.ChargingNetworkManager.SitePowerManagerController(c.getConfig("sitePowerManagerController"))) else None,
      ...
      object SnapLocationAndRemoveInvalidInputs {
        ...
        object Params {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.SnapLocationAndRemoveInvalidInputs.Params = {
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.SnapLocationAndRemoveInvalidInputs = {
          BeamConfig.Beam.Agentsim.SnapLocationAndRemoveInvalidInputs(
            params = BeamConfig.Beam.Agentsim.SnapLocationAndRemoveInvalidInputs.Params(if(c.hasPathOrNull("params")) c.getConfig("params") else com.typesafe.config.ConfigFactory.parseString("params{}"))
          )
        }
      }
      ...
      object Taz {
        ...
        object ParkingManager {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Taz.ParkingManager = {
            BeamConfig.Beam.Agentsim.Taz.ParkingManager(
              ...
              parallel                  = BeamConfig.Beam.Agentsim.Taz.ParkingManager.Parallel(if(c.hasPathOrNull("parallel")) c.getConfig("parallel") else com.typesafe.config.ConfigFactory.parseString("parallel{}"))
            )
          }
        }
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Taz = {
          BeamConfig.Beam.Agentsim.Taz(
            ...
            parkingCostScalingFactor       = if(c.hasPathOrNull("parkingCostScalingFactor")) c.getDouble("parkingCostScalingFactor") else 1.0,
            parkingFilePath                = if(c.hasPathOrNull("parkingFilePath")) c.getString("parkingFilePath") else "",
            parkingManager                 = BeamConfig.Beam.Agentsim.Taz.ParkingManager(if(c.hasPathOrNull("parkingManager")) c.getConfig("parkingManager") else com.typesafe.config.ConfigFactory.parseString("parkingManager{}")),
            parkingStallCountScalingFactor = if(c.hasPathOrNull("parkingStallCountScalingFactor")) c.getDouble("parkingStallCountScalingFactor") else 1.0,
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim = {
        BeamConfig.Beam.Agentsim(
          ...
          chargingNetworkManager                  = BeamConfig.Beam.Agentsim.ChargingNetworkManager(if(c.hasPathOrNull("chargingNetworkManager")) c.getConfig("chargingNetworkManager") else com.typesafe.config.ConfigFactory.parseString("chargingNetworkManager{}")),
          ...
          fractionOfPlansWithSingleActivity       = if(c.hasPathOrNull("fractionOfPlansWithSingleActivity")) c.getDouble("fractionOfPlansWithSingleActivity") else 0.0,
          h3taz                                   = BeamConfig.Beam.Agentsim.H3taz(if(c.hasPathOrNull("h3taz")) c.getConfig("h3taz") else com.typesafe.config.ConfigFactory.parseString("h3taz{}")),
          ...
          randomSeedForPopulationSampling         = if(c.hasPathOrNull("randomSeedForPopulationSampling")) Some(c.getInt("randomSeedForPopulationSampling")) else None,
          ...
          snapLocationAndRemoveInvalidInputs      = BeamConfig.Beam.Agentsim.SnapLocationAndRemoveInvalidInputs(if(c.hasPathOrNull("snapLocationAndRemoveInvalidInputs")) c.getConfig("snapLocationAndRemoveInvalidInputs") else com.typesafe.config.ConfigFactory.parseString("snapLocationAndRemoveInvalidInputs{}")),
    ...
    object Calibration {
      ...
      object Counts {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Calibration.Counts = {
          BeamConfig.Beam.Calibration.Counts(
            averageCountsOverIterations = if(c.hasPathOrNull("averageCountsOverIterations")) c.getInt("averageCountsOverIterations") else 1,
        ...
        object TravelTimes {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Calibration.Google.TravelTimes = {
            BeamConfig.Beam.Calibration.Google.TravelTimes(
              ...
              minDistanceInMeters      = if(c.hasPathOrNull("minDistanceInMeters")) c.getDouble("minDistanceInMeters") else 5000.0,
              numDataPointsOver24Hours = if(c.hasPathOrNull("numDataPointsOver24Hours")) c.getInt("numDataPointsOver24Hours") else 1000,
        ...
        object TravelTimes {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Calibration.RoadNetwork.TravelTimes = {
            BeamConfig.Beam.Calibration.RoadNetwork.TravelTimes(
              zoneBoundariesFilePath    = if(c.hasPathOrNull("zoneBoundariesFilePath")) c.getString("zoneBoundariesFilePath") else "",
              zoneODTravelTimesFilePath = if(c.hasPathOrNull("zoneODTravelTimesFilePath")) c.getString("zoneODTravelTimesFilePath") else ""
            )
          }
        }
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Calibration = {
        BeamConfig.Beam.Calibration(
          ...
          google                  = BeamConfig.Beam.Calibration.Google(if(c.hasPathOrNull("google")) c.getConfig("google") else com.typesafe.config.ConfigFactory.parseString("google{}")),
          ...
          objectiveFunction       = if(c.hasPathOrNull("objectiveFunction")) c.getString("objectiveFunction") else "CountsObjectiveFunction",
          roadNetwork             = BeamConfig.Beam.Calibration.RoadNetwork(if(c.hasPathOrNull("roadNetwork")) c.getConfig("roadNetwork") else com.typesafe.config.ConfigFactory.parseString("roadNetwork{}")),
          studyArea               = BeamConfig.Beam.Calibration.StudyArea(if(c.hasPathOrNull("studyArea")) c.getConfig("studyArea") else com.typesafe.config.ConfigFactory.parseString("studyArea{}"))
        )
      }
    }
    ...
    object Debug {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Debug = {
        BeamConfig.Beam.Debug(
          ...
          agentTripScoresInterval                                       = if(c.hasPathOrNull("agentTripScoresInterval")) c.getInt("agentTripScoresInterval") else 0,
          ...
          maxSimulationStepTimeBeforeConsideredStuckAtInitializationMin = if(c.hasPathOrNull("maxSimulationStepTimeBeforeConsideredStuckAtInitializationMin")) c.getInt("maxSimulationStepTimeBeforeConsideredStuckAtInitializationMin") else 600,
          maxSimulationStepTimeBeforeConsideredStuckMin                 = if(c.hasPathOrNull("maxSimulationStepTimeBeforeConsideredStuckMin")) c.getInt("maxSimulationStepTimeBeforeConsideredStuckMin") else 60,
          ...
          vmInformation                                                 = BeamConfig.Beam.Debug.VmInformation(if(c.hasPathOrNull("vmInformation")) c.getConfig("vmInformation") else com.typesafe.config.ConfigFactory.parseString("vmInformation{}")),
          writeModeChoiceAlternatives                                   = c.hasPathOrNull("writeModeChoiceAlternatives") && c.getBoolean("writeModeChoiceAlternatives"),
          writeRealizedModeChoiceFile                                   = c.hasPathOrNull("writeRealizedModeChoiceFile") && c.getBoolean("writeRealizedModeChoiceFile")
        )
      }
    }
      ...
      object Output {
        ...
        object ActivitySimSkimmer {
          ...
          object Secondary {
            ...
            object Taz {
              ...
              object TazMapping {
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Exchange.Output.ActivitySimSkimmer.Secondary.Taz.TazMapping = {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Exchange.Output.ActivitySimSkimmer = {
            BeamConfig.Beam.Exchange.Output.ActivitySimSkimmer(
              primary   = BeamConfig.Beam.Exchange.Output.ActivitySimSkimmer.Primary(if(c.hasPathOrNull("primary")) c.getConfig("primary") else com.typesafe.config.ConfigFactory.parseString("primary{}")),
              secondary = BeamConfig.Beam.Exchange.Output.ActivitySimSkimmer.Secondary(if(c.hasPathOrNull("secondary")) c.getConfig("secondary") else com.typesafe.config.ConfigFactory.parseString("secondary{}"))
            )
          }
        }
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Exchange.Output = {
          BeamConfig.Beam.Exchange.Output(
            activity_sim_skimmer            = if(c.hasPathOrNull("activity-sim-skimmer")) scala.Some(BeamConfig.Beam.Exchange.Output.ActivitySimSkimmer(c.getConfig("activity-sim-skimmer"))) else None,
            activitySimSkimsEnabled         = c.hasPathOrNull("activitySimSkimsEnabled") && c.getBoolean("activitySimSkimsEnabled"),
            generateSkimsForAllModes        = c.hasPathOrNull("generateSkimsForAllModes") && c.getBoolean("generateSkimsForAllModes"),
            generateSkimsForRideHailTransit = c.hasPathOrNull("generateSkimsForRideHailTransit") && c.getBoolean("generateSkimsForRideHailTransit"),
      ...
      object Scenario {
        ...
        object Urbansim {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Exchange.Scenario.Urbansim = {
            BeamConfig.Beam.Exchange.Scenario.Urbansim(
              ...
              scenarioLoadingTimeoutSeconds = if(c.hasPathOrNull("scenarioLoadingTimeoutSeconds")) c.getInt("scenarioLoadingTimeoutSeconds") else 3000
            )
          }
        }
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Exchange.Scenario = {
          BeamConfig.Beam.Exchange.Scenario(
            ...
            urbansim       = BeamConfig.Beam.Exchange.Scenario.Urbansim(if(c.hasPathOrNull("urbansim")) c.getConfig("urbansim") else com.typesafe.config.ConfigFactory.parseString("urbansim{}"))
          )
        }
      }
    ...
    object Output {
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Output = {
        BeamConfig.Beam.Output(
          writePlansAndStopSimulation = c.hasPathOrNull("writePlansAndStopSimulation") && c.getBoolean("writePlansAndStopSimulation")
        )
      }
    }
    ...
    object Outputs {
      ...
      object Analysis {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Outputs.Analysis = {
          BeamConfig.Beam.Outputs.Analysis(
            iterationScripts         = if(c.hasPathOrNull("iterationScripts")) scala.Some($_L$_str(c.getList("iterationScripts"))) else None,
            processWaitTimeInMinutes = if(c.hasPathOrNull("processWaitTimeInMinutes")) c.getInt("processWaitTimeInMinutes") else 60,
            simulationScripts        = if(c.hasPathOrNull("simulationScripts")) scala.Some($_L$_str(c.getList("simulationScripts"))) else None
          )
        }
      }
      ...
      object Events {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Outputs.Events = {
          BeamConfig.Beam.Outputs.Events(
            eventsToWrite     = if(c.hasPathOrNull("eventsToWrite")) c.getString("eventsToWrite") else "ActivityEndEvent,ActivityStartEvent,PersonEntersVehicleEvent,PersonLeavesVehicleEvent,ModeChoiceEvent,PathTraversalEvent,ReserveRideHailEvent,ReplanningEvent,RefuelSessionEvent,ChargingPlugInEvent,ChargingPlugOutEvent,ParkingEvent,LeavingParkingEvent",
      ...
      object Matsim {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Outputs.Matsim = {
          BeamConfig.Beam.Outputs.Matsim(
            deleteITERSFolderFiles = if(c.hasPathOrNull("deleteITERSFolderFiles")) c.getString("deleteITERSFolderFiles") else "",
            deleteRootFolderFiles  = if(c.hasPathOrNull("deleteRootFolderFiles")) c.getString("deleteRootFolderFiles") else ""
          )
        }
      }
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Outputs = {
        BeamConfig.Beam.Outputs(
          ...
          analysis                              = BeamConfig.Beam.Outputs.Analysis(if(c.hasPathOrNull("analysis")) c.getConfig("analysis") else com.typesafe.config.ConfigFactory.parseString("analysis{}")),
          baseOutputDirectory                   = if(c.hasPathOrNull("baseOutputDirectory")) c.getString("baseOutputDirectory") else "output",
          collectAndCreateBeamAnalysisAndGraphs = !c.hasPathOrNull("collectAndCreateBeamAnalysisAndGraphs") || c.getBoolean("collectAndCreateBeamAnalysisAndGraphs"),
          ...
          matsim                                = BeamConfig.Beam.Outputs.Matsim(if(c.hasPathOrNull("matsim")) c.getConfig("matsim") else com.typesafe.config.ConfigFactory.parseString("matsim{}")),
    ...
    object Physsim {
      ...
      object Bprsim {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Bprsim = {
          BeamConfig.Beam.Physsim.Bprsim(
            inFlowAggregationTimeWindowInSeconds = if(c.hasPathOrNull("inFlowAggregationTimeWindowInSeconds")) c.getInt("inFlowAggregationTimeWindowInSeconds") else 900,
            minFlowToUseBPRFunction              = if(c.hasPathOrNull("minFlowToUseBPRFunction")) c.getInt("minFlowToUseBPRFunction") else 0,
      ...
      object DuplicatePTE {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.DuplicatePTE = {
          BeamConfig.Beam.Physsim.DuplicatePTE(
            departureTimeShiftMax       = if(c.hasPathOrNull("departureTimeShiftMax")) c.getInt("departureTimeShiftMax") else 600,
            departureTimeShiftMin       = if(c.hasPathOrNull("departureTimeShiftMin")) c.getInt("departureTimeShiftMin") else -600,
            fractionOfEventsToDuplicate = if(c.hasPathOrNull("fractionOfEventsToDuplicate")) c.getDouble("fractionOfEventsToDuplicate") else 0.0
          )
        }
      }
      ...
      object Jdeqsim {
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Jdeqsim = {
          BeamConfig.Beam.Physsim.Jdeqsim(
            ...
            cacc                             = BeamConfig.Beam.Physsim.Jdeqsim.Cacc(if(c.hasPathOrNull("cacc")) c.getConfig("cacc") else com.typesafe.config.ConfigFactory.parseString("cacc{}"))
          )
        }
      }
      ...
      object Network {
        ...
        object OverwriteRoadTypeProperties {
          ...
          object Default {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.Default = {
          ...
          object LivingStreet {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.LivingStreet = {
          ...
          object Minor {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.Minor = {
          ...
          object Motorway {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.Motorway = {
          ...
          object MotorwayLink {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.MotorwayLink = {
          ...
          object Primary {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.Primary = {
          ...
          object PrimaryLink {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.PrimaryLink = {
          ...
          object Residential {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.Residential = {
          ...
          object Secondary {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.Secondary = {
          ...
          object SecondaryLink {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.SecondaryLink = {
          ...
          object TertiaryLink {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.TertiaryLink = {
          ...
          object Trunk {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.Trunk = {
          ...
          object TrunkLink {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.TrunkLink = {
          ...
          object Unclassified {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.Unclassified = {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties = {
            BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties(
              default       = BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.Default(if(c.hasPathOrNull("default")) c.getConfig("default") else com.typesafe.config.ConfigFactory.parseString("default{}")),
              enabled       = c.hasPathOrNull("enabled") && c.getBoolean("enabled"),
              livingStreet  = BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.LivingStreet(if(c.hasPathOrNull("livingStreet")) c.getConfig("livingStreet") else com.typesafe.config.ConfigFactory.parseString("livingStreet{}")),
              minor         = BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.Minor(if(c.hasPathOrNull("minor")) c.getConfig("minor") else com.typesafe.config.ConfigFactory.parseString("minor{}")),
              motorway      = BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.Motorway(if(c.hasPathOrNull("motorway")) c.getConfig("motorway") else com.typesafe.config.ConfigFactory.parseString("motorway{}")),
              motorwayLink  = BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.MotorwayLink(if(c.hasPathOrNull("motorwayLink")) c.getConfig("motorwayLink") else com.typesafe.config.ConfigFactory.parseString("motorwayLink{}")),
              primary       = BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.Primary(if(c.hasPathOrNull("primary")) c.getConfig("primary") else com.typesafe.config.ConfigFactory.parseString("primary{}")),
              primaryLink   = BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.PrimaryLink(if(c.hasPathOrNull("primaryLink")) c.getConfig("primaryLink") else com.typesafe.config.ConfigFactory.parseString("primaryLink{}")),
              residential   = BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.Residential(if(c.hasPathOrNull("residential")) c.getConfig("residential") else com.typesafe.config.ConfigFactory.parseString("residential{}")),
              secondary     = BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.Secondary(if(c.hasPathOrNull("secondary")) c.getConfig("secondary") else com.typesafe.config.ConfigFactory.parseString("secondary{}")),
              secondaryLink = BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.SecondaryLink(if(c.hasPathOrNull("secondaryLink")) c.getConfig("secondaryLink") else com.typesafe.config.ConfigFactory.parseString("secondaryLink{}")),
              tertiary      = BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.Tertiary(if(c.hasPathOrNull("tertiary")) c.getConfig("tertiary") else com.typesafe.config.ConfigFactory.parseString("tertiary{}")),
              tertiaryLink  = BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.TertiaryLink(if(c.hasPathOrNull("tertiaryLink")) c.getConfig("tertiaryLink") else com.typesafe.config.ConfigFactory.parseString("tertiaryLink{}")),
              trunk         = BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.Trunk(if(c.hasPathOrNull("trunk")) c.getConfig("trunk") else com.typesafe.config.ConfigFactory.parseString("trunk{}")),
              trunkLink     = BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.TrunkLink(if(c.hasPathOrNull("trunkLink")) c.getConfig("trunkLink") else com.typesafe.config.ConfigFactory.parseString("trunkLink{}")),
              unclassified  = BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties.Unclassified(if(c.hasPathOrNull("unclassified")) c.getConfig("unclassified") else com.typesafe.config.ConfigFactory.parseString("unclassified{}"))
            )
          }
        }
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network = {
          BeamConfig.Beam.Physsim.Network(
            ...
            overwriteRoadTypeProperties = BeamConfig.Beam.Physsim.Network.OverwriteRoadTypeProperties(if(c.hasPathOrNull("overwriteRoadTypeProperties")) c.getConfig("overwriteRoadTypeProperties") else com.typesafe.config.ConfigFactory.parseString("overwriteRoadTypeProperties{}")),
      ...
      object PickUpDropOffAnalysis {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.PickUpDropOffAnalysis = {
          BeamConfig.Beam.Physsim.PickUpDropOffAnalysis(
            additionalTravelTimeMultiplier             = if(c.hasPathOrNull("additionalTravelTimeMultiplier")) c.getDouble("additionalTravelTimeMultiplier") else 1.0,
            enabled                                    = c.hasPathOrNull("enabled") && c.getBoolean("enabled"),
            secondsFromPickUpPropOffToAffectTravelTime = if(c.hasPathOrNull("secondsFromPickUpPropOffToAffectTravelTime")) c.getInt("secondsFromPickUpPropOffToAffectTravelTime") else 600
          )
        }
      }
      ...
      object Relaxation {
        ...
        object Experiment20 {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Relaxation.Experiment20 = {
            BeamConfig.Beam.Physsim.Relaxation.Experiment20(
              clearModesEveryIteration      = !c.hasPathOrNull("clearModesEveryIteration") || c.getBoolean("clearModesEveryIteration"),
              clearRoutesEveryIteration     = !c.hasPathOrNull("clearRoutesEveryIteration") || c.getBoolean("clearRoutesEveryIteration"),
              fractionOfPopulationToReroute = if(c.hasPathOrNull("fractionOfPopulationToReroute")) c.getDouble("fractionOfPopulationToReroute") else 0.1,
              internalNumberOfIterations    = if(c.hasPathOrNull("internalNumberOfIterations")) c.getInt("internalNumberOfIterations") else 15
            )
          }
        }
        ...
        object Experiment40 {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Relaxation.Experiment40 = {
            BeamConfig.Beam.Physsim.Relaxation.Experiment40(
              percentToSimulate = if(c.hasPathOrNull("percentToSimulate")) scala.Some($_L$_dbl(c.getList("percentToSimulate"))) else None
            )
          }
        }
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Relaxation = {
          BeamConfig.Beam.Physsim.Relaxation(
            ...
            experiment2_1 = BeamConfig.Beam.Physsim.Relaxation.Experiment21(if(c.hasPathOrNull("experiment2_1")) c.getConfig("experiment2_1") else com.typesafe.config.ConfigFactory.parseString("experiment2_1{}")),
            experiment3_0 = BeamConfig.Beam.Physsim.Relaxation.Experiment30(if(c.hasPathOrNull("experiment3_0")) c.getConfig("experiment3_0") else com.typesafe.config.ConfigFactory.parseString("experiment3_0{}")),
            experiment4_0 = BeamConfig.Beam.Physsim.Relaxation.Experiment40(if(c.hasPathOrNull("experiment4_0")) c.getConfig("experiment4_0") else com.typesafe.config.ConfigFactory.parseString("experiment4_0{}")),
            experiment5_0 = BeamConfig.Beam.Physsim.Relaxation.Experiment50(if(c.hasPathOrNull("experiment5_0")) c.getConfig("experiment5_0") else com.typesafe.config.ConfigFactory.parseString("experiment5_0{}")),
            experiment5_1 = BeamConfig.Beam.Physsim.Relaxation.Experiment51(if(c.hasPathOrNull("experiment5_1")) c.getConfig("experiment5_1") else com.typesafe.config.ConfigFactory.parseString("experiment5_1{}")),
            experiment5_2 = BeamConfig.Beam.Physsim.Relaxation.Experiment52(if(c.hasPathOrNull("experiment5_2")) c.getConfig("experiment5_2") else com.typesafe.config.ConfigFactory.parseString("experiment5_2{}")),
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim = {
        BeamConfig.Beam.Physsim(
          ...
          cchRoutingAssignment                   = BeamConfig.Beam.Physsim.CchRoutingAssignment(if(c.hasPathOrNull("cchRoutingAssignment")) c.getConfig("cchRoutingAssignment") else com.typesafe.config.ConfigFactory.parseString("cchRoutingAssignment{}")),
          duplicatePTE                           = BeamConfig.Beam.Physsim.DuplicatePTE(if(c.hasPathOrNull("duplicatePTE")) c.getConfig("duplicatePTE") else com.typesafe.config.ConfigFactory.parseString("duplicatePTE{}")),
          eventManager                           = BeamConfig.Beam.Physsim.EventManager(if(c.hasPathOrNull("eventManager")) c.getConfig("eventManager") else com.typesafe.config.ConfigFactory.parseString("eventManager{}")),
          events                                 = BeamConfig.Beam.Physsim.Events(if(c.hasPathOrNull("events")) c.getConfig("events") else com.typesafe.config.ConfigFactory.parseString("events{}")),
          eventsForFullVersionOfVia              = !c.hasPathOrNull("eventsForFullVersionOfVia") || c.getBoolean("eventsForFullVersionOfVia"),
          ...
          initializeRouterWithFreeFlowTimes      = !c.hasPathOrNull("initializeRouterWithFreeFlowTimes") || c.getBoolean("initializeRouterWithFreeFlowTimes"),
          inputNetworkFilePath                   = if(c.hasPathOrNull("inputNetworkFilePath")) c.getString("inputNetworkFilePath") else "/test/input/beamville/r5/physsim-network.xml",
          ...
          linkStatsWriteInterval                 = if(c.hasPathOrNull("linkStatsWriteInterval")) c.getInt("linkStatsWriteInterval") else 0,
          maxLinkLengthToApplySpeedScalingFactor = if(c.hasPathOrNull("maxLinkLengthToApplySpeedScalingFactor")) c.getDouble("maxLinkLengthToApplySpeedScalingFactor") else 50.0,
          minCarSpeedInMetersPerSecond           = if(c.hasPathOrNull("minCarSpeedInMetersPerSecond")) c.getDouble("minCarSpeedInMetersPerSecond") else 0.5,
          name                                   = if(c.hasPathOrNull("name")) c.getString("name") else "JDEQSim",
          network                                = BeamConfig.Beam.Physsim.Network(if(c.hasPathOrNull("network")) c.getConfig("network") else com.typesafe.config.ConfigFactory.parseString("network{}")),
          overwriteLinkParamPath                 = if(c.hasPathOrNull("overwriteLinkParamPath")) c.getString("overwriteLinkParamPath") else "",
          parbprsim                              = BeamConfig.Beam.Physsim.Parbprsim(if(c.hasPathOrNull("parbprsim")) c.getConfig("parbprsim") else com.typesafe.config.ConfigFactory.parseString("parbprsim{}")),
          pickUpDropOffAnalysis                  = BeamConfig.Beam.Physsim.PickUpDropOffAnalysis(if(c.hasPathOrNull("pickUpDropOffAnalysis")) c.getConfig("pickUpDropOffAnalysis") else com.typesafe.config.ConfigFactory.parseString("pickUpDropOffAnalysis{}")),
          ptSampleSize                           = if(c.hasPathOrNull("ptSampleSize")) c.getDouble("ptSampleSize") else 1.0,
          relaxation                             = BeamConfig.Beam.Physsim.Relaxation(if(c.hasPathOrNull("relaxation")) c.getConfig("relaxation") else com.typesafe.config.ConfigFactory.parseString("relaxation{}")),
          ...
          writePlansInterval                     = if(c.hasPathOrNull("writePlansInterval")) c.getInt("writePlansInterval") else 0,
          writeRouteHistoryInterval              = if(c.hasPathOrNull("writeRouteHistoryInterval")) c.getInt("writeRouteHistoryInterval") else 10
        )
      }
    }
    ...
    object Replanning {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Replanning = {
        BeamConfig.Beam.Replanning(
          ...
          clearModes                              = BeamConfig.Beam.Replanning.ClearModes(if(c.hasPathOrNull("clearModes")) c.getConfig("clearModes") else com.typesafe.config.ConfigFactory.parseString("clearModes{}")),
          fractionOfIterationsToDisableInnovation = if(c.hasPathOrNull("fractionOfIterationsToDisableInnovation")) c.getDouble("fractionOfIterationsToDisableInnovation") else Double.PositiveInfinity,
          ...
          replanningPenaltyInDollars              = if(c.hasPathOrNull("replanningPenaltyInDollars")) c.getDouble("replanningPenaltyInDollars") else 100.0,
    ...
    object Router {
      ...
      object Skim {
        ...
        object DriveTimeSkimmer {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Router.Skim.DriveTimeSkimmer = {
            BeamConfig.Beam.Router.Skim.DriveTimeSkimmer(
              fileBaseName = if(c.hasPathOrNull("fileBaseName")) c.getString("fileBaseName") else "skimsTravelTimeObservedVsSimulated",
        ...
        object OriginDestinationSkimmer {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Router.Skim.OriginDestinationSkimmer = {
            BeamConfig.Beam.Router.Skim.OriginDestinationSkimmer(
              ...
              poolingTravelTimeOverheadFactor                = if(c.hasPathOrNull("poolingTravelTimeOverheadFactor")) c.getDouble("poolingTravelTimeOverheadFactor") else 1.21,
              writeAllModeSkimsForPeakNonPeakPeriodsInterval = if(c.hasPathOrNull("writeAllModeSkimsForPeakNonPeakPeriodsInterval")) c.getInt("writeAllModeSkimsForPeakNonPeakPeriodsInterval") else 0,
              writeFullSkimsInterval                         = if(c.hasPathOrNull("writeFullSkimsInterval")) c.getInt("writeFullSkimsInterval") else 0
            )
          }
        }
        ...
        object TransitCrowdingSkimmer {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Router.Skim.TransitCrowdingSkimmer = {
            BeamConfig.Beam.Router.Skim.TransitCrowdingSkimmer(
              fileBaseName = if(c.hasPathOrNull("fileBaseName")) c.getString("fileBaseName") else "skimsTransitCrowding",
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Router.Skim = {
          BeamConfig.Beam.Router.Skim(
            ...
            drive_time_skimmer                      = BeamConfig.Beam.Router.Skim.DriveTimeSkimmer(if(c.hasPathOrNull("drive-time-skimmer")) c.getConfig("drive-time-skimmer") else com.typesafe.config.ConfigFactory.parseString("drive-time-skimmer{}")),
            emissions_skimmer                       = BeamConfig.Beam.Router.Skim.EmissionsSkimmer(if(c.hasPathOrNull("emissions-skimmer")) c.getConfig("emissions-skimmer") else com.typesafe.config.ConfigFactory.parseString("emissions-skimmer{}")),
            keepKLatestSkims                        = if(c.hasPathOrNull("keepKLatestSkims")) c.getInt("keepKLatestSkims") else 1,
            origin_destination_skimmer              = BeamConfig.Beam.Router.Skim.OriginDestinationSkimmer(if(c.hasPathOrNull("origin-destination-skimmer")) c.getConfig("origin-destination-skimmer") else com.typesafe.config.ConfigFactory.parseString("origin-destination-skimmer{}")),
            origin_destination_vehicle_type_skimmer = BeamConfig.Beam.Router.Skim.OriginDestinationVehicleTypeSkimmer(if(c.hasPathOrNull("origin-destination-vehicle-type-skimmer")) c.getConfig("origin-destination-vehicle-type-skimmer") else com.typesafe.config.ConfigFactory.parseString("origin-destination-vehicle-type-skimmer{}")),
            sendNonChosenTripsToSkimmer             = !c.hasPathOrNull("sendNonChosenTripsToSkimmer") || c.getBoolean("sendNonChosenTripsToSkimmer"),
            taz_skimmer                             = BeamConfig.Beam.Router.Skim.TazSkimmer(if(c.hasPathOrNull("taz-skimmer")) c.getConfig("taz-skimmer") else com.typesafe.config.ConfigFactory.parseString("taz-skimmer{}")),
            transit_crowding_skimmer                = BeamConfig.Beam.Router.Skim.TransitCrowdingSkimmer(if(c.hasPathOrNull("transit-crowding-skimmer")) c.getConfig("transit-crowding-skimmer") else com.typesafe.config.ConfigFactory.parseString("transit-crowding-skimmer{}")),
            writeAggregatedSkimsInterval            = if(c.hasPathOrNull("writeAggregatedSkimsInterval")) c.getInt("writeAggregatedSkimsInterval") else 0,
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Router = {
        BeamConfig.Beam.Router(
          requestAllAvailableModes = c.hasPathOrNull("requestAllAvailableModes") && c.getBoolean("requestAllAvailableModes"),
    ...
    object Routing {
      ...
      object R5 {
        ...
        case class StatePoolSize(
          bike                     : scala.Int,
          bike_transit_optimal     : scala.Int,
          bike_transit_suboptimal  : scala.Int,
          car                      : scala.Int,
          drive_transit_optimal    : scala.Int,
          drive_transit_suboptimal : scala.Int,
          primary                  : scala.Int,
          walk                     : scala.Int,
          walk_transit_optimal     : scala.Int,
          walk_transit_suboptimal  : scala.Int
        )
        object StatePoolSize {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing.R5.StatePoolSize = {
            BeamConfig.Beam.Routing.R5.StatePoolSize(
              ...
              bike_transit_optimal     = if(c.hasPathOrNull("bike_transit_optimal")) c.getInt("bike_transit_optimal") else 20000,
              bike_transit_suboptimal  = if(c.hasPathOrNull("bike_transit_suboptimal")) c.getInt("bike_transit_suboptimal") else 1000000,
              car                      = if(c.hasPathOrNull("car")) c.getInt("car") else 150000,
              drive_transit_optimal    = if(c.hasPathOrNull("drive_transit_optimal")) c.getInt("drive_transit_optimal") else 20000,
              drive_transit_suboptimal = if(c.hasPathOrNull("drive_transit_suboptimal")) c.getInt("drive_transit_suboptimal") else 1000000,
              primary                  = if(c.hasPathOrNull("primary")) c.getInt("primary") else 150000,
              walk                     = if(c.hasPathOrNull("walk")) c.getInt("walk") else 35000,
              walk_transit_optimal     = if(c.hasPathOrNull("walk_transit_optimal")) c.getInt("walk_transit_optimal") else 100000,
              walk_transit_suboptimal  = if(c.hasPathOrNull("walk_transit_suboptimal")) c.getInt("walk_transit_suboptimal") else 2000000
            )
          }
        }
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing.R5 = {
          BeamConfig.Beam.Routing.R5(
            accessBufferTimeSeconds         = BeamConfig.Beam.Routing.R5.AccessBufferTimeSeconds(if(c.hasPathOrNull("accessBufferTimeSeconds")) c.getConfig("accessBufferTimeSeconds") else com.typesafe.config.ConfigFactory.parseString("accessBufferTimeSeconds{}")),
            bikeLaneLinkIdsFilePath         = if(c.hasPathOrNull("bikeLaneLinkIdsFilePath")) c.getString("bikeLaneLinkIdsFilePath") else "",
            bikeLaneScaleFactor             = if(c.hasPathOrNull("bikeLaneScaleFactor")) c.getDouble("bikeLaneScaleFactor") else 1.0,
            ...
            maxTimeLimitForFreightInMinutes = if(c.hasPathOrNull("maxTimeLimitForFreightInMinutes")) c.getInt("maxTimeLimitForFreightInMinutes") else 300,
            ...
            statePoolSize                   = BeamConfig.Beam.Routing.R5.StatePoolSize(if(c.hasPathOrNull("statePoolSize")) c.getConfig("statePoolSize") else com.typesafe.config.ConfigFactory.parseString("statePoolSize{}")),
            suboptimalMinutes               = if(c.hasPathOrNull("suboptimalMinutes")) c.getInt("suboptimalMinutes") else 10,
            suboptimalMinutesForDriveAccess = if(c.hasPathOrNull("suboptimalMinutesForDriveAccess")) c.getInt("suboptimalMinutesForDriveAccess") else 2,
            transitAlternativeList          = if(c.hasPathOrNull("transitAlternativeList")) c.getString("transitAlternativeList") else "SUBOPTIMAL",
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing = {
        BeamConfig.Beam.Routing(
          ...
          gh                                    = BeamConfig.Beam.Routing.Gh(if(c.hasPathOrNull("gh")) c.getConfig("gh") else com.typesafe.config.ConfigFactory.parseString("gh{}")),
          minimumPossibleSkimBasedTravelTimeInS = if(c.hasPathOrNull("minimumPossibleSkimBasedTravelTimeInS")) c.getInt("minimumPossibleSkimBasedTravelTimeInS") else 60,
          overrideNetworkTravelTimesUsingSkims  = c.hasPathOrNull("overrideNetworkTravelTimesUsingSkims") && c.getBoolean("overrideNetworkTravelTimesUsingSkims"),
          r5                                    = BeamConfig.Beam.Routing.R5(if(c.hasPathOrNull("r5")) c.getConfig("r5") else com.typesafe.config.ConfigFactory.parseString("r5{}")),
          skimTravelTimesScalingFactor          = if(c.hasPathOrNull("skimTravelTimesScalingFactor")) c.getDouble("skimTravelTimesScalingFactor") else 0.0,
          startingIterationForTravelTimesMSA    = if(c.hasPathOrNull("startingIterationForTravelTimesMSA")) c.getInt("startingIterationForTravelTimesMSA") else 0,
    ...
    object Sim {
      ...
      object Metric {
        ...
        object Collector {
          ...
          object InfluxDbSimulationMetricCollector {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Sim.Metric.Collector.InfluxDbSimulationMetricCollector = {
              BeamConfig.Beam.Sim.Metric.Collector.InfluxDbSimulationMetricCollector(
                connectionString = if(c.hasPathOrNull("connectionString")) c.getString("connectionString") else "http://localhost:8086",
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Sim = {
        BeamConfig.Beam.Sim(
          ...
          termination = BeamConfig.Beam.Sim.Termination(if(c.hasPathOrNull("termination")) c.getConfig("termination") else com.typesafe.config.ConfigFactory.parseString("termination{}"))
        )
      }
    }
    ...
    object Urbansim {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Urbansim = {
        BeamConfig.Beam.Urbansim(
          ...
          fractionOfModesToClear   = BeamConfig.Beam.Urbansim.FractionOfModesToClear(if(c.hasPathOrNull("fractionOfModesToClear")) c.getConfig("fractionOfModesToClear") else com.typesafe.config.ConfigFactory.parseString("fractionOfModesToClear{}"))
        )
      }
    }
    ...
    object WarmStart {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.WarmStart = {
        BeamConfig.Beam.WarmStart(
          ...
          skimsFilePaths              = if(c.hasPathOrNull("skimsFilePaths")) scala.Some($_LBeamConfig_Beam_WarmStart_SkimsFilePaths$Elm(c.getList("skimsFilePaths"))) else None,
          `type`                      = if(c.hasPathOrNull("type")) c.getString("type") else "disabled"
        )
      }
      private def $_LBeamConfig_Beam_WarmStart_SkimsFilePaths$Elm(cl:com.typesafe.config.ConfigList): scala.List[BeamConfig.Beam.WarmStart.SkimsFilePaths$Elm] = {
        import scala.collection.JavaConverters._
    ...
    def apply(c: com.typesafe.config.Config): BeamConfig.Beam = {
      BeamConfig.Beam(
        ...
        exchange        = BeamConfig.Beam.Exchange(if(c.hasPathOrNull("exchange")) c.getConfig("exchange") else com.typesafe.config.ConfigFactory.parseString("exchange{}")),
        experimental    = BeamConfig.Beam.Experimental(if(c.hasPathOrNull("experimental")) c.getConfig("experimental") else com.typesafe.config.ConfigFactory.parseString("experimental{}")),
        input           = BeamConfig.Beam.Input(if(c.hasPathOrNull("input")) c.getConfig("input") else com.typesafe.config.ConfigFactory.parseString("input{}")),
        inputDirectory  = if(c.hasPathOrNull("inputDirectory")) c.getString("inputDirectory") else "/test/input/beamville",
        logger          = BeamConfig.Beam.Logger(if(c.hasPathOrNull("logger")) c.getConfig("logger") else com.typesafe.config.ConfigFactory.parseString("logger{}")),
        ...
        output          = BeamConfig.Beam.Output(if(c.hasPathOrNull("output")) c.getConfig("output") else com.typesafe.config.ConfigFactory.parseString("output{}")),
        ...
        replanning      = BeamConfig.Beam.Replanning(if(c.hasPathOrNull("replanning")) c.getConfig("replanning") else com.typesafe.config.ConfigFactory.parseString("replanning{}")),
        router          = BeamConfig.Beam.Router(if(c.hasPathOrNull("router")) c.getConfig("router") else com.typesafe.config.ConfigFactory.parseString("router{}")),
        ...
        sim             = BeamConfig.Beam.Sim(if(c.hasPathOrNull("sim")) c.getConfig("sim") else com.typesafe.config.ConfigFactory.parseString("sim{}")),
        ...
        urbansim        = BeamConfig.Beam.Urbansim(if(c.hasPathOrNull("urbansim")) c.getConfig("urbansim") else com.typesafe.config.ConfigFactory.parseString("urbansim{}")),
    ...
    object Modules {
      ...
      object LinkStats {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.LinkStats = {
          BeamConfig.Matsim.Modules.LinkStats(
            averageLinkStatsOverIterations = if(c.hasPathOrNull("averageLinkStatsOverIterations")) c.getInt("averageLinkStatsOverIterations") else 5,
            writeLinkStatsInterval         = if(c.hasPathOrNull("writeLinkStatsInterval")) c.getInt("writeLinkStatsInterval") else 10
          )
        }
      }
      ...
      object Network {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Network = {
          BeamConfig.Matsim.Modules.Network(
            inputNetworkFile = if(c.hasPathOrNull("inputNetworkFile")) c.getString("inputNetworkFile") else "/test/input/beamville/r5/physsim-network.xml"
          )
        }
      }
      ...
      object Strategy {
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Strategy = {
          BeamConfig.Matsim.Modules.Strategy(
            ...
            fractionOfIterationsToDisableInnovation = if(c.hasPathOrNull("fractionOfIterationsToDisableInnovation")) c.getInt("fractionOfIterationsToDisableInnovation") else 999999,
            maxAgentPlanMemorySize                  = if(c.hasPathOrNull("maxAgentPlanMemorySize")) c.getInt("maxAgentPlanMemorySize") else 5,
            parameterset                            = $_LBeamConfig_Matsim_Modules_Strategy_Parameterset$Elm(c.getList("parameterset")),
            planSelectorForRemoval                  = if(c.hasPathOrNull("planSelectorForRemoval")) c.getString("planSelectorForRemoval") else "WorstPlanForRemovalSelector"
          )
        }
        private def $_LBeamConfig_Matsim_Modules_Strategy_Parameterset$Elm(cl:com.typesafe.config.ConfigList): scala.List[BeamConfig.Matsim.Modules.Strategy.Parameterset$Elm] = {
          import scala.collection.JavaConverters._
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules = {
        BeamConfig.Matsim.Modules(
          ...
          linkStats             = BeamConfig.Matsim.Modules.LinkStats(if(c.hasPathOrNull("linkStats")) c.getConfig("linkStats") else com.typesafe.config.ConfigFactory.parseString("linkStats{}")),
