// generated by tscfg 0.9.4 on Tue Apr 14 21:39:07 PDT 2020
      ...
      object Agents {
        ...
        object RideHail {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager = {
              BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager(
                ...
                matchingAlgorithm =
                  ...
                  else "VEHICLE_CENTRIC_MATCHING_FOR_RIDEHAIL",
          ...
          case class RepositioningManager(
            demandFollowingPerDistanceSquaredRepositioning: BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager.DemandFollowingPerDistanceSquaredRepositioning,
          ...
          object RepositioningManager {
            case class DemandFollowingPerDistanceSquaredRepositioning(
            ...
            object DemandFollowingPerDistanceSquaredRepositioning {

              def apply(
                c: com.typesafe.config.Config
              ): BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager.DemandFollowingPerDistanceSquaredRepositioning = {
                BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager
                  .DemandFollowingPerDistanceSquaredRepositioning(
                    predictionHorizon =
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager = {
              BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager(
                demandFollowingPerDistanceSquaredRepositioning =
                  BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager
                    .DemandFollowingPerDistanceSquaredRepositioning(
                      if (c.hasPathOrNull("demandFollowingPerDistanceSquaredRepositioning"))
                        c.getConfig("demandFollowingPerDistanceSquaredRepositioning")
                      else
                        com.typesafe.config.ConfigFactory
                          .parseString("demandFollowingPerDistanceSquaredRepositioning{}")
                    ),
