// generated by tscfg 0.8.1 on Fri Sep 15 16:34:52 IST 2017
...
object BeamConfig {
  ...
  object Beam {
        ...
        object ModalBehaviors {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors = {
            BeamConfig.Beam.Agentsim.Agents.ModalBehaviors(
              ...
              modeChoiceParametersFile = if(c.hasPathOrNull("modeChoiceParametersFile")) c.getString("modeChoiceParametersFile") else "/home/fidel101/SmartMobility/TL/beam/test/input/beam-developers/modeChoiceParameters.xml"
            )
          }
        }
    ...
    case class Levels(
      beamLoggingLevels : java.lang.String
    )
    object Levels {
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Levels = {
        BeamConfig.Beam.Levels(
          beamLoggingLevels = if(c.hasPathOrNull("beamLoggingLevels")) c.getString("beamLoggingLevels") else ""
        )
      }
    }
    ...
    object Outputs {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Outputs = {
        BeamConfig.Beam.Outputs(
          ...
          outputDirectory         = if(c.hasPathOrNull("outputDirectory")) c.getString("outputDirectory") else "/home/fidel101/SmartMobility/TL/beam/test/output",
      ...
      object Gtfs {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing.Gtfs = {
          BeamConfig.Beam.Routing.Gtfs(
            ...
            outputDir     = if(c.hasPathOrNull("outputDir")) c.getString("outputDir") else "/home/fidel101/SmartMobility/TL/beam/test/output/gtfs"
          )
        }
      }
      ...
      object R5 {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing.R5 = {
          BeamConfig.Beam.Routing.R5(
            ...
            directory       = if(c.hasPathOrNull("directory")) c.getString("directory") else "/home/fidel101/SmartMobility/TL/beam/test/input/beam-developers/model-inputs/r5"
          )
        }
      }
    ...
    def apply(c: com.typesafe.config.Config): BeamConfig.Beam = {
      BeamConfig.Beam(
        ...
        sharedInputs = if(c.hasPathOrNull("sharedInputs")) c.getString("sharedInputs") else "/home/fidel101/SmartMobility/TL/beam/test/input/beam-developers",
  ...
  case class Matsim(
    R5Packages : scala.List[java.lang.String],
    levels     : BeamConfig.Matsim.Levels,
    modules    : BeamConfig.Matsim.Modules
  )
  object Matsim {
    case class Levels(
      dependencyLoggingLevels : scala.List[java.lang.String]
    )
    object Levels {
      def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Levels = {
        BeamConfig.Matsim.Levels(
          dependencyLoggingLevels = $_L$_str(c.getList("dependencyLoggingLevels"))
        )
      }
    }
      ...
      object Controler {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Controler = {
          BeamConfig.Matsim.Modules.Controler(
            ...
            outputDirectory  = if(c.hasPathOrNull("outputDirectory")) c.getString("outputDirectory") else "/home/fidel101/SmartMobility/TL/beam/test/output/pt-tutorial"
          )
        }
      }
      ...
      object Network {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Network = {
          BeamConfig.Matsim.Modules.Network(
            inputNetworkFile = if(c.hasPathOrNull("inputNetworkFile")) c.getString("inputNetworkFile") else "/home/fidel101/SmartMobility/TL/beam/test/input/beam-developers/model-inputs/dev/multimodalnetwork.xml"
          )
        }
      }
      ...
      object Plans {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Plans = {
          BeamConfig.Matsim.Modules.Plans(
            inputPlansFile = if(c.hasPathOrNull("inputPlansFile")) c.getString("inputPlansFile") else "/home/fidel101/SmartMobility/TL/beam/test/input/beam-developers/model-inputs/dev/population-500.xml"
          )
        }
      }
    ...
    def apply(c: com.typesafe.config.Config): BeamConfig.Matsim = {
      BeamConfig.Matsim(
        R5Packages = $_L$_str(c.getList("R5Packages")),
