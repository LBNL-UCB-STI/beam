// generated by tscfg 0.9.4 on Fri May 15 00:12:29 ICT 2020
  ...
  object Beam {
    ...
    object Physsim {
      case class Cch(
        ...
        enableVerboseOutput : scala.Boolean
      )
      object Cch {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Cch = {
          BeamConfig.Beam.Physsim.Cch(
            ...
            enableVerboseOutput = c.hasPathOrNull("enableVerboseOutput") && c.getBoolean("enableVerboseOutput")
          )
        }
      }
