// generated by tscfg 0.8.1 on Sun Aug 12 21:25:24 PDT 2018
      ...
      object Agents {
        ...
        object Vehicles {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles = {
            BeamConfig.Beam.Agentsim.Agents.Vehicles(
              bicycles = BeamConfig.Beam.Agentsim.Agents.Vehicles.Bicycles(c.getConfig("bicycles"))
            )
          }
        }
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents = {
          BeamConfig.Beam.Agentsim.Agents(
            ...
            vehicles       = BeamConfig.Beam.Agentsim.Agents.Vehicles(c.getConfig("vehicles"))
          )
        }
      }
