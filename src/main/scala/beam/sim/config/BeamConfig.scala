// generated by tscfg 0.8.1 on Mon Jul 30 15:52:18 ICT 2018
        ...
        object RideHail {
          ...
          object AllocationManager {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager = {
              BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager(
                ...
                randomRepositioning       = BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager.RandomRepositioning(c.getConfig("randomRepositioning")),
                repositionLowWaitingTimes = BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager.RepositionLowWaitingTimes(c.getConfig("repositionLowWaitingTimes")),
          ...
          object InitialLocation {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.InitialLocation = {
              BeamConfig.Beam.Agentsim.Agents.RideHail.InitialLocation(
                home = BeamConfig.Beam.Agentsim.Agents.RideHail.InitialLocation.Home(c.getConfig("home")),
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail = {
            BeamConfig.Beam.Agentsim.Agents.RideHail(
              allocationManager                = BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager(c.getConfig("allocationManager")),
              ...
              initialLocation                  = BeamConfig.Beam.Agentsim.Agents.RideHail.InitialLocation(c.getConfig("initialLocation")),
              ...
              rideHailManager                  = BeamConfig.Beam.Agentsim.Agents.RideHail.RideHailManager(c.getConfig("rideHailManager")),
    ...
    object Debug {
      ...
      object StuckAgentDetection {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Debug.StuckAgentDetection = {
          BeamConfig.Beam.Debug.StuckAgentDetection(
            ...
            isOn               = c.hasPathOrNull("isOn") && c.getBoolean("isOn"),
            markAsStuckAfterMs = if(c.hasPathOrNull("markAsStuckAfterMs")) c.getDuration("markAsStuckAfterMs", java.util.concurrent.TimeUnit.MILLISECONDS) else 30000
          )
        }
      }
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Debug = {
        BeamConfig.Beam.Debug(
          ...
          stuckAgentDetection          = BeamConfig.Beam.Debug.StuckAgentDetection(c.getConfig("stuckAgentDetection"))
        )
      }
    }
      ...
      object Jdeqsim {
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Jdeqsim = {
          BeamConfig.Beam.Physsim.Jdeqsim(
            agentSimPhysSimInterfaceDebugger = BeamConfig.Beam.Physsim.Jdeqsim.AgentSimPhysSimInterfaceDebugger(c.getConfig("agentSimPhysSimInterfaceDebugger"))
          )
        }
      }
