// generated by tscfg 0.8.1 on Wed Sep 20 17:40:47 PDT 2017
  ...
  object Beam {
        ...
        object ModalBehaviors {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors = {
            BeamConfig.Beam.Agentsim.Agents.ModalBehaviors(
              ...
              modeChoiceParametersFile = if(c.hasPathOrNull("modeChoiceParametersFile")) c.getString("modeChoiceParametersFile") else "/Users/daddy30000/14_Mobility_Sim/GoogleDrive/beam/my-developers//modeChoiceParameters.xml"
            )
          }
        }
    ...
    object Outputs {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Outputs = {
        BeamConfig.Beam.Outputs(
          ...
          outputDirectory         = if(c.hasPathOrNull("outputDirectory")) c.getString("outputDirectory") else "/Users/daddy30000/dev/data/beam_outputs",
      ...
      object Gtfs {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing.Gtfs = {
          BeamConfig.Beam.Routing.Gtfs(
            ...
            outputDir     = if(c.hasPathOrNull("outputDir")) c.getString("outputDir") else "/Users/daddy30000/dev/data/beam_outputs/gtfs"
          )
        }
      }
      ...
      object R5 {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing.R5 = {
          BeamConfig.Beam.Routing.R5(
            ...
            directory       = if(c.hasPathOrNull("directory")) c.getString("directory") else "/Users/daddy30000/14_Mobility_Sim/GoogleDrive/beam/my-developers//model-inputs/r5",
            osmFile         = if(c.hasPathOrNull("osmFile")) c.getString("osmFile") else "/Users/daddy30000/14_Mobility_Sim/GoogleDrive/beam/my-developers//model-inputs/r5/bay_area_all_roads.osm.pbf",
            osmMapdbFile    = if(c.hasPathOrNull("osmMapdbFile")) c.getString("osmMapdbFile") else "/Users/daddy30000/14_Mobility_Sim/GoogleDrive/beam/my-developers//model-inputs/r5/osm.mapdb"
          )
        }
      }
    ...
    def apply(c: com.typesafe.config.Config): BeamConfig.Beam = {
      BeamConfig.Beam(
        ...
        sharedInputs = if(c.hasPathOrNull("sharedInputs")) c.getString("sharedInputs") else "/Users/daddy30000/14_Mobility_Sim/GoogleDrive/beam/my-developers/",
      ...
      object Controler {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Controler = {
          BeamConfig.Matsim.Modules.Controler(
            ...
            outputDirectory  = if(c.hasPathOrNull("outputDirectory")) c.getString("outputDirectory") else "/Users/daddy30000/dev/data/beam_outputs/pt-tutorial"
          )
        }
      }
      ...
      object Network {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Network = {
          BeamConfig.Matsim.Modules.Network(
            inputNetworkFile = if(c.hasPathOrNull("inputNetworkFile")) c.getString("inputNetworkFile") else "/Users/daddy30000/14_Mobility_Sim/GoogleDrive/beam/my-developers//model-inputs/dev/multimodalnetwork.xml"
          )
        }
      }
      ...
      object Plans {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Plans = {
          BeamConfig.Matsim.Modules.Plans(
            inputPlansFile = if(c.hasPathOrNull("inputPlansFile")) c.getString("inputPlansFile") else "/Users/daddy30000/14_Mobility_Sim/GoogleDrive/beam/my-developers//model-inputs/dev/population-500.xml"
          )
        }
      }
