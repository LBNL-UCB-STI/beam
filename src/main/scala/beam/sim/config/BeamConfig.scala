// generated by tscfg 0.8.1 on Thu Jun 28 11:58:44 PKT 2018
        ...
        object RideHailing {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHailing = {
            BeamConfig.Beam.Agentsim.Agents.RideHailing(
              allocationManager                         = if(c.hasPathOrNull("allocationManager")) c.getString("allocationManager") else "DEFAULT_RIDEHAIL_ALLOCATION_MANAGER",
