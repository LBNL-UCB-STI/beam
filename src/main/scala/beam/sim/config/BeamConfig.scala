// generated by tscfg 0.9.4 on Fri Feb 22 18:06:55 IST 2019
...
object BeamConfig {
  ...
  object Beam {
    ...
    case class Replanning(
      ...
      anchorEndTimeMutator                    : BeamConfig.Beam.Replanning.AnchorEndTimeMutator,
      fractionOfIterationsToDisableInnovation : scala.Double,
      maxAgentPlanMemorySize                  : scala.Int
    )
    object Replanning {
      case class AnchorEndTimeMutator(
        mutation : BeamConfig.Beam.Replanning.AnchorEndTimeMutator.Mutation
      )
      object AnchorEndTimeMutator {
        ...
        object Mutation {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Replanning.AnchorEndTimeMutator.Mutation = {
            BeamConfig.Beam.Replanning.AnchorEndTimeMutator.Mutation(
              range = if(c.hasPathOrNull("range")) c.getInt("range") else 1
            )
          }
        }
              
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Replanning.AnchorEndTimeMutator = {
          BeamConfig.Beam.Replanning.AnchorEndTimeMutator(
            mutation = BeamConfig.Beam.Replanning.AnchorEndTimeMutator.Mutation(if(c.hasPathOrNull("mutation")) c.getConfig("mutation") else com.typesafe.config.ConfigFactory.parseString("mutation{}"))
          )
        }
      }
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Replanning = {
        BeamConfig.Beam.Replanning(
          ...
          anchorEndTimeMutator                    = BeamConfig.Beam.Replanning.AnchorEndTimeMutator(if(c.hasPathOrNull("anchorEndTimeMutator")) c.getConfig("anchorEndTimeMutator") else com.typesafe.config.ConfigFactory.parseString("anchorEndTimeMutator{}")),
