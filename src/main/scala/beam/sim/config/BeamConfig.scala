      ...
      object R5 {
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing.R5 = {
          BeamConfig.Beam.Routing.R5(
            ...
            rideHailPooledTransitRoutingBufferInSeconds =
              if (c.hasPathOrNull("rideHailPooledTransitRoutingBufferInSeconds"))
                c.getInt("rideHailPooledTransitRoutingBufferInSeconds")
              else 360,
            ...
            vehicleTypeSpeedLimitsAsPortionOfFreeFlow =
              if (c.hasPathOrNull("vehicleTypeSpeedLimitsAsPortionOfFreeFlow"))
                scala.Some($_L$_str(c.getList("vehicleTypeSpeedLimitsAsPortionOfFreeFlow")))
              else None
          )
        }
      }
