// generated by tscfg 0.8.1 on Tue Sep 19 18:04:41 IST 2017
...
object BeamConfig {
  ...
  object Beam {
    ...
    case class Levels(
      beamLoggingLevel : java.lang.String
    )
    object Levels {
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Levels = {
        BeamConfig.Beam.Levels(
          beamLoggingLevel = if(c.hasPathOrNull("beamLoggingLevel")) c.getString("beamLoggingLevel") else ""
        )
      }
    }
