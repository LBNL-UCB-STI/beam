  ...
  object Beam {
    ...
    object Sim {
      ...
      case class Termination(
        ...
        terminateAtFleetStoredElectricityConvergence : BeamConfig.Beam.Sim.Termination.TerminateAtFleetStoredElectricityConvergence
      )
      object Termination {
        case class TerminateAtFleetStoredElectricityConvergence(
          maxLastIteration  : scala.Int,
          minLastIteration  : scala.Int,
          relativeTolerance : scala.Double
        )
        object TerminateAtFleetStoredElectricityConvergence {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Sim.Termination.TerminateAtFleetStoredElectricityConvergence = {
            BeamConfig.Beam.Sim.Termination.TerminateAtFleetStoredElectricityConvergence(
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Sim.Termination = {
          BeamConfig.Beam.Sim.Termination(
            ...
            terminateAtFleetStoredElectricityConvergence = BeamConfig.Beam.Sim.Termination.TerminateAtFleetStoredElectricityConvergence(if(c.hasPathOrNull("terminateAtFleetStoredElectricityConvergence")) c.getConfig("terminateAtFleetStoredElectricityConvergence") else com.typesafe.config.ConfigFactory.parseString("terminateAtFleetStoredElectricityConvergence{}"))
          )
        }
      }
