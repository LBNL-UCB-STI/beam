// generated by tscfg 0.9.4 on Thu Oct 18 08:01:30 PDT 2018
        ...
        object Population {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Population = {
            BeamConfig.Beam.Agentsim.Agents.Population(
              beamPopulationFile = if(c.hasPathOrNull("beamPopulationFile")) c.getString("beamPopulationFile") else "/test/input/beamville/population.csv"
            )
          }
        }
