      ...
      object ChargingNetworkManager {
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.ChargingNetworkManager = {
          BeamConfig.Beam.Agentsim.ChargingNetworkManager(
            ...
            parkingFilePath         = if(c.hasPathOrNull("parkingFilePath")) c.getString("parkingFilePath") else "",
            scaleUpExpansionFactor  = if(c.hasPathOrNull("scaleUpExpansionFactor")) c.getDouble("scaleUpExpansionFactor") else 1.0,
            stallCostScalingFactor  = if(c.hasPathOrNull("stallCostScalingFactor")) c.getDouble("stallCostScalingFactor") else 1.0,
            stallCountScalingFactor = if(c.hasPathOrNull("stallCountScalingFactor")) c.getDouble("stallCountScalingFactor") else 1.0,
