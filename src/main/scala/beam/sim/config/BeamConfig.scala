// generated by tscfg 0.9.4 on Tue Apr 07 11:37:37 PDT 2020
        ...
        object RideHail {
          ...
          object RepositioningManager {
            case class DemandFollowingRepositioningManager(
              ...
              sensitivityToDistance                     : scala.Double
            )
            object DemandFollowingRepositioningManager {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager.DemandFollowingRepositioningManager = {
                BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager.DemandFollowingRepositioningManager(
                  ...
                  sensitivityToDistance                     = if(c.hasPathOrNull("sensitivityToDistance")) c.getDouble("sensitivityToDistance") else 0.2
                )
              }
            }
