// generated by tscfg 0.8.1 on Tue Oct 03 20:45:48 PDT 2017
...
object BeamConfig {
  ...
  object Beam {
        ...
        object ModalBehaviors {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors = {
            BeamConfig.Beam.Agentsim.Agents.ModalBehaviors(
              ...
              modeChoiceParametersFile = if(c.hasPathOrNull("modeChoiceParametersFile")) c.getString("modeChoiceParametersFile") else "/Users/critter/Dropbox/ucb/vto/beam-all/beam/test/input/beam-developers/modeChoiceParameters.xml"
            )
          }
        }
    ...
    case class Outputs(
      ...
      overrideLoggingLevels   : java.lang.String,
    ...
    object Outputs {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Outputs = {
        BeamConfig.Beam.Outputs(
          defaultLoggingLevel     = if(c.hasPathOrNull("defaultLoggingLevel")) c.getString("defaultLoggingLevel") else "OFF",
          ...
          overrideLoggingLevels   = if(c.hasPathOrNull("overrideLoggingLevels")) c.getString("overrideLoggingLevels") else "ModeChoiceEvent:VERBOSE,PathTraversalEvent:VERBOSE",
    ...
    def apply(c: com.typesafe.config.Config): BeamConfig.Beam = {
      BeamConfig.Beam(
        ...
        sharedInputs = if(c.hasPathOrNull("sharedInputs")) c.getString("sharedInputs") else "/Users/critter/Dropbox/ucb/vto/beam-all/beam/test/input/beam-developers",
      ...
      object Network {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Network = {
          BeamConfig.Matsim.Modules.Network(
            inputNetworkFile = if(c.hasPathOrNull("inputNetworkFile")) c.getString("inputNetworkFile") else "/Users/critter/Dropbox/ucb/vto/beam-all/beam/test/input/beam-developers/model-inputs/dev/multimodalnetwork.xml"
          )
        }
      }
      ...
      object Plans {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Plans = {
          BeamConfig.Matsim.Modules.Plans(
            inputPlansFile = if(c.hasPathOrNull("inputPlansFile")) c.getString("inputPlansFile") else "/Users/critter/Dropbox/ucb/vto/beam-all/beam/test/input/beam-developers/model-inputs/dev/population-500.xml"
          )
        }
      }
