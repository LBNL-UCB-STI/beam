// generated by tscfg 0.9.4 on Thu Jan 17 21:09:51 PKT 2019
...
object BeamConfig {
  ...
  object Beam {
    ...
    case class Routing(
      ...
      useMsaAfterIteration   : scala.Int
    )
    object Routing {
      case class R5(
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing = {
        BeamConfig.Beam.Routing(
          ...
          useMsaAfterIteration   = if(c.hasPathOrNull("useMsaAfterIteration")) c.getInt("useMsaAfterIteration") else 0
        )
      }
    }
