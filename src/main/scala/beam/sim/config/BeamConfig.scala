    ...
    object Agentsim {
      ...
      object Taz {
        case class ParkingManager(
          ...
          residentialParkingFilePath : java.lang.String
        )
        object ParkingManager {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Taz.ParkingManager = {
            BeamConfig.Beam.Agentsim.Taz.ParkingManager(
              ...
              residentialParkingFilePath = if(c.hasPathOrNull("residentialParkingFilePath")) c.getString("residentialParkingFilePath") else ""
            )
          }
        }
