        ...
        object RideHail {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail = {
            BeamConfig.Beam.Agentsim.Agents.RideHail(
              ...
              vehicleManagerId               = if(c.hasPathOrNull("vehicleManagerId")) c.getString("vehicleManagerId") else "ride-hail-default"
            )
          }
        }
      ...
      object ChargingNetworkManager {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.ChargingNetworkManager = {
          BeamConfig.Beam.Agentsim.ChargingNetworkManager(
            ...
            helicsDataInStreamPoint  = if(c.hasPathOrNull("helicsDataInStreamPoint")) c.getString("helicsDataInStreamPoint") else "GridFed/PhysicalBounds",
            helicsDataOutStreamPoint = if(c.hasPathOrNull("helicsDataOutStreamPoint")) c.getString("helicsDataOutStreamPoint") else "PowerDemand",
            helicsFederateName       = if(c.hasPathOrNull("helicsFederateName")) c.getString("helicsFederateName") else "CNMFederate",
