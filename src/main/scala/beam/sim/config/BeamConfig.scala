// generated by tscfg 0.9.4 on Mon Jan 06 12:10:36 PST 2020
    ...
    object Agentsim {
      ...
      object Agents {
            ...
            object AlonsoMora {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager.AlonsoMora = {
                BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager.AlonsoMora(
                  solutionSpaceSizePerVehicle = if(c.hasPathOrNull("solutionSpaceSizePerVehicle")) c.getInt("solutionSpaceSizePerVehicle") else 5,
                  travelTimeDelayAsFraction   = if(c.hasPathOrNull("travelTimeDelayAsFraction")) c.getDouble("travelTimeDelayAsFraction") else 0.2,
        ...
        case class Vehicles(
          ...
          electricVehicleRangeMethod     : java.lang.String,
          electricVehicleRangeOverride   : scala.Int,
          fractionOfInitialVehicleFleet  : scala.Double,
        ...
        object Vehicles {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles = {
            BeamConfig.Beam.Agentsim.Agents.Vehicles(
              ...
              electricVehicleRangeMethod     = if(c.hasPathOrNull("electricVehicleRangeMethod")) c.getString("electricVehicleRangeMethod") else "FROM_FILE",
              electricVehicleRangeOverride   = if(c.hasPathOrNull("electricVehicleRangeOverride")) c.getInt("electricVehicleRangeOverride") else 100,
      ...
      object Taz {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Taz = {
          BeamConfig.Beam.Agentsim.Taz(
            defaultChargerCostPerHourInDollars = if(c.hasPathOrNull("defaultChargerCostPerHourInDollars")) c.getDouble("defaultChargerCostPerHourInDollars") else 30.0,
            ...
            parkingStallChargerDefaultType     = if(c.hasPathOrNull("parkingStallChargerDefaultType")) c.getString("parkingStallChargerDefaultType") else "Custom(150.0|DC)",
            parkingStallChargerInitMethod      = if(c.hasPathOrNull("parkingStallChargerInitMethod")) c.getString("parkingStallChargerInitMethod") else "FROM_FILE",
        ...
        object Cacc {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Jdeqsim.Cacc = {
            BeamConfig.Beam.Physsim.Jdeqsim.Cacc(
              ...
              minimumRoadSpeedInMetersPerSecond = if(c.hasPathOrNull("minimumRoadSpeedInMetersPerSecond")) c.getDouble("minimumRoadSpeedInMetersPerSecond") else 1.3,
