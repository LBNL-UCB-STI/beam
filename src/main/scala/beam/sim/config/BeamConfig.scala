      ...
      object R5 {
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing.R5 = {
          BeamConfig.Beam.Routing.R5(
            ...
            osmFilePath                    = if(c.hasPathOrNull("osmFilePath")) c.getString("osmFilePath") else "/test/input/beamville/r5/beamville.osm.pbf",
            osmMapdbFilePath               = if(c.hasPathOrNull("osmMapdbFilePath")) c.getString("osmMapdbFilePath") else "/test/input/beamville/r5/osm.mapdb",
