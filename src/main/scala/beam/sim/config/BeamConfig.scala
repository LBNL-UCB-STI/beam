// generated by tscfg 0.8.1 on Mon Jun 18 08:37:46 PDT 2018
        ...
        object RideHail {
          ...
          object AllocationManager {
            ...
            case class RepositionLowWaitingTimes(
              minimumNumberOfIdlingVehiclesThreshholdForRepositioning : scala.Int,
              percentageOfVehiclesToReposition                        : scala.Double,
              repositionCircleRadisInMeters                           : scala.Double,
            ...
            object RepositionLowWaitingTimes {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager.RepositionLowWaitingTimes = {
                BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager.RepositionLowWaitingTimes(
                  minimumNumberOfIdlingVehiclesThreshholdForRepositioning = if(c.hasPathOrNull("minimumNumberOfIdlingVehiclesThreshholdForRepositioning")) c.getInt("minimumNumberOfIdlingVehiclesThreshholdForRepositioning") else 1,
                  ...
                  repositionCircleRadisInMeters                           = if(c.hasPathOrNull("repositionCircleRadisInMeters")) c.getDouble("repositionCircleRadisInMeters") else 3000,
