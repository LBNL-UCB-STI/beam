  ...
  object Beam {
    ...
    object Outputs {
      case class Events(
        ...
        extraEventsToWrite : scala.Option[java.lang.String],
      ...
      object Events {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Outputs.Events = {
          BeamConfig.Beam.Outputs.Events(
            ...
            extraEventsToWrite = if(c.hasPathOrNull("extraEventsToWrite")) Some(c.getString("extraEventsToWrite")) else None,
