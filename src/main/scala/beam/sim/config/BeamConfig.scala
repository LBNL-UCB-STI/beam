// generated by tscfg 0.8.1 on Tue Jan 02 10:47:50 PST 2018
      ...
      object Transit {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Transit = {
          BeamConfig.Matsim.Modules.Transit(
            ...
            vehiclesFile = if (c.hasPathOrNull("vehiclesFile")) c.getString("vehiclesFile") else "/Users/critter/Dropbox/ucb/vto/beam-all/beam/test/input/beamville/transitVehicles.xml"
          )
        }
      }
