      ...
      object Output {
        ...
        object SecondaryActivitySimSkimmer {
          ...
          object GeoZoneMapping {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Exchange.Output.SecondaryActivitySimSkimmer.GeoZoneMapping = {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Exchange.Output.SecondaryActivitySimSkimmer = {
            BeamConfig.Beam.Exchange.Output.SecondaryActivitySimSkimmer(
              ...
              enabled                 = c.hasPathOrNull("enabled") && c.getBoolean("enabled"),
              geoZoneMapping          = if(c.hasPathOrNull("geoZoneMapping")) scala.Some(BeamConfig.Beam.Exchange.Output.SecondaryActivitySimSkimmer.GeoZoneMapping(c.getConfig("geoZoneMapping"))) else None,
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Exchange.Output = {
          BeamConfig.Beam.Exchange.Output(
            secondary_activity_sim_skimmer = BeamConfig.Beam.Exchange.Output.SecondaryActivitySimSkimmer(if(c.hasPathOrNull("secondary-activity-sim-skimmer")) c.getConfig("secondary-activity-sim-skimmer") else com.typesafe.config.ConfigFactory.parseString("secondary-activity-sim-skimmer{}"))
          )
        }
      }
