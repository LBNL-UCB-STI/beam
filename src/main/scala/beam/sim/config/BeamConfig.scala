// generated by tscfg 0.9.4 on Wed May 27 19:20:01 NOVT 2020
...
object BeamConfig {
  ...
  object Beam {
    ...
    case class WarmStart(
      ...
      skimsFileNumberOfParts : scala.Int,
      skimsFilePartsTemplate : java.lang.String,
    ...
    object WarmStart {
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.WarmStart = {
        BeamConfig.Beam.WarmStart(
          ...
          skimsFileNumberOfParts = if(c.hasPathOrNull("skimsFileNumberOfParts")) c.getInt("skimsFileNumberOfParts") else 0,
          skimsFilePartsTemplate = if(c.hasPathOrNull("skimsFilePartsTemplate")) c.getString("skimsFilePartsTemplate") else "",
