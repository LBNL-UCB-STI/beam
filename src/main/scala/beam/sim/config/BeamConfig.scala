// generated by tscfg 0.9.4 on Fri Apr 03 00:59:18 ICT 2020
  ...
  object Beam {
    ...
    object Routing {
      case class R5(
        ...
        distanceLimits: BeamConfig.Beam.Routing.R5.DistanceLimits,
      ...
      object R5 {
        case class DistanceLimits(
          bike: scala.Int
        )

        object DistanceLimits {

          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing.R5.DistanceLimits = {
            BeamConfig.Beam.Routing.R5.DistanceLimits(
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing.R5 = {
          BeamConfig.Beam.Routing.R5(
            ...
            distanceLimits = BeamConfig.Beam.Routing.R5.DistanceLimits(
              if (c.hasPathOrNull("distanceLimits")) c.getConfig("distanceLimits")
              else com.typesafe.config.ConfigFactory.parseString("distanceLimits{}")
            ),
            mNetBuilder = BeamConfig.Beam.Routing.R5.MNetBuilder(
