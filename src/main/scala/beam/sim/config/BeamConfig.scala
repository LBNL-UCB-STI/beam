// generated by tscfg 0.9.4 on Wed Mar 13 03:20:13 IST 2019
...
object BeamConfig {
  ...
  object Beam {
    ...
    case class Physsim(
      ...
      speedAdjustmentFactor: scala.Int,
      ...
      object Jdeqsim {
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Jdeqsim = {
          BeamConfig.Beam.Physsim.Jdeqsim(
            ...
            caccMinSpeedMetersPerSec =
              if (c.hasPathOrNull("caccMinSpeedMetersPerSec")) c.getInt("caccMinSpeedMetersPerSec") else 20
          )
        }
      }
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim = {
        BeamConfig.Beam.Physsim(
          ...
          speedAdjustmentFactor =
            if (c.hasPathOrNull("speedAdjustmentFactor")) c.getInt("speedAdjustmentFactor") else 1,
