// generated by tscfg 0.9.4 on Sun Aug 11 16:41:39 PDT 2019
        ...
        object RideHail {
          ...
          object AllocationManager {
            case class AlonsoMora(
              dropoffTimeWindowInSec : scala.Double,
            ...
            object AlonsoMora {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager.AlonsoMora = {
                BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager.AlonsoMora(
                  dropoffTimeWindowInSec = if(c.hasPathOrNull("dropoffTimeWindowInSec")) c.getDouble("dropoffTimeWindowInSec") else 0.2,
                  maxRequestsPerVehicle  = if(c.hasPathOrNull("maxRequestsPerVehicle")) c.getInt("maxRequestsPerVehicle") else 5,
                  pickupTimeWindowInSec  = if(c.hasPathOrNull("pickupTimeWindowInSec")) c.getInt("pickupTimeWindowInSec") else 360
                )
              }
            }
