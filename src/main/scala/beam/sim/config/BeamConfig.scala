    ...
    object Beamskimmer {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Beamskimmer = {
        BeamConfig.Beam.Beamskimmer(
          writeAllModeSkimsForPeakNonPeakPeriods =
            if (c.hasPathOrNull("writeAllModeSkimsForPeakNonPeakPeriods"))
              c.getInt("writeAllModeSkimsForPeakNonPeakPeriods")
            else 0,
          writeObservedSkims = if (c.hasPathOrNull("writeObservedSkims")) c.getInt("writeObservedSkims") else 0,
          writeObservedSkimsPlus =
            if (c.hasPathOrNull("writeObservedSkimsPlus")) c.getInt("writeObservedSkimsPlus") else 0
        )
      }
    }
