      ...
      object Agents {
        ...
        object RideHail {
          ...
          object AllocationManager {
            ...
            object AlonsoMora {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager.AlonsoMora = {
          ...
          object Initialization {
            ...
            object Parking {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Initialization.Parking = {
            ...
            object Procedural {
              ...
              object InitialLocation {
                ...
                object Home {
                  def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Initialization.Procedural.InitialLocation.Home = {
              ...
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Initialization.Procedural = {
                BeamConfig.Beam.Agentsim.Agents.RideHail.Initialization.Procedural(
                  ...
                  initialLocation               = BeamConfig.Beam.Agentsim.Agents.RideHail.Initialization.Procedural.InitialLocation(if(c.hasPathOrNull("initialLocation")) c.getConfig("initialLocation") else com.typesafe.config.ConfigFactory.parseString("initialLocation{}")),
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Initialization = {
              BeamConfig.Beam.Agentsim.Agents.RideHail.Initialization(
                ...
                parking    = BeamConfig.Beam.Agentsim.Agents.RideHail.Initialization.Parking(if(c.hasPathOrNull("parking")) c.getConfig("parking") else com.typesafe.config.ConfigFactory.parseString("parking{}")),
                procedural = BeamConfig.Beam.Agentsim.Agents.RideHail.Initialization.Procedural(if(c.hasPathOrNull("procedural")) c.getConfig("procedural") else com.typesafe.config.ConfigFactory.parseString("procedural{}"))
              )
            }
          }
          ...
          object RepositioningManager {
            ...
            object DemandFollowingRepositioningManager {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager.DemandFollowingRepositioningManager = {
            ...
            object InverseSquareDistanceRepositioningFactor {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager.InverseSquareDistanceRepositioningFactor = {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager = {
              BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager(
                ...
                inverseSquareDistanceRepositioningFactor = BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager.InverseSquareDistanceRepositioningFactor(if(c.hasPathOrNull("inverseSquareDistanceRepositioningFactor")) c.getConfig("inverseSquareDistanceRepositioningFactor") else com.typesafe.config.ConfigFactory.parseString("inverseSquareDistanceRepositioningFactor{}")),
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail = {
            BeamConfig.Beam.Agentsim.Agents.RideHail(
              ...
              initialization                 = BeamConfig.Beam.Agentsim.Agents.RideHail.Initialization(if(c.hasPathOrNull("initialization")) c.getConfig("initialization") else com.typesafe.config.ConfigFactory.parseString("initialization{}")),
              ...
              repositioningManager           = BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager(if(c.hasPathOrNull("repositioningManager")) c.getConfig("repositioningManager") else com.typesafe.config.ConfigFactory.parseString("repositioningManager{}")),
          ...
          object Destination {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles.Destination = {
              BeamConfig.Beam.Agentsim.Agents.Vehicles.Destination(
                ...
                noRefuelThresholdInMeters       = if(c.hasPathOrNull("noRefuelThresholdInMeters")) c.getInt("noRefuelThresholdInMeters") else 128720,
                refuelRequiredThresholdInMeters = if(c.hasPathOrNull("refuelRequiredThresholdInMeters")) c.getDouble("refuelRequiredThresholdInMeters") else 64373.8,
          ...
          object Enroute {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles.Enroute = {
              BeamConfig.Beam.Agentsim.Agents.Vehicles.Enroute(
                estimateOfMeanChargingDurationInSecond       = if(c.hasPathOrNull("estimateOfMeanChargingDurationInSecond")) c.getInt("estimateOfMeanChargingDurationInSecond") else 1800,
      ...
      object ChargingNetworkManager {
        ...
        object ScaleUp {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.ChargingNetworkManager.ScaleUp = {
            BeamConfig.Beam.Agentsim.ChargingNetworkManager.ScaleUp(
              ...
              enabled                           = c.hasPathOrNull("enabled") && c.getBoolean("enabled"),
              expansionFactor_charge_activity   = if(c.hasPathOrNull("expansionFactor_charge_activity")) c.getDouble("expansionFactor_charge_activity") else 1.0,
              expansionFactor_home_activity     = if(c.hasPathOrNull("expansionFactor_home_activity")) c.getDouble("expansionFactor_home_activity") else 1.0,
              expansionFactor_init_activity     = if(c.hasPathOrNull("expansionFactor_init_activity")) c.getDouble("expansionFactor_init_activity") else 1.0,
              expansionFactor_wherever_activity = if(c.hasPathOrNull("expansionFactor_wherever_activity")) c.getDouble("expansionFactor_wherever_activity") else 1.0,
              expansionFactor_work_activity     = if(c.hasPathOrNull("expansionFactor_work_activity")) c.getDouble("expansionFactor_work_activity") else 1.0
            )
          }
        }
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.ChargingNetworkManager = {
          BeamConfig.Beam.Agentsim.ChargingNetworkManager(
            ...
            maxChargingSessionsInSeconds    = if(c.hasPathOrNull("maxChargingSessionsInSeconds")) c.getInt("maxChargingSessionsInSeconds") else 43200,
