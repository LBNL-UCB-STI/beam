// generated by tscfg 0.9.4 on Wed Nov 13 19:21:07 PST 2019
        ...
        object Skimmers$Elm {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Router.Skim.Skimmers$Elm = {
            BeamConfig.Beam.Router.Skim.Skimmers$Elm(
              ...
              name = if (c.hasPathOrNull("name")) c.getString("name") else "give-a-name-to-skimmer",
              origin_destination_skimmer =
                if (c.hasPathOrNull("origin-destination-skimmer"))
                  scala.Some(
                    BeamConfig.Beam.Router.Skim.Skimmers$Elm
                      .OriginDestinationSkimmer(c.getConfig("origin-destination-skimmer"))
                  )
                else None,
              skimType = if (c.hasPathOrNull("skimType")) c.getString("skimType") else "give-type-here-for-id"
            )
          }
        }
