...
object BeamConfig {
  ...
  object Beam {
            ...
            object VehicleChargingManager {
              ...
              object DepotManager {
                ...
                object StallAssignmentStrategy {
                  def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Charging.VehicleChargingManager.DepotManager.StallAssignmentStrategy = {
                ...
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Charging.VehicleChargingManager.DepotManager = {
                  BeamConfig.Beam.Agentsim.Agents.RideHail.Charging.VehicleChargingManager.DepotManager(
                    stallAssignmentStrategy = BeamConfig.Beam.Agentsim.Agents.RideHail.Charging.VehicleChargingManager.DepotManager.StallAssignmentStrategy(if(c.hasPathOrNull("stallAssignmentStrategy")) c.getConfig("stallAssignmentStrategy") else com.typesafe.config.ConfigFactory.parseString("stallAssignmentStrategy{}"))
                  )
                }
              }
              ...
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Charging.VehicleChargingManager = {
                BeamConfig.Beam.Agentsim.Agents.RideHail.Charging.VehicleChargingManager(
                  ...
                  depotManager                  = BeamConfig.Beam.Agentsim.Agents.RideHail.Charging.VehicleChargingManager.DepotManager(if(c.hasPathOrNull("depotManager")) c.getConfig("depotManager") else com.typesafe.config.ConfigFactory.parseString("depotManager{}")),
      ...
      object ChargingNetworkManager {
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.ChargingNetworkManager = {
          BeamConfig.Beam.Agentsim.ChargingNetworkManager(
            chargingPoint     = BeamConfig.Beam.Agentsim.ChargingNetworkManager.ChargingPoint(if(c.hasPathOrNull("chargingPoint")) c.getConfig("chargingPoint") else com.typesafe.config.ConfigFactory.parseString("chargingPoint{}")),
    ...
    case class Mep(
      aws : BeamConfig.Beam.Mep.Aws
    )
    object Mep {
      case class Aws(
        arn        : java.lang.String,
        externalId : java.lang.String,
        lambda     : BeamConfig.Beam.Mep.Aws.Lambda,
        region     : java.lang.String
      )
      object Aws {
        case class Lambda(
        ...
        object Lambda {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Mep.Aws.Lambda = {
            BeamConfig.Beam.Mep.Aws.Lambda(
              functionName = if(c.hasPathOrNull("functionName")) c.getString("functionName") else "mep-dev-mep-validation"
            )
          }
        }
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Mep = {
        BeamConfig.Beam.Mep(
          aws = BeamConfig.Beam.Mep.Aws(if(c.hasPathOrNull("aws")) c.getConfig("aws") else com.typesafe.config.ConfigFactory.parseString("aws{}"))
        )
      }
    }
    ...
    def apply(c: com.typesafe.config.Config): BeamConfig.Beam = {
      BeamConfig.Beam(
        ...
        aws             = BeamConfig.Beam.Aws(if(c.hasPathOrNull("aws")) c.getConfig("aws") else com.typesafe.config.ConfigFactory.parseString("aws{}")),
        ...
        mep             = BeamConfig.Beam.Mep(if(c.hasPathOrNull("mep")) c.getConfig("mep") else com.typesafe.config.ConfigFactory.parseString("mep{}")),
