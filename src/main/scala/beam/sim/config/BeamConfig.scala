// generated by tscfg 0.9.4 on Sat Sep 22 01:00:58 IST 2018
    ...
    object Agentsim {
        ...
        object RideHail {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail = {
            BeamConfig.Beam.Agentsim.Agents.RideHail(
              ...
              vehicleRangeInMeters             = if(c.hasPathOrNull("vehicleRangeInMeters")) c.getDouble("vehicleRangeInMeters") else 100000.0,
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim = {
        BeamConfig.Beam.Agentsim(
          ...
          schedulerParallelismWindow              = if(c.hasPathOrNull("schedulerParallelismWindow")) c.getDouble("schedulerParallelismWindow") else 30,
