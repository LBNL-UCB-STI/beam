// generated by tscfg 0.9.4 on Fri May 29 11:33:37 MSK 2020
...
object BeamConfig {
  ...
  object Beam {
    ...
    object Physsim {
      case class Bprsim(
        minVolumeToUseBPRFunction: scala.Int,
      ...
      object Bprsim {
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Bprsim = {
          BeamConfig.Beam.Physsim.Bprsim(
            minVolumeToUseBPRFunction =
              if (c.hasPathOrNull("minVolumeToUseBPRFunction")) c.getInt("minVolumeToUseBPRFunction") else 2,
