// generated by tscfg 0.9.4 on Wed Nov 27 15:25:50 PST 2019
...
object BeamConfig {
  ...
  object Beam {
    ...
    object Router {
      case class Skim(
        count_skimmer: BeamConfig.Beam.Router.Skim.CountSkimmer,
        keepKLatestSkims: scala.Int,
        od_skimmer: BeamConfig.Beam.Router.Skim.OdSkimmer,
        travel_time_skimmer: BeamConfig.Beam.Router.Skim.TravelTimeSkimmer,
      ...
      object Skim {
        ...
        object CountSkimmer {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Router.Skim.CountSkimmer = {
            BeamConfig.Beam.Router.Skim.CountSkimmer(
              fileBaseName = if (c.hasPathOrNull("fileBaseName")) c.getString("fileBaseName") else "skimsCount",
        ...
        object OdSkimmer {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Router.Skim.OdSkimmer = {
            BeamConfig.Beam.Router.Skim.OdSkimmer(
        ...
        case class TravelTimeSkimmer(
          fileBaseName: java.lang.String,
          name: java.lang.String
        )

        object TravelTimeSkimmer {

          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Router.Skim.TravelTimeSkimmer = {
            BeamConfig.Beam.Router.Skim.TravelTimeSkimmer(
              fileBaseName =
                if (c.hasPathOrNull("fileBaseName")) c.getString("fileBaseName")
                else "tazODTravelTimeObservedVsSimulated",
              name = if (c.hasPathOrNull("name")) c.getString("name") else "travel-time-skimmer"
            )
          }
        }
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Router.Skim = {
          BeamConfig.Beam.Router.Skim(
            count_skimmer = BeamConfig.Beam.Router.Skim.CountSkimmer(
              if (c.hasPathOrNull("count-skimmer")) c.getConfig("count-skimmer")
              else com.typesafe.config.ConfigFactory.parseString("count-skimmer{}")
            ),
            keepKLatestSkims = if (c.hasPathOrNull("keepKLatestSkims")) c.getInt("keepKLatestSkims") else 1,
            od_skimmer = BeamConfig.Beam.Router.Skim.OdSkimmer(
              if (c.hasPathOrNull("od-skimmer")) c.getConfig("od-skimmer")
              else com.typesafe.config.ConfigFactory.parseString("od-skimmer{}")
            ),
            travel_time_skimmer = BeamConfig.Beam.Router.Skim.TravelTimeSkimmer(
              if (c.hasPathOrNull("travel-time-skimmer")) c.getConfig("travel-time-skimmer")
              else com.typesafe.config.ConfigFactory.parseString("travel-time-skimmer{}")
            ),
