// generated by tscfg 0.9.4 on Tue Aug 06 17:58:08 PDT 2019
...
object BeamConfig {
  ...
  object Beam {
    ...
    case class Beamskimmer(
      writeAllModeSkimsForPeakNonPeakPeriods: scala.Boolean,
      writeObservedSkims: scala.Boolean,
      writeObservedSkimsPlus: scala.Boolean
    )
    ...
    object Beamskimmer {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Beamskimmer = {
        BeamConfig.Beam.Beamskimmer(
          writeAllModeSkimsForPeakNonPeakPeriods = !c.hasPathOrNull("writeAllModeSkimsForPeakNonPeakPeriods") || c
            .getBoolean("writeAllModeSkimsForPeakNonPeakPeriods"),
          writeObservedSkims = !c.hasPathOrNull("writeObservedSkims") || c.getBoolean("writeObservedSkims"),
          writeObservedSkimsPlus = !c.hasPathOrNull("writeObservedSkimsPlus") || c.getBoolean("writeObservedSkimsPlus")
        )
      }
    }
