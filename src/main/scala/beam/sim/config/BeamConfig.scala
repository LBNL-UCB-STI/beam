// generated by tscfg 0.9.4 on Wed Jun 05 20:25:37 CEST 2019
      ...
      object Agents {
        ...
        object Vehicles {
          case class SharedFleets$Elm(
            ...
            fixed_non_reserving_fleet_from_file      : scala.Option[BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm.FixedNonReservingFleetFromFile],
            fixed_non_reserving_randomly_distributed : scala.Option[BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm.FixedNonReservingRandomlyDistributed],
          ...
          object SharedFleets$Elm {
            ...
            object FixedNonReservingFleetFromFile {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm.FixedNonReservingFleetFromFile = {
            ...
            object FixedNonReservingRandomlyDistributed {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm.FixedNonReservingRandomlyDistributed = {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm = {
              BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm(
                ...
                fixed_non_reserving_fleet_from_file      = if(c.hasPathOrNull("fixed-non-reserving-fleet-from-file")) scala.Some(BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm.FixedNonReservingFleetFromFile(c.getConfig("fixed-non-reserving-fleet-from-file"))) else None,
                fixed_non_reserving_randomly_distributed = if(c.hasPathOrNull("fixed-non-reserving-randomly-distributed")) scala.Some(BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm.FixedNonReservingRandomlyDistributed(c.getConfig("fixed-non-reserving-randomly-distributed"))) else None,
