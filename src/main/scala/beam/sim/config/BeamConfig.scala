// generated by tscfg 0.9.4 on Mon Jun 08 16:48:11 MSK 2020
...
object BeamConfig {
  ...
  object Beam {
    ...
    case class Debug(
      ...
      spawnModeChoiceOccurredEvents: scala.Boolean,
    ...
    object Debug {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Debug = {
        BeamConfig.Beam.Debug(
          ...
          spawnModeChoiceOccurredEvents = c.hasPathOrNull("spawnModeChoiceOccurredEvents") && c.getBoolean(
            "spawnModeChoiceOccurredEvents"
          ),
          stuckAgentDetection = BeamConfig.Beam.Debug.StuckAgentDetection(
