        ...
        object ModalBehaviors {
          ...
          object MulitnomialLogit {
            case class Params(
              ...
              transit_crowding_VOT_cutoff: scala.Double,
            ...
            object Params {
              ...
              def apply(
                ...
                BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.MulitnomialLogit.Params(
                  ...
                  transit_crowding_VOT_cutoff =
                    if (c.hasPathOrNull("transit_crowding_VOT_cutoff")) c.getDouble("transit_crowding_VOT_cutoff")
                    else 0.5,
