// generated by tscfg 0.9.4 on Thu Jul 25 11:47:36 ALMT 2019
    ...
    object Physsim {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim = {
        BeamConfig.Beam.Physsim(
          ...
          speedDataFilePath                      = if(c.hasPathOrNull("speedDataFilePath")) c.getString("speedDataFilePath") else "/test/input/beamville/r5/speedData.csv",
