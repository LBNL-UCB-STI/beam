// generated by tscfg 0.9.4 on Sat Aug 25 19:00:46 PDT 2018
...
object BeamConfig {
  ...
  object Beam {
    case class Agentsim(
      ...
      numAgents                               : scala.Int,
      scheduler                               : BeamConfig.Beam.Agentsim.Scheduler,
    ...
    object Agentsim {
      ...
      object Scheduler {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Scheduler = {
          BeamConfig.Beam.Agentsim.Scheduler(
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim = {
        BeamConfig.Beam.Agentsim(
          ...
          scheduler                               = BeamConfig.Beam.Agentsim.Scheduler(if(c.hasPathOrNull("scheduler")) c.getConfig("scheduler") else com.typesafe.config.ConfigFactory.parseString("scheduler{}")),
