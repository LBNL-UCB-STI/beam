// generated by tscfg 0.9.4 on Fri Feb 15 15:55:12 PST 2019
    ...
    object Agentsim {
      ...
      object Agents {
        ...
        case class ModalBehaviors(
          ...
          waitingValueOfTime     : scala.Double
        )
        object ModalBehaviors {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors = {
            BeamConfig.Beam.Agentsim.Agents.ModalBehaviors(
              ...
              waitingValueOfTime     = if(c.hasPathOrNull("waitingValueOfTime")) c.getDouble("waitingValueOfTime") else 8.0
            )
          }
        }
