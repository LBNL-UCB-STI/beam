// generated by tscfg 0.9.4 on Mon Mar 18 19:52:02 IST 2019
          ...
          object Initialization {
            ...
            object Procedural {
              ...
              def apply(
                ...
                BeamConfig.Beam.Agentsim.Agents.RideHail.Initialization.Procedural(
                  effectiveVehicleReplacementMultiplier =
                    if (c.hasPathOrNull("effectiveVehicleReplacementMultiplier"))
                      c.getDouble("effectiveVehicleReplacementMultiplier")
                    else 1.0,
                  initialLocation = BeamConfig.Beam.Agentsim.Agents.RideHail.Initialization.Procedural.InitialLocation(
                  ...
                  portionOfInitialVehicleFleet =
                    if (c.hasPathOrNull("portionOfInitialVehicleFleet")) c.getDouble("portionOfInitialVehicleFleet")
                    else 0.1,
        ...
        object Vehicles {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles = {
            BeamConfig.Beam.Agentsim.Agents.Vehicles(
              ...
              householdVehicleFleetSizeSampleFactor =
                if (c.hasPathOrNull("householdVehicleFleetSizeSampleFactor"))
                  c.getDouble("householdVehicleFleetSizeSampleFactor")
                else 1.0,
