          ...
          object Initialization {
            ...
            object Parking {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Initialization.Parking = {
                BeamConfig.Beam.Agentsim.Agents.RideHail.Initialization.Parking(
                  filePath = if(c.hasPathOrNull("filePath")) c.getString("filePath") else "/test/input/beamville/ride-hail-parking.csv"
                )
              }
            }
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Initialization = {
              BeamConfig.Beam.Agentsim.Agents.RideHail.Initialization(
                filePath   = if(c.hasPathOrNull("filePath")) c.getString("filePath") else "/test/input/beamville/ride-hail-fleet.csv",
      ...
      object Taz {
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Taz = {
          BeamConfig.Beam.Agentsim.Taz(
            ...
            parkingFilePath                = if(c.hasPathOrNull("parkingFilePath")) c.getString("parkingFilePath") else "/test/input/beamville/taz-parking.csv",
      ...
      object Counts {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Calibration.Counts = {
          BeamConfig.Beam.Calibration.Counts(
            ...
            inputCountsFile             = if(c.hasPathOrNull("inputCountsFile")) c.getString("inputCountsFile") else "/test/input/beamville/counts.xml",
    ...
    object Replanning {
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Replanning = {
        BeamConfig.Beam.Replanning(
          ...
          cleanNonCarModesInIteration             = if(c.hasPathOrNull("cleanNonCarModesInIteration")) c.getInt("cleanNonCarModesInIteration") else 0,
    ...
    object Urbansim {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Urbansim = {
        BeamConfig.Beam.Urbansim(
          ...
          allTAZSkimsWriteInterval = if(c.hasPathOrNull("allTAZSkimsWriteInterval")) c.getInt("allTAZSkimsWriteInterval") else 0,
