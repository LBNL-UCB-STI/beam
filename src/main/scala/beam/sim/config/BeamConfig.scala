// generated by tscfg 0.8.1 on Mon May 28 17:00:12 PDT 2018
...
object BeamConfig {
  ...
  object Beam {
    ...
    case class Debug(
      debugActorTimerInterval : scala.Int,
    ...
    object Debug {
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Debug = {
        BeamConfig.Beam.Debug(
          debugActorTimerInterval = if(c.hasPathOrNull("debugActorTimerInterval")) c.getInt("debugActorTimerInterval") else 0,
