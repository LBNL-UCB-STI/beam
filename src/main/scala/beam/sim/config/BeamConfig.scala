// generated by tscfg 0.9.4 on Mon Jan 27 12:03:33 PST 2020
      ...
      object Agents {
        ...
        object TripBehaviors {
          case class MulitnomialLogit(
            ...
            votParams: BeamConfig.Beam.Agentsim.Agents.TripBehaviors.MulitnomialLogit.VotParams
          )

          object MulitnomialLogit {
            case class VotParams(
              home: scala.Double,
              meal: scala.Double,
              other: scala.Double,
              shop: scala.Double,
            ...
            object VotParams {
              ...
              def apply(
                c: com.typesafe.config.Config
              ): BeamConfig.Beam.Agentsim.Agents.TripBehaviors.MulitnomialLogit.VotParams = {
                BeamConfig.Beam.Agentsim.Agents.TripBehaviors.MulitnomialLogit.VotParams(
                  home = if (c.hasPathOrNull("home")) c.getDouble("home") else 0.8,
                  meal = if (c.hasPathOrNull("meal")) c.getDouble("meal") else 3.0,
                  other = if (c.hasPathOrNull("other")) c.getDouble("other") else 2.0,
                  shop = if (c.hasPathOrNull("shop")) c.getDouble("shop") else 2.0,
                  work = if (c.hasPathOrNull("work")) c.getDouble("work") else 1.0
                )
              }
            }
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.TripBehaviors.MulitnomialLogit = {
              BeamConfig.Beam.Agentsim.Agents.TripBehaviors.MulitnomialLogit(
                ...
                votParams = BeamConfig.Beam.Agentsim.Agents.TripBehaviors.MulitnomialLogit.VotParams(
                  if (c.hasPathOrNull("votParams")) c.getConfig("votParams")
                  else com.typesafe.config.ConfigFactory.parseString("votParams{}")
                )
              )
            }
          }
