// generated by tscfg 0.8.1 on Tue Sep 05 15:55:14 PDT 2017
        ...
        object ModalBehaviors {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors = {
            BeamConfig.Beam.Agentsim.Agents.ModalBehaviors(
              modeChoiceClass = if(c.hasPathOrNull("modeChoiceClass")) c.getString("modeChoiceClass") else "beam.agentsim.agents.choice.mode.ModeChoiceMultinomialLogit"
            )
          }
        }
