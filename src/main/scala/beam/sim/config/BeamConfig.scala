// generated by tscfg 0.9.4 on Sat May 16 23:58:09 ICT 2020
...
object BeamConfig {
  ...
  object Beam {
    ...
    case class Physsim(
      cch                                    : BeamConfig.Beam.Physsim.Cch,
    ...
    object Physsim {
      ...
      object Cch {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Cch = {
          BeamConfig.Beam.Physsim.Cch(
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim = {
        BeamConfig.Beam.Physsim(
          cch                                    = BeamConfig.Beam.Physsim.Cch(if(c.hasPathOrNull("cch")) c.getConfig("cch") else com.typesafe.config.ConfigFactory.parseString("cch{}")),
