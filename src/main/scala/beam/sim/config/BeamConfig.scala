// generated by tscfg 0.9.4 on Sat May 09 15:28:40 ICT 2020
...
object BeamConfig {
  ...
  object Beam {
    ...
    case class Physsim(
      ...
      routingFramework                       : BeamConfig.Beam.Physsim.RoutingFramework,
    ...
    object Physsim {
      ...
      case class RoutingFramework(
        congestionFactor : scala.Int
      )
      object RoutingFramework {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.RoutingFramework = {
          BeamConfig.Beam.Physsim.RoutingFramework(
            congestionFactor = if(c.hasPathOrNull("congestionFactor")) c.getInt("congestionFactor") else 1
          )
        }
      }
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim = {
        BeamConfig.Beam.Physsim(
          ...
          routingFramework                       = BeamConfig.Beam.Physsim.RoutingFramework(if(c.hasPathOrNull("routingFramework")) c.getConfig("routingFramework") else com.typesafe.config.ConfigFactory.parseString("routingFramework{}")),
