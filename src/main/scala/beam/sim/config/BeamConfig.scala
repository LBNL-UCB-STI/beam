// generated by tscfg 0.9.4 on Mon Aug 19 16:52:43 MDT 2019
        ...
        object Parking {
          ...
          object MulitnomialLogit {
            case class Params(
              ...
              installedCapacityMultiplier : scala.Double,
              parkingCostsPriceMultiplier : scala.Double,
            ...
            object Params {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Parking.MulitnomialLogit.Params = {
                BeamConfig.Beam.Agentsim.Agents.Parking.MulitnomialLogit.Params(
                  distanceMultiplier          = if(c.hasPathOrNull("distanceMultiplier")) c.getDouble("distanceMultiplier") else 1.0,
                  installedCapacityMultiplier = if(c.hasPathOrNull("installedCapacityMultiplier")) c.getDouble("installedCapacityMultiplier") else 0.001,
                  parkingCostsPriceMultiplier = if(c.hasPathOrNull("parkingCostsPriceMultiplier")) c.getDouble("parkingCostsPriceMultiplier") else 4.5,
                  rangeAnxietyMultiplier      = if(c.hasPathOrNull("rangeAnxietyMultiplier")) c.getDouble("rangeAnxietyMultiplier") else 1.0
                )
              }
            }
