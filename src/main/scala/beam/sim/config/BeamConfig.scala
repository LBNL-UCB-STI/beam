// generated by tscfg 0.8.1 on Mon Jul 02 17:34:32 PKT 2018
...
object BeamConfig {
  ...
  object Beam {
    ...
    case class WarmStart(
      ...
      iterationToUse : scala.Int,
      parentRun      : java.lang.String
    )
    object WarmStart {
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.WarmStart = {
        BeamConfig.Beam.WarmStart(
          enabled        = c.hasPathOrNull("enabled") && c.getBoolean("enabled"),
          iterationToUse = if(c.hasPathOrNull("iterationToUse")) c.getInt("iterationToUse") else -1,
          parentRun      = if(c.hasPathOrNull("parentRun")) c.getString("parentRun") else "output"
        )
      }
    }
