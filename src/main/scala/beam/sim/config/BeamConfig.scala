      ...
      object VmInformation {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Debug.VmInformation = {
          BeamConfig.Beam.Debug.VmInformation(
            gcClassHistogramAtIterationEnd   = c.hasPathOrNull("gcClassHistogramAtIterationEnd") && c.getBoolean("gcClassHistogramAtIterationEnd"),
            gcClassHistogramAtIterationStart = c.hasPathOrNull("gcClassHistogramAtIterationStart") && c.getBoolean("gcClassHistogramAtIterationStart")
          )
        }
      }
