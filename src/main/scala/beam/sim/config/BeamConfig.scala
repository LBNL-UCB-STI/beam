// generated by tscfg 0.9.4 on Fri Aug 23 19:15:40 PDT 2019
  ...
  object Beam {
    ...
    object Agentsim {
        ...
        object Parking {
          ...
          object Bev {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Parking.Bev = {
              BeamConfig.Beam.Agentsim.Agents.Parking.Bev(
                distance_safety_margin = if(c.hasPathOrNull("distance_safety_margin")) c.getDouble("distance_safety_margin") else 35000
              )
            }
          }
            ...
            object Params {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Parking.MulitnomialLogit.Params = {
                BeamConfig.Beam.Agentsim.Agents.Parking.MulitnomialLogit.Params(
                  distance_multiplier            = if(c.hasPathOrNull("distance_multiplier")) c.getDouble("distance_multiplier") else 1.0,
                  installed_capacity_multiplier  = if(c.hasPathOrNull("installed_capacity_multiplier")) c.getDouble("installed_capacity_multiplier") else 0.001,
                  parking_costs_price_multiplier = if(c.hasPathOrNull("parking_costs_price_multiplier")) c.getDouble("parking_costs_price_multiplier") else 4.5
                )
              }
            }
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Parking = {
            BeamConfig.Beam.Agentsim.Agents.Parking(
              bev              = BeamConfig.Beam.Agentsim.Agents.Parking.Bev(if(c.hasPathOrNull("bev")) c.getConfig("bev") else com.typesafe.config.ConfigFactory.parseString("bev{}")),
        ...
        object RideHail {
          ...
          object AllocationManager {
            case class AlonsoMora(
              maxTravelTimeDelayAsFraction       : scala.Double,
              maxWaitTimeInSec                   : scala.Int,
              ratioOfSolutionSpaceToAvailability : scala.Double,
              ratioOfSolutionSpaceToRequest      : scala.Double
            )
            object AlonsoMora {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager.AlonsoMora = {
                BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager.AlonsoMora(
                  maxTravelTimeDelayAsFraction       = if(c.hasPathOrNull("maxTravelTimeDelayAsFraction")) c.getDouble("maxTravelTimeDelayAsFraction") else 0.2,
                  maxWaitTimeInSec                   = if(c.hasPathOrNull("maxWaitTimeInSec")) c.getInt("maxWaitTimeInSec") else 360,
                  ratioOfSolutionSpaceToAvailability = if(c.hasPathOrNull("ratioOfSolutionSpaceToAvailability")) c.getDouble("ratioOfSolutionSpaceToAvailability") else 1.0,
                  ratioOfSolutionSpaceToRequest      = if(c.hasPathOrNull("ratioOfSolutionSpaceToRequest")) c.getDouble("ratioOfSolutionSpaceToRequest") else 1.0
                )
              }
            }
      ...
      case class Taz(
        ...
        probabilityOfResidentialCharging : scala.Double
      )
      object Taz {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Taz = {
          BeamConfig.Beam.Agentsim.Taz(
            ...
            probabilityOfResidentialCharging = if(c.hasPathOrNull("probabilityOfResidentialCharging")) c.getDouble("probabilityOfResidentialCharging") else 1.0
          )
        }
      }
