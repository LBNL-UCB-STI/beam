// generated by tscfg 0.8.1 on Sun Sep 24 21:25:38 PDT 2017
      ...
      object OverrideLoggingLevels$Elm {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Outputs.OverrideLoggingLevels$Elm = {
          BeamConfig.Beam.Outputs.OverrideLoggingLevels$Elm(
            classname = if(c.hasPathOrNull("classname")) c.getString("classname") else "ModeChoiceEvent",
            value     = if(c.hasPathOrNull("value")) c.getString("value") else "VERBOSE"
          )
        }
      }
