// generated by tscfg 0.9.4 on Fri Feb 22 17:09:51 PST 2019
        ...
        object ModalBehaviors {
          ...
          object HighTimeSensitivity {
            case class HighCongestion(
              highwayFactor    : scala.Double,
              nonHighwayFactor : scala.Double
            )
            object HighCongestion {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.HighTimeSensitivity.HighCongestion = {
                BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.HighTimeSensitivity.HighCongestion(
                  highwayFactor    = if(c.hasPathOrNull("highwayFactor")) c.getDouble("highwayFactor") else 1.0,
                  nonHighwayFactor = if(c.hasPathOrNull("nonHighwayFactor")) c.getDouble("nonHighwayFactor") else 1.0
                )
              }
            }
          ...
          object ModeVotMultiplier {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.ModeVotMultiplier = {
              BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.ModeVotMultiplier(
                ...
                sharedAutonomous = if(c.hasPathOrNull("sharedAutonomous")) c.getDouble("sharedAutonomous") else 1.6,
                sharedDriver     = if(c.hasPathOrNull("sharedDriver")) c.getDouble("sharedDriver") else 1.3,
                transit          = if(c.hasPathOrNull("transit")) c.getDouble("transit") else 1.0,
                waiting          = if(c.hasPathOrNull("waiting")) c.getDouble("waiting") else 1.5
              )
            }
          }
