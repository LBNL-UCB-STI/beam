// generated by tscfg 0.9.4 on Sat Mar 28 13:29:25 ICT 2020
...
object BeamConfig {
  ...
  object Beam {
    ...
    object Router {
      case class Skim(
        collectFullCarSkimsInterval: scala.Int,
      ...
      object Skim {
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Router.Skim = {
          BeamConfig.Beam.Router.Skim(
            collectFullCarSkimsInterval =
              if (c.hasPathOrNull("collectFullCarSkimsInterval")) c.getInt("collectFullCarSkimsInterval") else 0,
            drive_time_skimmer = BeamConfig.Beam.Router.Skim.DriveTimeSkimmer(
