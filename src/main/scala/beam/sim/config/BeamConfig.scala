// generated by tscfg 0.8.1 on Thu Apr 05 02:37:50 PKT 2018
...
object BeamConfig {
  ...
  object Beam {
    ...
    case class Mobsim(
      vehicle : BeamConfig.Beam.Mobsim.Vehicle
    )
    object Mobsim {
      case class Vehicle(
      ...
      object Vehicle {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Mobsim.Vehicle = {
          BeamConfig.Beam.Mobsim.Vehicle(
            fuelCapacityInJoules = if(c.hasPathOrNull("fuelCapacityInJoules")) c.getDouble("fuelCapacityInJoules") else 86400000
          )
        }
      }
            
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Mobsim = {
        BeamConfig.Beam.Mobsim(
          vehicle = BeamConfig.Beam.Mobsim.Vehicle(c.getConfig("vehicle"))
        )
      }
    }
    ...
    def apply(c: com.typesafe.config.Config): BeamConfig.Beam = {
      BeamConfig.Beam(
        ...
        mobsim         = BeamConfig.Beam.Mobsim(c.getConfig("mobsim")),
