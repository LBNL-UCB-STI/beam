// generated by tscfg 0.9.4 on Fri Feb 22 04:17:11 EST 2019
    ...
    object Agentsim {
      ...
      object Agents {
        ...
        case class Vehicles(
          ...
          vehicleEnergyFile: java.lang.String
        )
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles = {
            BeamConfig.Beam.Agentsim.Agents.Vehicles(
              ...
              linkToGradePercentFile =
                if (c.hasPathOrNull("linkToGradePercentFile")) c.getString("linkToGradePercentFile")
                else "/test/input/beamville/linkToGradePercent.csv",
              ...
              vehicleEnergyFile =
                if (c.hasPathOrNull("vehicleEnergyFile")) c.getString("vehicleEnergyFile")
                else "/test/input/beamville/vehicleEnergy.csv"
            )
          }
