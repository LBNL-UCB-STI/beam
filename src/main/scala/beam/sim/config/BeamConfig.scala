// generated by tscfg 0.9.4 on Mon Apr 15 14:12:51 IST 2019
      ...
      object ScheduleMonitorTask {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.ScheduleMonitorTask = {
          BeamConfig.Beam.Agentsim.ScheduleMonitorTask(
            ...
            interval     = if(c.hasPathOrNull("interval")) c.getInt("interval") else 10
          )
        }
      }
    ...
    object Debug {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Debug = {
        BeamConfig.Beam.Debug(
          ...
          agentTripScoresInterval                   = if(c.hasPathOrNull("agentTripScoresInterval")) c.getInt("agentTripScoresInterval") else 10,
          ...
          debugActorTimerIntervalInSec              = if(c.hasPathOrNull("debugActorTimerIntervalInSec")) c.getInt("debugActorTimerIntervalInSec") else 10,
