// generated by tscfg 0.8.1 on Thu Jun 28 22:55:13 PKT 2018
    ...
    object Agentsim {
      ...
      object Agents {
        case class DrivingCost(
          defaultLitersPerGallon : scala.Double,
        ...
        object DrivingCost {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.DrivingCost = {
            BeamConfig.Beam.Agentsim.Agents.DrivingCost(
              defaultLitersPerGallon = if(c.hasPathOrNull("defaultLitersPerGallon")) c.getDouble("defaultLitersPerGallon") else 3.78541,
        ...
        object RideHail {
          ...
          object AllocationManager {
            ...
            case class RepositionLowWaitingTimes(
              ...
              minScoreThresholdForRespositioning                     : scala.Double,
            ...
            object RepositionLowWaitingTimes {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager.RepositionLowWaitingTimes = {
                BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager.RepositionLowWaitingTimes(
                  ...
                  minScoreThresholdForRespositioning                     = if(c.hasPathOrNull("minScoreThresholdForRespositioning")) c.getDouble("minScoreThresholdForRespositioning") else 0.1,
