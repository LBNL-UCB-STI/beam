// generated by tscfg 0.9.4 on Wed Apr 15 15:27:32 PDT 2020
          ...
          object AllocationManager {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager = {
              BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager(
                ...
                matchingAlgorithm             = if(c.hasPathOrNull("matchingAlgorithm")) c.getString("matchingAlgorithm") else "VEHICLE_CENTRIC_MATCHING_FOR_RIDEHAIL",
