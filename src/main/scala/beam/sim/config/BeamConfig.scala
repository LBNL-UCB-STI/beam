            ...
            object DemandFollowingRepositioningManager {
              ...
              def apply(
                ...
                BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager.DemandFollowingRepositioningManager(
                  ...
                  horizon = if (c.hasPathOrNull("horizonBin")) c.getInt("horizonBin") else 1200,
                  ...
                  sensitivityToDistance =
                    if (c.hasPathOrNull("sensitivityToDistance")) c.getDouble("sensitivityToDistance") else 0.2
                )
              }
            }
