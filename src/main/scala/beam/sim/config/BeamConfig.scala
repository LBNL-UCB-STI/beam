              ...
              def apply(
                ...
                BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager
                  .RepositionLowWaitingTimes(
                    ...
                    minScoreThresholdForRespositioning =
                      if (c.hasPathOrNull("minScoreThresholdForRespositioning"))
                        c.getDouble("minScoreThresholdForRespositioning")
                      else 0.1,
      ...
      object Gtfs {
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing.Gtfs = {
          BeamConfig.Beam.Routing.Gtfs(
            ...
            outputDir =
              if (c.hasPathOrNull("outputDir")) c.getString("outputDir") else "/test/output/gtfs"
          )
        }
      }
