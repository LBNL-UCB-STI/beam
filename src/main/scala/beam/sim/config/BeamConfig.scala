// generated by tscfg 0.9.4 on Mon Jul 29 19:52:41 PDT 2019
      ...
      object Agents {
        ...
        object RideHail {
            ...
            object AlonsoMora {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager.AlonsoMora = {
                BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager.AlonsoMora(
                  dropoffTimeWindowInSec = if(c.hasPathOrNull("dropoffTimeWindowInSec")) c.getInt("dropoffTimeWindowInSec") else 600,
          ...
          object RepositioningManager {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager = {
              BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager(
                ...
                timeout                             = if(c.hasPathOrNull("timeout")) c.getInt("timeout") else 300
              )
            }
          }
          ...
          case class SurgePricing(
            ...
            surgePricingFile       : java.lang.String,
            surgePricingManager    : java.lang.String
          )
          object SurgePricing {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.SurgePricing = {
              BeamConfig.Beam.Agentsim.Agents.RideHail.SurgePricing(
                ...
                surgePricingFile       = if(c.hasPathOrNull("surgePricingFile")) c.getString("surgePricingFile") else "/test/input/beamville/surgePricingData.csv",
                surgePricingManager    = if(c.hasPathOrNull("surgePricingManager")) c.getString("surgePricingManager") else "DUMMY"
              )
            }
          }
