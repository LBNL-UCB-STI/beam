// generated by tscfg 0.8.1 on Fri Sep 08 19:01:58 IST 2017
  ...
  object Beam {
    ...
    object Outputs {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Outputs = {
        BeamConfig.Beam.Outputs(
          ...
          outputDirectory         = if(c.hasPathOrNull("outputDirectory")) c.getString("outputDirectory") else "/home/fidel101/SmartMobility/TL08/beam/test/output",
      ...
      object Gtfs {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing.Gtfs = {
          BeamConfig.Beam.Routing.Gtfs(
            ...
            outputDir     = if(c.hasPathOrNull("outputDir")) c.getString("outputDir") else "/home/fidel101/SmartMobility/TL08/beam/test/output/gtfs"
          )
        }
      }
      ...
      object R5 {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing.R5 = {
          BeamConfig.Beam.Routing.R5(
            ...
            directory       = if(c.hasPathOrNull("directory")) c.getString("directory") else "/home/fidel101/SmartMobility/TL08/beam/test/input/beam-developers/model-inputs/r5"
          )
        }
      }
    ...
    def apply(c: com.typesafe.config.Config): BeamConfig.Beam = {
      BeamConfig.Beam(
        ...
        sharedInputs = if(c.hasPathOrNull("sharedInputs")) c.getString("sharedInputs") else "/home/fidel101/SmartMobility/TL08/beam/test/input/beam-developers",
      ...
      object Controler {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Controler = {
          BeamConfig.Matsim.Modules.Controler(
            ...
            outputDirectory  = if(c.hasPathOrNull("outputDirectory")) c.getString("outputDirectory") else "/home/fidel101/SmartMobility/TL08/beam/test/output/pt-tutorial"
          )
        }
      }
      ...
      object Network {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Network = {
          BeamConfig.Matsim.Modules.Network(
            inputNetworkFile = if(c.hasPathOrNull("inputNetworkFile")) c.getString("inputNetworkFile") else "/home/fidel101/SmartMobility/TL08/beam/test/input/beam-developers/model-inputs/dev/multimodalnetwork.xml"
          )
        }
      }
      ...
      object Plans {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Plans = {
          BeamConfig.Matsim.Modules.Plans(
            inputPlansFile = if(c.hasPathOrNull("inputPlansFile")) c.getString("inputPlansFile") else "/home/fidel101/SmartMobility/TL08/beam/test/input/beam-developers/model-inputs/dev/population-500.xml"
          )
        }
      }
