// generated by tscfg 0.9.4 on Wed Apr 01 02:32:28 ICT 2020
...
object BeamConfig {
  ...
  object Beam {
              ...
              def apply(
                ...
                BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager.AlonsoMora(
                  ...
                  matchingAlgorithm =
                    ...
                    else "VehicleCentricMatchingForRideHail",
    ...
    object Physsim {
      ...
      case class Network(
        highwayType: BeamConfig.Beam.Physsim.Network.HighwayType
      )

      object Network {
        case class HighwayType(
          enabled: scala.Boolean,
          livingStreet: BeamConfig.Beam.Physsim.Network.HighwayType.LivingStreet,
          minor: BeamConfig.Beam.Physsim.Network.HighwayType.Minor,
          motorway: BeamConfig.Beam.Physsim.Network.HighwayType.Motorway,
          motorwayLink: BeamConfig.Beam.Physsim.Network.HighwayType.MotorwayLink,
          primary: BeamConfig.Beam.Physsim.Network.HighwayType.Primary,
          primaryLink: BeamConfig.Beam.Physsim.Network.HighwayType.PrimaryLink,
          residential: BeamConfig.Beam.Physsim.Network.HighwayType.Residential,
          secondary: BeamConfig.Beam.Physsim.Network.HighwayType.Secondary,
          secondaryLink: BeamConfig.Beam.Physsim.Network.HighwayType.SecondaryLink,
          tertiary: BeamConfig.Beam.Physsim.Network.HighwayType.Tertiary,
          tertiaryLink: BeamConfig.Beam.Physsim.Network.HighwayType.TertiaryLink,
          trunk: BeamConfig.Beam.Physsim.Network.HighwayType.Trunk,
          trunkLink: BeamConfig.Beam.Physsim.Network.HighwayType.TrunkLink,
          unclassified: BeamConfig.Beam.Physsim.Network.HighwayType.Unclassified
        )
        ...
        object HighwayType {
          ...
          object LivingStreet {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.HighwayType.LivingStreet = {
              BeamConfig.Beam.Physsim.Network.HighwayType.LivingStreet(
          ...
          object Minor {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.HighwayType.Minor = {
              BeamConfig.Beam.Physsim.Network.HighwayType.Minor(
                capacity = if (c.hasPathOrNull("capacity")) Some(c.getInt("capacity")) else None,
                lanes = if (c.hasPathOrNull("lanes")) Some(c.getInt("lanes")) else None,
                speed = if (c.hasPathOrNull("speed")) Some(c.getDouble("speed")) else None
              )
          ...
          object Motorway {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.HighwayType.Motorway = {
              BeamConfig.Beam.Physsim.Network.HighwayType.Motorway(
                capacity = if (c.hasPathOrNull("capacity")) Some(c.getInt("capacity")) else None,
                lanes = if (c.hasPathOrNull("lanes")) Some(c.getInt("lanes")) else None,
                speed = if (c.hasPathOrNull("speed")) Some(c.getDouble("speed")) else None
              )
          ...
          object MotorwayLink {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.HighwayType.MotorwayLink = {
              BeamConfig.Beam.Physsim.Network.HighwayType.MotorwayLink(
                capacity = if (c.hasPathOrNull("capacity")) Some(c.getInt("capacity")) else None,
                lanes = if (c.hasPathOrNull("lanes")) Some(c.getInt("lanes")) else None,
                speed = if (c.hasPathOrNull("speed")) Some(c.getDouble("speed")) else None
              )
          ...
          object Primary {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.HighwayType.Primary = {
              BeamConfig.Beam.Physsim.Network.HighwayType.Primary(
                capacity = if (c.hasPathOrNull("capacity")) Some(c.getInt("capacity")) else None,
                lanes = if (c.hasPathOrNull("lanes")) Some(c.getInt("lanes")) else None,
                speed = if (c.hasPathOrNull("speed")) Some(c.getDouble("speed")) else None
              )
          ...
          object PrimaryLink {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.HighwayType.PrimaryLink = {
              BeamConfig.Beam.Physsim.Network.HighwayType.PrimaryLink(
                capacity = if (c.hasPathOrNull("capacity")) Some(c.getInt("capacity")) else None,
                lanes = if (c.hasPathOrNull("lanes")) Some(c.getInt("lanes")) else None,
                speed = if (c.hasPathOrNull("speed")) Some(c.getDouble("speed")) else None
              )
          ...
          object Residential {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.HighwayType.Residential = {
              BeamConfig.Beam.Physsim.Network.HighwayType.Residential(
                capacity = if (c.hasPathOrNull("capacity")) Some(c.getInt("capacity")) else None,
                lanes = if (c.hasPathOrNull("lanes")) Some(c.getInt("lanes")) else None,
                speed = if (c.hasPathOrNull("speed")) Some(c.getDouble("speed")) else None
              )
          ...
          object Secondary {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.HighwayType.Secondary = {
              BeamConfig.Beam.Physsim.Network.HighwayType.Secondary(
                capacity = if (c.hasPathOrNull("capacity")) Some(c.getInt("capacity")) else None,
                lanes = if (c.hasPathOrNull("lanes")) Some(c.getInt("lanes")) else None,
                speed = if (c.hasPathOrNull("speed")) Some(c.getDouble("speed")) else None
              )
          ...
          object SecondaryLink {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.HighwayType.SecondaryLink = {
              BeamConfig.Beam.Physsim.Network.HighwayType.SecondaryLink(
                capacity = if (c.hasPathOrNull("capacity")) Some(c.getInt("capacity")) else None,
                lanes = if (c.hasPathOrNull("lanes")) Some(c.getInt("lanes")) else None,
                speed = if (c.hasPathOrNull("speed")) Some(c.getDouble("speed")) else None
              )
          ...
          object Tertiary {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.HighwayType.Tertiary = {
              BeamConfig.Beam.Physsim.Network.HighwayType.Tertiary(
                capacity = if (c.hasPathOrNull("capacity")) Some(c.getInt("capacity")) else None,
                lanes = if (c.hasPathOrNull("lanes")) Some(c.getInt("lanes")) else None,
                speed = if (c.hasPathOrNull("speed")) Some(c.getDouble("speed")) else None
              )
          ...
          object TertiaryLink {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.HighwayType.TertiaryLink = {
              BeamConfig.Beam.Physsim.Network.HighwayType.TertiaryLink(
                capacity = if (c.hasPathOrNull("capacity")) Some(c.getInt("capacity")) else None,
                lanes = if (c.hasPathOrNull("lanes")) Some(c.getInt("lanes")) else None,
                speed = if (c.hasPathOrNull("speed")) Some(c.getDouble("speed")) else None
              )
          ...
          object Trunk {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.HighwayType.Trunk = {
              BeamConfig.Beam.Physsim.Network.HighwayType.Trunk(
                capacity = if (c.hasPathOrNull("capacity")) Some(c.getInt("capacity")) else None,
                lanes = if (c.hasPathOrNull("lanes")) Some(c.getInt("lanes")) else None,
                speed = if (c.hasPathOrNull("speed")) Some(c.getDouble("speed")) else None
              )
          ...
          object TrunkLink {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.HighwayType.TrunkLink = {
              BeamConfig.Beam.Physsim.Network.HighwayType.TrunkLink(
                capacity = if (c.hasPathOrNull("capacity")) Some(c.getInt("capacity")) else None,
                lanes = if (c.hasPathOrNull("lanes")) Some(c.getInt("lanes")) else None,
                speed = if (c.hasPathOrNull("speed")) Some(c.getDouble("speed")) else None
              )
          ...
          object Unclassified {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.HighwayType.Unclassified = {
              BeamConfig.Beam.Physsim.Network.HighwayType.Unclassified(
                capacity = if (c.hasPathOrNull("capacity")) Some(c.getInt("capacity")) else None,
                lanes = if (c.hasPathOrNull("lanes")) Some(c.getInt("lanes")) else None,
                speed = if (c.hasPathOrNull("speed")) Some(c.getDouble("speed")) else None
              )
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network.HighwayType = {
            BeamConfig.Beam.Physsim.Network.HighwayType(
              enabled = c.hasPathOrNull("enabled") && c.getBoolean("enabled"),
              livingStreet = BeamConfig.Beam.Physsim.Network.HighwayType.LivingStreet(
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Network = {
          BeamConfig.Beam.Physsim.Network(
            highwayType = BeamConfig.Beam.Physsim.Network.HighwayType(
              if (c.hasPathOrNull("highwayType")) c.getConfig("highwayType")
              else com.typesafe.config.ConfigFactory.parseString("highwayType{}")
            )
          )
        }
      }
