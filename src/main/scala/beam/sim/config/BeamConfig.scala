// generated by tscfg 0.9.4 on Thu Feb 28 22:57:20 EST 2019
        ...
        object Vehicles {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles = {
            BeamConfig.Beam.Agentsim.Agents.Vehicles(
              ...
              linkToGradePercentFile         = if(c.hasPathOrNull("linkToGradePercentFile")) c.getString("linkToGradePercentFile") else "/test/input/beamville/linkToGradePercent.csv",
