// generated by tscfg 0.9.4 on Tue Mar 26 20:41:23 CET 2019
        ...
        object Vehicles {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles = {
            BeamConfig.Beam.Agentsim.Agents.Vehicles(
              enableNewVehicleEnergyConsumptionLogic = !c.hasPathOrNull("enableNewVehicleEnergyConsumptionLogic") || c.getBoolean("enableNewVehicleEnergyConsumptionLogic"),
    ...
    object Calibration {
      ...
      object RoadNetwork {
        case class TravelTimes(
          benchmarkFileAggregates   : java.lang.String,
          benchmarkFileCensustracts : java.lang.String,
          benchmarkFileChart        : java.lang.String
        )
        object TravelTimes {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Calibration.RoadNetwork.TravelTimes = {
            BeamConfig.Beam.Calibration.RoadNetwork.TravelTimes(
              benchmarkFileAggregates   = if(c.hasPathOrNull("benchmarkFileAggregates")) c.getString("benchmarkFileAggregates") else "",
              benchmarkFileCensustracts = if(c.hasPathOrNull("benchmarkFileCensustracts")) c.getString("benchmarkFileCensustracts") else "",
              benchmarkFileChart        = if(c.hasPathOrNull("benchmarkFileChart")) c.getString("benchmarkFileChart") else ""
            )
          }
        }
