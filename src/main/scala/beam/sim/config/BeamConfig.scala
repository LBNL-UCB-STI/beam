// generated by tscfg 0.9.4 on Sun Mar 03 00:39:46 PST 2019
        ...
        object Population {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Population = {
            BeamConfig.Beam.Agentsim.Agents.Population(
              beamPopulationDirectory = if(c.hasPathOrNull("beamPopulationDirectory")) c.getString("beamPopulationDirectory") else "",
