// generated by tscfg 0.9.4 on Thu Apr 23 10:56:20 MSK 2020
    ...
    object Agentsim {
      ...
      object Taz {
        case class ParkingManager(
          hierarchical: BeamConfig.Beam.Agentsim.Taz.ParkingManager.Hierarchical,
          managerType: java.lang.String
        )

        object ParkingManager {
          case class Hierarchical(
            numberOfClusters: scala.Int
          )

          object Hierarchical {

            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Taz.ParkingManager.Hierarchical = {
              BeamConfig.Beam.Agentsim.Taz.ParkingManager.Hierarchical(
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Taz.ParkingManager = {
            BeamConfig.Beam.Agentsim.Taz.ParkingManager(
              hierarchical = BeamConfig.Beam.Agentsim.Taz.ParkingManager.Hierarchical(
                if (c.hasPathOrNull("hierarchical")) c.getConfig("hierarchical")
                else com.typesafe.config.ConfigFactory.parseString("hierarchical{}")
              ),
              managerType = if (c.hasPathOrNull("managerType")) c.getString("managerType") else "default"
            )
          }
        }
