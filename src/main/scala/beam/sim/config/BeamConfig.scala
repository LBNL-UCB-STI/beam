// generated by tscfg 0.9.4 on Thu Aug 15 16:44:49 MSK 2019
        ...
        object RideHail {
          ...
          object RepositioningManager {
            case class DemandFollowingRepositioningManager(
              PercentageOfClosestClustersToConsider: scala.Double,
            ...
            object DemandFollowingRepositioningManager {
              ...
              def apply(
                ...
                BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager.DemandFollowingRepositioningManager(
                  PercentageOfClosestClustersToConsider =
                    if (c.hasPathOrNull("PercentageOfClosestClustersToConsider"))
                      c.getDouble("PercentageOfClosestClustersToConsider")
                    else 0.2,
