            ...
            terminateAtFleetStoredElectricityConvergence =
              BeamConfig.Beam.Sim.Termination.TerminateAtFleetStoredElectricityConvergence(
                if (c.hasPathOrNull("terminateAtFleetStoredElectricityConvergence"))
                  c.getConfig("terminateAtFleetStoredElectricityConvergence")
                else com.typesafe.config.ConfigFactory.parseString("terminateAtFleetStoredElectricityConvergence{}")
              )
          )
        }
      }
