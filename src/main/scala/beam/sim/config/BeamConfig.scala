// generated by tscfg 0.9.4 on Mon Apr 13 15:12:01 PDT 2020
            ...
            object AlonsoMora {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager.AlonsoMora = {
                BeamConfig.Beam.Agentsim.Agents.RideHail.AllocationManager.AlonsoMora(
                  excessRideTimeAsFraction = if(c.hasPathOrNull("excessRideTimeAsFraction")) c.getDouble("excessRideTimeAsFraction") else 0.2,
                  matchingAlgorithm        = if(c.hasPathOrNull("matchingAlgorithm")) c.getString("matchingAlgorithm") else "VehicleCentricMatchingForRideHail",
                  numRequestsPerVehicle    = if(c.hasPathOrNull("numRequestsPerVehicle")) c.getInt("numRequestsPerVehicle") else 5,
