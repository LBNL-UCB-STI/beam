      ...
      object ChargingNetworkManager {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.ChargingNetworkManager = {
          BeamConfig.Beam.Agentsim.ChargingNetworkManager(
            chargingSessionInSeconds = if(c.hasPathOrNull("chargingSessionInSeconds")) c.getInt("chargingSessionInSeconds") else 300,
            ...
            helicsFederateName       = if(c.hasPathOrNull("helicsFederateName")) c.getString("helicsFederateName") else "BeamCNM",
            planningHorizonInSeconds = if(c.hasPathOrNull("planningHorizonInSeconds")) c.getInt("planningHorizonInSeconds") else 300
          )
        }
      }
