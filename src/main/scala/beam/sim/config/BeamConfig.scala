// generated by tscfg 0.9.4 on Wed Jun 26 18:42:07 BST 2019
    ...
    object Agentsim {
      ...
      object Agents {
        ...
        case class Population(
          inputPopulationFilePath : java.lang.String,
        ...
        object Population {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Population = {
            BeamConfig.Beam.Agentsim.Agents.Population(
              inputPopulationFilePath = if(c.hasPathOrNull("inputPopulationFilePath")) c.getString("inputPopulationFilePath") else "/test/input/beamville/population.csv",
