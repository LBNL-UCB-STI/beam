        ...
        object Parking {
            ...
            object Params {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Parking.MulitnomialLogit.Params = {
                BeamConfig.Beam.Agentsim.Agents.Parking.MulitnomialLogit.Params(
                  ...
                  overnightParkingPrefersChargingMultiplier       = if(c.hasPathOrNull("overnightParkingPrefersChargingMultiplier")) c.getDouble("overnightParkingPrefersChargingMultiplier") else 1.0,
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Parking = {
            BeamConfig.Beam.Agentsim.Agents.Parking(
              ...
              overnightChargingSampleSize            = if(c.hasPathOrNull("overnightChargingSampleSize")) c.getDouble("overnightChargingSampleSize") else 0.5,
