// generated by tscfg 0.9.4 on Fri Feb 15 15:20:54 PST 2019
    ...
    object Agentsim {
      ...
      object Agents {
        ...
        case class ModalBehaviors(
          autonomous_VOTT_factor : scala.Double,
          ...
          shared_VOTT_factor     : scala.Double,
          waiting_VOTT_factor    : scala.Double
        )
        object ModalBehaviors {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors = {
            BeamConfig.Beam.Agentsim.Agents.ModalBehaviors(
              autonomous_VOTT_factor = if(c.hasPathOrNull("autonomous_VOTT_factor")) c.getDouble("autonomous_VOTT_factor") else 1.0,
              ...
              shared_VOTT_factor     = if(c.hasPathOrNull("shared_VOTT_factor")) c.getDouble("shared_VOTT_factor") else 1.0,
              waiting_VOTT_factor    = if(c.hasPathOrNull("waiting_VOTT_factor")) c.getDouble("waiting_VOTT_factor") else 1.0
            )
          }
        }
