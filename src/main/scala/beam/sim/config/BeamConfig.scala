// generated by tscfg 0.9.4 on Thu Feb 28 17:01:28 GMT 2019
...
object BeamConfig {
  ...
  object Beam {
    ...
    object Agentsim {
      ...
      object Agents {
        case class Households(
          ...
          inputHouseholdAttributesFilename : java.lang.String
        )
        object Households {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Households = {
            BeamConfig.Beam.Agentsim.Agents.Households(
              inputFilename                    = if(c.hasPathOrNull("inputFilename")) c.getString("inputFilename") else "/test/input/beamville/households.xml.gz",
              inputHouseholdAttributesFilename = if(c.hasPathOrNull("inputHouseholdAttributesFilename")) c.getString("inputHouseholdAttributesFilename") else "/test/input/beamville/householdAttributes.xml.gz"
            )
          }
        }
          ...
          object Lccm {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.Lccm = {
              BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.Lccm(
                filename = if(c.hasPathOrNull("filename")) c.getString("filename") else "/test/input/beamville/lccm-long.csv"
              )
            }
          }
        ...
        object ModeIncentive {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModeIncentive = {
            BeamConfig.Beam.Agentsim.Agents.ModeIncentive(
              filename = if(c.hasPathOrNull("filename")) c.getString("filename") else ""
            )
          }
        }
        ...
        case class Plans(
          ...
          inputPlansFilename        : java.lang.String
        )
        object Plans {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Plans = {
            BeamConfig.Beam.Agentsim.Agents.Plans(
              ...
              inputPlansFilename        = if(c.hasPathOrNull("inputPlansFilename")) c.getString("inputPlansFilename") else "/test/input/beamville/population.xml.gz"
            )
          }
        }
        ...
        case class Vehicles(
          fuelTypesFilename              : java.lang.String,
          ...
          vehicleTypesFilename           : java.lang.String,
          vehiclesFilename               : java.lang.String
        )
        object Vehicles {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles = {
            BeamConfig.Beam.Agentsim.Agents.Vehicles(
              fuelTypesFilename              = if(c.hasPathOrNull("fuelTypesFilename")) c.getString("fuelTypesFilename") else "/test/input/beamville/beamFuelTypes.csv",
              ...
              vehicleTypesFilename           = if(c.hasPathOrNull("vehicleTypesFilename")) c.getString("vehicleTypesFilename") else "/test/input/beamville/vehicleTypes.csv",
              vehiclesFilename               = if(c.hasPathOrNull("vehiclesFilename")) c.getString("vehiclesFilename") else "/test/input/beamville/vehicles.csv"
            )
          }
      ...
      case class Taz(
        filename        : java.lang.String,
        parkingFilename : java.lang.String
      )
      object Taz {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Taz = {
          BeamConfig.Beam.Agentsim.Taz(
            filename        = if(c.hasPathOrNull("filename")) c.getString("filename") else "/test/input/beamville/taz-centers.csv",
            parkingFilename = if(c.hasPathOrNull("parkingFilename")) c.getString("parkingFilename") else "/test/input/beamville/taz-parking.csv"
          )
        }
      }
      ...
      object Toll {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Toll = {
          BeamConfig.Beam.Agentsim.Toll(
            filename = if(c.hasPathOrNull("filename")) c.getString("filename") else "/test/input/beamville/toll-prices.csv"
          )
        }
      }
    ...
    object Calibration {
      ...
      case class Mode(
        benchmarkFilename : java.lang.String
      )
      object Mode {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Calibration.Mode = {
          BeamConfig.Beam.Calibration.Mode(
            benchmarkFilename = if(c.hasPathOrNull("benchmarkFilename")) c.getString("benchmarkFilename") else ""
          )
        }
      }
    ...
    case class Physsim(
      ...
      inputNetworkFilename                   : java.lang.String,
    ...
    object Physsim {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim = {
        BeamConfig.Beam.Physsim(
          ...
          inputNetworkFilename                   = if(c.hasPathOrNull("inputNetworkFilename")) c.getString("inputNetworkFilename") else "/test/input/beamville/r5/physsim-network.xml",
