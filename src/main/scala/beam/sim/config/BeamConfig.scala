    ...
    object Agentsim {
        ...
        object TripBehaviors {
          ...
          object MulitnomialLogit {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.TripBehaviors.MulitnomialLogit = {
              BeamConfig.Beam.Agentsim.Agents.TripBehaviors.MulitnomialLogit(
                ...
                fill_in_modes_from_skims                            = c.hasPathOrNull("fill_in_modes_from_skims") && c.getBoolean("fill_in_modes_from_skims"),
                ...
                look_for_closest_hour_in_OD_skims_for_fill_in_modes = c.hasPathOrNull("look_for_closest_hour_in_OD_skims_for_fill_in_modes") && c.getBoolean("look_for_closest_hour_in_OD_skims_for_fill_in_modes"),
                ...
                max_hour_for_closest_hour_in_OD_skims_request       = if(c.hasPathOrNull("max_hour_for_closest_hour_in_OD_skims_request")) c.getInt("max_hour_for_closest_hour_in_OD_skims_request") else 20,
                min_hour_for_closest_hour_in_OD_skims_request       = if(c.hasPathOrNull("min_hour_for_closest_hour_in_OD_skims_request")) c.getInt("min_hour_for_closest_hour_in_OD_skims_request") else 6,
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.TripBehaviors = {
            BeamConfig.Beam.Agentsim.Agents.TripBehaviors(
              ...
              replaceModes     = BeamConfig.Beam.Agentsim.Agents.TripBehaviors.ReplaceModes(if(c.hasPathOrNull("replaceModes")) c.getConfig("replaceModes") else com.typesafe.config.ConfigFactory.parseString("replaceModes{}"))
            )
          }
        }
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim = {
        BeamConfig.Beam.Agentsim(
          ...
          minimumAgentAgeToIncludeInSimulation    = if(c.hasPathOrNull("minimumAgentAgeToIncludeInSimulation")) c.getInt("minimumAgentAgeToIncludeInSimulation") else 0,
    ...
    object Debug {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Debug = {
        BeamConfig.Beam.Debug(
          ...
          maxInitializationTimeBeforeConsideredStuckMin = if(c.hasPathOrNull("maxInitializationTimeBeforeConsideredStuckMin")) c.getInt("maxInitializationTimeBeforeConsideredStuckMin") else 180,
          maxSimulationStepTimeBeforeConsideredStuckMin = if(c.hasPathOrNull("maxSimulationStepTimeBeforeConsideredStuckMin")) c.getInt("maxSimulationStepTimeBeforeConsideredStuckMin") else 999999,
