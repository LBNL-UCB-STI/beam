// generated by tscfg 0.8.1 on Mon Dec 11 18:45:26 PST 2017
  ...
  object Beam {
        ...
        object ModalBehaviors {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors = {
            BeamConfig.Beam.Agentsim.Agents.ModalBehaviors(
              ...
              modeChoiceParametersFile = if(c.hasPathOrNull("modeChoiceParametersFile")) c.getString("modeChoiceParametersFile") else "/Users/sfeygin/current_code/java/research/beam/test/input/beamville/modeChoiceParameters.xml"
            )
          }
        }
    ...
    object Outputs {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Outputs = {
        BeamConfig.Beam.Outputs(
          ...
          outputDirectory     = if(c.hasPathOrNull("outputDirectory")) c.getString("outputDirectory") else "/Users/sfeygin/current_code/java/research/beam/test/output",
      ...
      object Gtfs {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing.Gtfs = {
          BeamConfig.Beam.Routing.Gtfs(
            ...
            outputDir     = if(c.hasPathOrNull("outputDir")) c.getString("outputDir") else "/Users/sfeygin/current_code/java/research/beam/test/output/gtfs"
          )
        }
      }
      ...
      object R5 {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing.R5 = {
          BeamConfig.Beam.Routing.R5(
            ...
            directory       = if(c.hasPathOrNull("directory")) c.getString("directory") else "/Users/sfeygin/current_code/java/research/beam/test/input/beamville/r5",
            numberOfSamples = if(c.hasPathOrNull("numberOfSamples")) c.getInt("numberOfSamples") else 1,
            osmFile         = if(c.hasPathOrNull("osmFile")) c.getString("osmFile") else "/Users/sfeygin/current_code/java/research/beam/test/input/beamville/r5/beamville.osm.pbf",
            osmMapdbFile    = if(c.hasPathOrNull("osmMapdbFile")) c.getString("osmMapdbFile") else "/Users/sfeygin/current_code/java/research/beam/test/input/beamville/r5/osm.mapdb"
          )
        }
      }
    ...
    def apply(c: com.typesafe.config.Config): BeamConfig.Beam = {
      BeamConfig.Beam(
        ...
        inputDirectory = if(c.hasPathOrNull("inputDirectory")) c.getString("inputDirectory") else "/Users/sfeygin/current_code/java/research/beam/test/input/beamville",
      ...
      object Controler {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Controler = {
          BeamConfig.Matsim.Modules.Controler(
            ...
            outputDirectory  = if(c.hasPathOrNull("outputDirectory")) c.getString("outputDirectory") else "/Users/sfeygin/current_code/java/research/beam/test/output/pt-tutorial",
      ...
      object Households {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Households = {
          BeamConfig.Matsim.Modules.Households(
            inputFile                    = if(c.hasPathOrNull("inputFile")) c.getString("inputFile") else "/Users/sfeygin/current_code/java/research/beam/test/input/beamville/households.xml",
            inputHouseholdAttributesFile = if(c.hasPathOrNull("inputHouseholdAttributesFile")) c.getString("inputHouseholdAttributesFile") else "/Users/sfeygin/current_code/java/research/beam/test/input/beamville/householdAttributes.xml"
          )
        }
      }
      ...
      object Network {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Network = {
          BeamConfig.Matsim.Modules.Network(
            inputNetworkFile = if(c.hasPathOrNull("inputNetworkFile")) c.getString("inputNetworkFile") else "/Users/sfeygin/current_code/java/research/beam/test/input/beamville/physsim-network.xml"
          )
        }
      }
      ...
      object Plans {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Plans = {
          BeamConfig.Matsim.Modules.Plans(
            inputPersonAttributesFile = if(c.hasPathOrNull("inputPersonAttributesFile")) c.getString("inputPersonAttributesFile") else "/Users/sfeygin/current_code/java/research/beam/test/input/beamville/populationAttributes.xml",
            inputPlansFile            = if(c.hasPathOrNull("inputPlansFile")) c.getString("inputPlansFile") else "/Users/sfeygin/current_code/java/research/beam/test/input/beamville/population.xml"
          )
        }
      }
      ...
      object Vehicles {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Vehicles = {
          BeamConfig.Matsim.Modules.Vehicles(
            vehiclesFile = if(c.hasPathOrNull("vehiclesFile")) c.getString("vehiclesFile") else "/Users/sfeygin/current_code/java/research/beam/test/input/beamville/vehicles.xml"
          )
        }
      }
