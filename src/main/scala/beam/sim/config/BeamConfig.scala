// generated by tscfg 0.9.4 on Thu Feb 28 14:26:07 PST 2019
      ...
      object Agents {
        ...
        object ModalBehaviors {
              ...
              object HighwayFactor {
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.HighTimeSensitivity.HighCongestion.HighwayFactor = {
                  BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.HighTimeSensitivity.HighCongestion.HighwayFactor(
                    ...
                    LevelLE3 = if(c.hasPathOrNull("LevelLE3")) c.getDouble("LevelLE3") else 1.0
                  )
                }
              }
          ...
          case class ModeVotMultiplier(
            ...
            sharedAutonomous : scala.Double,
            sharedDriver     : scala.Double,
          ...
          object ModeVotMultiplier {
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.ModeVotMultiplier = {
              BeamConfig.Beam.Agentsim.Agents.ModalBehaviors.ModeVotMultiplier(
                ...
                sharedAutonomous = if(c.hasPathOrNull("sharedAutonomous")) c.getDouble("sharedAutonomous") else 1.0,
                sharedDriver     = if(c.hasPathOrNull("sharedDriver")) c.getDouble("sharedDriver") else 1.0,
