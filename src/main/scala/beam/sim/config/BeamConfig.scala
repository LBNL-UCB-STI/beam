// generated by tscfg 0.9.4 on Mon Apr 13 21:54:12 PDT 2020
      ...
      object Agents {
        ...
        object RideHail {
          ...
          case class RepositioningManager(
            alternativeDemandFollowingRepositioning: BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager.AlternativeDemandFollowingRepositioning,
          ...
          object RepositioningManager {
            case class AlternativeDemandFollowingRepositioning(
            ...
            object AlternativeDemandFollowingRepositioning {

              def apply(
                c: com.typesafe.config.Config
              ): BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager.AlternativeDemandFollowingRepositioning = {
                BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager.AlternativeDemandFollowingRepositioning(
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager = {
              BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager(
                alternativeDemandFollowingRepositioning =
                  BeamConfig.Beam.Agentsim.Agents.RideHail.RepositioningManager.AlternativeDemandFollowingRepositioning(
                    if (c.hasPathOrNull("alternativeDemandFollowingRepositioning"))
                      c.getConfig("alternativeDemandFollowingRepositioning")
                    else com.typesafe.config.ConfigFactory.parseString("alternativeDemandFollowingRepositioning{}")
                  ),
