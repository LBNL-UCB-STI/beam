  ...
  object Beam {
    ...
    object Skimmanager {
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Skimmanager.H3 = {
          BeamConfig.Beam.Skimmanager.H3(
            lowerBoundResolution =
              if (c.hasPathOrNull("lowerBoundResolution")) c.getInt("lowerBoundResolution") else 10,
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Skimmanager = {
        BeamConfig.Beam.Skimmanager(
          ...
          h3 = BeamConfig.Beam.Skimmanager.H3(
            if (c.hasPathOrNull("h3")) c.getConfig("h3") else com.typesafe.config.ConfigFactory.parseString("h3{}")
          ),
          ...
          skimmer = BeamConfig.Beam.Skimmanager.Skimmer(
            if (c.hasPathOrNull("skimmer")) c.getConfig("skimmer")
            else com.typesafe.config.ConfigFactory.parseString("skimmer{}")
          )
        )
      }
    }
    ...
    def apply(c: com.typesafe.config.Config): BeamConfig.Beam = {
      BeamConfig.Beam(
        ...
        skimmanager = BeamConfig.Beam.Skimmanager(
          if (c.hasPathOrNull("skimmanager")) c.getConfig("skimmanager")
          else com.typesafe.config.ConfigFactory.parseString("skimmanager{}")
        ),
        spatial = BeamConfig.Beam.Spatial(
