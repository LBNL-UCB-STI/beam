  ...
  object Beam {
    ...
    object Cosim {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Cosim = {
        BeamConfig.Beam.Cosim(
          helics = BeamConfig.Beam.Cosim.Helics(if(c.hasPathOrNull("helics")) c.getConfig("helics") else com.typesafe.config.ConfigFactory.parseString("helics{}"))
        )
      }
    }
    ...
    def apply(c: com.typesafe.config.Config): BeamConfig.Beam = {
      BeamConfig.Beam(
        ...
        cosim           = BeamConfig.Beam.Cosim(if(c.hasPathOrNull("cosim")) c.getConfig("cosim") else com.typesafe.config.ConfigFactory.parseString("cosim{}")),
