// generated by tscfg 0.9.4 on Wed May 29 15:42:15 PDT 2019
        ...
        object Vehicles {
          ...
          object SharedFleets$Elm {
            ...
            case class FixedNonReservingFleetByTaz(
              fleetSize           : scala.Int,
              maxWalkingDistance  : scala.Int,
              repositioningClass  : java.lang.String,
              vehicleTypeId       : java.lang.String,
              vehiclesSharePerTAZ : java.lang.String
            )
            object FixedNonReservingFleetByTaz {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm.FixedNonReservingFleetByTaz = {
                BeamConfig.Beam.Agentsim.Agents.Vehicles.SharedFleets$Elm.FixedNonReservingFleetByTaz(
                  ...
                  maxWalkingDistance  = if(c.hasPathOrNull("maxWalkingDistance")) c.getInt("maxWalkingDistance") else 500,
                  repositioningClass  = if(c.hasPathOrNull("repositioningClass")) c.getString("repositioningClass") else "beam.sim.vehiclesharing.AvailabilityBasedRepositioning",
                  vehicleTypeId       = if(c.hasPathOrNull("vehicleTypeId")) c.getString("vehicleTypeId") else "sharedCar",
                  vehiclesSharePerTAZ = c.getString("vehiclesSharePerTAZ")
                )
              }
            }
