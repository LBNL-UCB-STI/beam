// generated by tscfg 0.9.4 on Tue Sep 18 07:41:38 PKT 2018
    ...
    object Agentsim {
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim = {
        BeamConfig.Beam.Agentsim(
          ...
          populationAdjustment                    = if(c.hasPathOrNull("populationAdjustment")) c.getString("populationAdjustment") else "DefaultPopulationAdjustment",
