// generated by tscfg 0.8.1 on Mon Feb 12 10:41:44 PST 2018
...
object BeamConfig {
  ...
  object Beam {
    case class Agentsim(
      ...
      infrastructure              : BeamConfig.Beam.Agentsim.Infrastructure,
      numAgents                   : scala.Int,
    ...
    object Agentsim {
      ...
      case class Infrastructure(
        parking : BeamConfig.Beam.Agentsim.Infrastructure.Parking
      )
      object Infrastructure {
        case class Parking(
          attributesFilePaths : java.lang.String
        )
        object Parking {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Infrastructure.Parking = {
            BeamConfig.Beam.Agentsim.Infrastructure.Parking(
              attributesFilePaths = if(c.hasPathOrNull("attributesFilePaths")) c.getString("attributesFilePaths") else ""
            )
          }
        }
              
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Infrastructure = {
          BeamConfig.Beam.Agentsim.Infrastructure(
            parking = BeamConfig.Beam.Agentsim.Infrastructure.Parking(c.getConfig("parking"))
          )
        }
      }
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim = {
        BeamConfig.Beam.Agentsim(
          ...
          infrastructure              = BeamConfig.Beam.Agentsim.Infrastructure(c.getConfig("infrastructure")),
