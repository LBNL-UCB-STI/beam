// generated by tscfg 0.9.4 on Mon Aug 12 15:16:21 PDT 2019
...
object BeamConfig {
  ...
  object Beam {
    ...
    case class Beamskimmer(
      writeAllModeSkimsForPeakNonPeakPeriods : scala.Int,
      writeObservedSkims                     : scala.Int,
      writeObservedSkimsPlus                 : scala.Int
    )
    object Beamskimmer {
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Beamskimmer = {
        BeamConfig.Beam.Beamskimmer(
          writeAllModeSkimsForPeakNonPeakPeriods = if(c.hasPathOrNull("writeAllModeSkimsForPeakNonPeakPeriods")) c.getInt("writeAllModeSkimsForPeakNonPeakPeriods") else 0,
          writeObservedSkims                     = if(c.hasPathOrNull("writeObservedSkims")) c.getInt("writeObservedSkims") else 0,
          writeObservedSkimsPlus                 = if(c.hasPathOrNull("writeObservedSkimsPlus")) c.getInt("writeObservedSkimsPlus") else 0
        )
      }
    }
