// generated by tscfg 0.8.1 on Thu Sep 07 13:27:10 PDT 2017
  ...
  object Beam {
      ...
      object R5 {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing.R5 = {
          BeamConfig.Beam.Routing.R5(
            ...
            directory       = if(c.hasPathOrNull("directory")) c.getString("directory") else "/Users/sfeygin/current_code/java/research/beam/test/input/beam-developers/model-inputs/r5"
          )
        }
      }
    ...
    def apply(c: com.typesafe.config.Config): BeamConfig.Beam = {
      BeamConfig.Beam(
        ...
        sharedInputs = if(c.hasPathOrNull("sharedInputs")) c.getString("sharedInputs") else "/Users/sfeygin/current_code/java/research/beam/test/input/beam-developers",
      ...
      object Network {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Network = {
          BeamConfig.Matsim.Modules.Network(
            inputNetworkFile = if(c.hasPathOrNull("inputNetworkFile")) c.getString("inputNetworkFile") else "/Users/sfeygin/current_code/java/research/beam/test/input/beam-developers/model-inputs/dev/multimodalnetwork.xml"
          )
        }
      }
      ...
      object Plans {
        def apply(c: com.typesafe.config.Config): BeamConfig.Matsim.Modules.Plans = {
          BeamConfig.Matsim.Modules.Plans(
            inputPlansFile = if(c.hasPathOrNull("inputPlansFile")) c.getString("inputPlansFile") else "/Users/sfeygin/current_code/java/research/beam/test/input/beam-developers/model-inputs/dev/population-500.xml"
          )
        }
      }
