// generated by tscfg 0.9.4 on Fri Nov 01 15:50:16 PDT 2019
...
object BeamConfig {
  case class Beam(
    ...
    skimmanager    : BeamConfig.Beam.Skimmanager,
  ...
  object Beam {
    ...
    case class Skimmanager(
      aggregateFunction    : java.lang.String,
      h3                   : BeamConfig.Beam.Skimmanager.H3,
      keepTheNLastestSkims : scala.Int,
      odskimmer            : BeamConfig.Beam.Skimmanager.Odskimmer,
      skimmer              : BeamConfig.Beam.Skimmanager.Skimmer
    )
    object Skimmanager {
      case class H3(
      ...
      object H3 {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Skimmanager.H3 = {
          BeamConfig.Beam.Skimmanager.H3(
      ...
      object Odskimmer {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Skimmanager.Odskimmer = {
          BeamConfig.Beam.Skimmanager.Odskimmer(
      ...
      object Skimmer {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Skimmanager.Skimmer = {
          BeamConfig.Beam.Skimmanager.Skimmer(
            writeAggregatedSkimsInterval = if(c.hasPathOrNull("writeAggregatedSkimsInterval")) c.getInt("writeAggregatedSkimsInterval") else 0,
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Skimmanager = {
        BeamConfig.Beam.Skimmanager(
          aggregateFunction    = if(c.hasPathOrNull("aggregateFunction")) c.getString("aggregateFunction") else "LATEST_SKIM",
          h3                   = BeamConfig.Beam.Skimmanager.H3(if(c.hasPathOrNull("h3")) c.getConfig("h3") else com.typesafe.config.ConfigFactory.parseString("h3{}")),
          keepTheNLastestSkims = if(c.hasPathOrNull("keepTheNLastestSkims")) c.getInt("keepTheNLastestSkims") else 1,
          odskimmer            = BeamConfig.Beam.Skimmanager.Odskimmer(if(c.hasPathOrNull("odskimmer")) c.getConfig("odskimmer") else com.typesafe.config.ConfigFactory.parseString("odskimmer{}")),
          skimmer              = BeamConfig.Beam.Skimmanager.Skimmer(if(c.hasPathOrNull("skimmer")) c.getConfig("skimmer") else com.typesafe.config.ConfigFactory.parseString("skimmer{}"))
        )
      }
    }
    ...
    def apply(c: com.typesafe.config.Config): BeamConfig.Beam = {
      BeamConfig.Beam(
        ...
        skimmanager    = BeamConfig.Beam.Skimmanager(if(c.hasPathOrNull("skimmanager")) c.getConfig("skimmanager") else com.typesafe.config.ConfigFactory.parseString("skimmanager{}")),
