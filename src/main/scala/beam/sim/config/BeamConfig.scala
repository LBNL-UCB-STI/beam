        ...
        object Parking {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Parking = {
            BeamConfig.Beam.Agentsim.Agents.Parking(
              estimatedMinParkingDuration            = if(c.hasPathOrNull("estimatedMinParkingDuration")) c.getDouble("estimatedMinParkingDuration") else 60.0,
        ...
        object RideHail {
              ...
              object DefaultVehicleChargingManager {
                ...
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Charging.VehicleChargingManager.DefaultVehicleChargingManager = {
                  BeamConfig.Beam.Agentsim.Agents.RideHail.Charging.VehicleChargingManager.DefaultVehicleChargingManager(
                    fractionAvailableThresholdToFavorFasterCharging = if(c.hasPathOrNull("fractionAvailableThresholdToFavorFasterCharging")) c.getDouble("fractionAvailableThresholdToFavorFasterCharging") else 1.01,
                    ...
                    noChargingThresholdExpirationTimeInS            = if(c.hasPathOrNull("noChargingThresholdExpirationTimeInS")) c.getInt("noChargingThresholdExpirationTimeInS") else 0
                  )
                }
              }
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail = {
            BeamConfig.Beam.Agentsim.Agents.RideHail(
              ...
              pooledToRegularRideCostRatio   = if(c.hasPathOrNull("pooledToRegularRideCostRatio")) c.getDouble("pooledToRegularRideCostRatio") else 0.6,
