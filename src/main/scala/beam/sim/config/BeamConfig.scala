// generated by tscfg 0.8.1 on Mon Jan 29 10:20:15 PST 2018
        ...
        object ModalBehaviors {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors = {
            BeamConfig.Beam.Agentsim.Agents.ModalBehaviors(
              ...
              modeChoiceParametersFile = if(c.hasPathOrNull("modeChoiceParametersFile")) c.getString("modeChoiceParametersFile") else "/test/input/beamville/modeChoiceParameters.xml"
            )
          }
        }
