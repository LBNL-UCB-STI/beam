// generated by tscfg 0.9.4 on Mon Mar 04 21:09:48 IST 2019
        ...
        object Vehicles {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles = {
            BeamConfig.Beam.Agentsim.Agents.Vehicles(
              ...
              linkToGradePercentFile =
                if (c.hasPathOrNull("linkToGradePercentFile")) c.getString("linkToGradePercentFile") else "",
    ...
    object Replanning {
      ...
      object AnchorEndTimeMutator {
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Replanning.AnchorEndTimeMutator = {
          BeamConfig.Beam.Replanning.AnchorEndTimeMutator(
            mutation = BeamConfig.Beam.Replanning.AnchorEndTimeMutator.Mutation(
              if (c.hasPathOrNull("mutation")) c.getConfig("mutation")
              else com.typesafe.config.ConfigFactory.parseString("mutation{}")
            )
          )
        }
      }
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Replanning = {
        BeamConfig.Beam.Replanning(
          ...
          anchorEndTimeMutator = BeamConfig.Beam.Replanning.AnchorEndTimeMutator(
            if (c.hasPathOrNull("anchorEndTimeMutator")) c.getConfig("anchorEndTimeMutator")
            else com.typesafe.config.ConfigFactory.parseString("anchorEndTimeMutator{}")
          ),
