  ...
  object Beam {
        ...
        object Freight {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Freight = {
            BeamConfig.Beam.Agentsim.Agents.Freight(
              ...
              nonHGVLinkWeightMultiplier       = if(c.hasPathOrNull("nonHGVLinkWeightMultiplier")) c.getDouble("nonHGVLinkWeightMultiplier") else 2.0,
        ...
        object ModalBehaviors {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.ModalBehaviors = {
            BeamConfig.Beam.Agentsim.Agents.ModalBehaviors(
              ...
              replanningWhenNoAvailableRoute    = c.hasPathOrNull("replanningWhenNoAvailableRoute") && c.getBoolean("replanningWhenNoAvailableRoute"),
        ...
        object RideHail {
          ...
          object Managers$Elm {
            ...
            object AllocationManager {
              ...
              object RepositionLowWaitingTimes {
                def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.AllocationManager.RepositionLowWaitingTimes = {
              ...
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.AllocationManager = {
                BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.AllocationManager(
                  ...
                  repositionLowWaitingTimes                      = BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.AllocationManager.RepositionLowWaitingTimes(if(c.hasPathOrNull("repositionLowWaitingTimes")) c.getConfig("repositionLowWaitingTimes") else com.typesafe.config.ConfigFactory.parseString("repositionLowWaitingTimes{}")),
            ...
            object RideHailManager {
              def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm.RideHailManager = {
            ...
            def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm = {
              BeamConfig.Beam.Agentsim.Agents.RideHail.Managers$Elm(
                ...
                savCoefficientMultiplier     = if(c.hasPathOrNull("savCoefficientMultiplier")) c.getDouble("savCoefficientMultiplier") else 0.0,
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.RideHail = {
            BeamConfig.Beam.Agentsim.Agents.RideHail(
              ...
              freeSpeedLinkWeightMultiplier  = if(c.hasPathOrNull("freeSpeedLinkWeightMultiplier")) c.getDouble("freeSpeedLinkWeightMultiplier") else 2.0,
        ...
        object TravelTimes {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Calibration.Google.TravelTimes = {
            BeamConfig.Beam.Calibration.Google.TravelTimes(
              ...
              minDistanceInMeters      = if(c.hasPathOrNull("minDistanceInMeters")) c.getDouble("minDistanceInMeters") else 5000,
              numDataPointsOver24Hours = if(c.hasPathOrNull("numDataPointsOver24Hours")) c.getInt("numDataPointsOver24Hours") else 100,
    ...
    object Physsim {
      ...
      object Events {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim.Events = {
          BeamConfig.Beam.Physsim.Events(
            eventsToWrite     = if(c.hasPathOrNull("eventsToWrite")) c.getString("eventsToWrite") else "ActivityEndEvent,ActivityStartEvent,LinkEnterEvent,LinkLeaveEvent,PersonArrivalEvent,PersonDepartureEvent,VehicleEntersTrafficEvent,VehicleLeavesTrafficEvent",
            fileOutputFormats = if(c.hasPathOrNull("fileOutputFormats")) c.getString("fileOutputFormats") else "csv"
          )
        }
      }
      ...
      def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Physsim = {
        BeamConfig.Beam.Physsim(
          ...
          quick_fix_minCarSpeedInMetersPerSecond = if(c.hasPathOrNull("quick_fix_minCarSpeedInMetersPerSecond")) c.getDouble("quick_fix_minCarSpeedInMetersPerSecond") else 0.5,
        ...
        object OriginDestinationSkimmer {
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Router.Skim.OriginDestinationSkimmer = {
            BeamConfig.Beam.Router.Skim.OriginDestinationSkimmer(
              ...
              poolingTravelTimeOveheadFactor                 = if(c.hasPathOrNull("poolingTravelTimeOveheadFactor")) c.getDouble("poolingTravelTimeOveheadFactor") else 1.21,
    ...
    object Routing {
      ...
      case class R5(
        ...
        rideHailPooledTransitRoutingBufferInSeconds : scala.Int,
        ...
        vehicleTypeSpeedLimitsAsPortionOfFreeFlow   : scala.Option[scala.List[java.lang.String]]
      )
      object R5 {
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing.R5 = {
          BeamConfig.Beam.Routing.R5(
            ...
            rideHailPooledTransitRoutingBufferInSeconds = if(c.hasPathOrNull("rideHailPooledTransitRoutingBufferInSeconds")) c.getInt("rideHailPooledTransitRoutingBufferInSeconds") else 360,
            rideHailTransitRoutingBufferInSeconds       = if(c.hasPathOrNull("rideHailTransitRoutingBufferInSeconds")) c.getInt("rideHailTransitRoutingBufferInSeconds") else 180,
            ...
            vehicleTypeSpeedLimitsAsPortionOfFreeFlow   = if(c.hasPathOrNull("vehicleTypeSpeedLimitsAsPortionOfFreeFlow")) scala.Some($_L$_str(c.getList("vehicleTypeSpeedLimitsAsPortionOfFreeFlow"))) else None
          )
        }
      }
