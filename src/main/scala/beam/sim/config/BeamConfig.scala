// generated by tscfg 0.9.4 on Thu Feb 27 18:38:54 IST 2020
  ...
  object Beam {
    ...
    object Agentsim {
      ...
      object Agents {
        ...
        case class Vehicles(
          collectEventTypes: java.lang.String,
        ...
        object Vehicles {
          ...
          def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.Agents.Vehicles = {
            BeamConfig.Beam.Agentsim.Agents.Vehicles(
              collectEventTypes =
                if (c.hasPathOrNull("collectEventTypes")) c.getString("collectEventTypes") else "charging",
              collectEvents = !c.hasPathOrNull("collectEvents") || c.getBoolean("collectEvents"),
              collectEventsIntervalInSeconds =
                if (c.hasPathOrNull("collectEventsIntervalInSeconds")) c.getInt("collectEventsIntervalInSeconds")
                else 300,
              downsamplingMethod =
