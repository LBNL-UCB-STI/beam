// generated by tscfg 0.9.4 on Wed Apr 29 18:30:02 PDT 2020
  ...
  object Beam {
    ...
    object Agentsim {
      ...
      case class H3taz(
        ...
        maxNumberOfDemandPointsPerHexagon: scala.Int,
      ...
      object H3taz {
        ...
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Agentsim.H3taz = {
          BeamConfig.Beam.Agentsim.H3taz(
            ...
            maxNumberOfDemandPointsPerHexagon =
              if (c.hasPathOrNull("maxNumberOfDemandPointsPerHexagon")) c.getInt("maxNumberOfDemandPointsPerHexagon")
              else 100,
