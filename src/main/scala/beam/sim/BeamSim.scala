...
class BeamSim @Inject()(
  ...
  override def notifyStartup(event: StartupEvent): Unit = {
    ...
    MatchingPerformance.runTest(8 * 3600, 44, 4, 100, "fast")
    MatchingPerformance.runTest(8 * 3600, 48, 4, 100, "fast")
    MatchingPerformance.runTest(8 * 3600, 52, 4, 100, "fast")
    MatchingPerformance.runTest(8 * 3600, 56, 4, 100, "fast")
    MatchingPerformance.runTest(8 * 3600, 60, 4, 100, "fast")
    MatchingPerformance.runTest(8 * 3600, 64, 4, 100, "fast")
    MatchingPerformance.runTest(8 * 3600, 68, 4, 100, "fast")
    MatchingPerformance.runTest(8 * 3600, 72, 4, 100, "fast")
    MatchingPerformance.runTest(8 * 3600, 76, 4, 100, "fast")
    MatchingPerformance.runTest(8 * 3600, 80, 4, 100, "fast")
    MatchingPerformance.runTest(8 * 3600, 84, 4, 100, "fast")
    MatchingPerformance.runTest(8 * 3600, 88, 4, 100, "fast")
    MatchingPerformance.runTest(8 * 3600, 92, 4, 100, "fast")
    MatchingPerformance.runTest(8 * 3600, 96, 4, 100, "fast")
    MatchingPerformance.runTest(8 * 3600, 102, 4, 100, "fast")
//
