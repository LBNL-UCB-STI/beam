...
object ViaTraverseLinkEvent {
  def entered(time: Double, vehicle: String, link: Int): ViaTraverseLinkEvent = ViaTraverseLinkEvent(time, vehicle, EnteredLink, link)
  def left(time: Double, vehicle: String, link: Int): ViaTraverseLinkEvent = ViaTraverseLinkEvent(time, vehicle, LeftLink, link)
}
