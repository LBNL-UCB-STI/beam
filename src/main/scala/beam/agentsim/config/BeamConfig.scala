// generated by tscfg 0.8.0 on Mon Mar 27 13:57:27 PDT 2017
      ...
      object Gtfs {
        def apply(c: com.typesafe.config.Config): BeamConfig.Beam.Routing.Gtfs = {
          BeamConfig.Beam.Routing.Gtfs(
            apiKey        = if(c.hasPathOrNull("apiKey")) c.getString("apiKey") else "3aa50c8c-08f2-4311-a12f-0a90e3ee205d",
            crs           = if(c.hasPathOrNull("crs")) c.getString("crs") else "epsg:26910",
            operatorsFile = if(c.hasPathOrNull("operatorsFile")) c.getString("operatorsFile") else "main/resources/GTFSOperators.csv",
