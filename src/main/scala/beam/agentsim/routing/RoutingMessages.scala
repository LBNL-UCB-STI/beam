...
object RoutingMessages {
  ...
  case class RoutingRequest(fromFacility: Facility[_ <: Facility[_]], toFacility: Facility[_ <: Facility[_]], departureTime: BeamTime, personId: Id[PersonAgent])

  object RoutingRequest {
    def apply(fromActivity: Activity, toActivity: Activity, departureTime: BeamTime, personId: Id[PersonAgent]): RoutingRequest = {
