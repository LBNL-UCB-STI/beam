...
class RefuelEvent(
  ...
  override def getAttributes: util.Map[String, String] = {
    if (attributes.isEmpty) {
      ...
      attributes.put(RefuelEventAttrs.ATTRIBUTE_LOCATION_X, stall.location.getX.toString)
      attributes.put(RefuelEventAttrs.ATTRIBUTE_LOCATION_Y, stall.location.getY.toString)
