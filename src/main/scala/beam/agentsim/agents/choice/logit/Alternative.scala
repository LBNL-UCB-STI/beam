...
/**
  ...
  *
  * @param alternativeTypeId the general identifier of the alternative that should be evaluated (e.g. car)
  * @param attributes the attributes of the alternative that should be taken into account for evaluation
  * @tparam A
  * @tparam T
  */
case class Alternative[T](alternativeTypeId: AlternativeType, attributes: Map[T, Double])
