      ...
      alt.tripClassifier match {
        case CAR if alt.costEstimate == 0.0 =>
          ...
          val cost = alt.legs
            ...
            .sum * litersPerMeter / DEFAULT_LITERS_PER_GALLON * DEFAULT_PRICE_PER_GALLON // 3.78 liters per gallon and 3.115 $/gal in CA: http://www.californiagasprices.com/Prices_Nationally.aspx
          BigDecimal(cost)
        case _ =>
          BigDecimal(0)
      }
