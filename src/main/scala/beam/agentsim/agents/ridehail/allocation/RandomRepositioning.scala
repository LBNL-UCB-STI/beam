  ...
  def updatePersonActivityQuadTree(tick: Double): Unit = {
    ...
    if (isOn && lastTimeQuadTreeUpdated + intervalForUpdatingQuadTree < tick) {
      ...
      rideHailManager.beamServices.matsimServices.getScenario.getPopulation.getPersons
        ...
        .foreach {
          case act: Activity =>
            if (act.getEndTime.seconds() > currentTime + 20 * 60 && act.getEndTime.seconds() < currentTime + 3600) {
    ...
    algorithm match {
      ...
      case 0 =>
        val nonRepositioningIdleVehicles =
          rideHailManager.rideHailManagerHelper.getIdleVehiclesAndFilterOutExluded.values.filter { ral =>
      ...
      case 1 =>
        ...
        // Get idle vehicles
        val idleVehiclesWithoutExcluded =
          rideHailManager.rideHailManagerHelper.getIdleVehiclesAndFilterOutExluded.values
              ...
              val dest =
                quadTree
                  ...
                  .map { act =>
                    ...
                    val closestIdleRHVehicle = rideHailManager.rideHailManagerHelper.idleRideHailAgentSpatialIndex
