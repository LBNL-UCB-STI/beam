...
class RideHailManager(
  ...
  def findDriverAndSendRoutingRequests(request: RideHailRequest,
                                       isInquiry: Boolean): Boolean = {
