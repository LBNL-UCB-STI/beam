...
trait AggregatorFactory {
  ...
  def aggregateResponsesTo(respondTo: ActorRef, requests: Map[ActorRef, List[Any]], originalSender: Option[ActorRef] = None)(resultTransformFunc: PartialFunction[Any,Any] ): Unit = {
