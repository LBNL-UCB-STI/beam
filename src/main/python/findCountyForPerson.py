...
inputPath 	= "/Users/mygreencar/Google Drive/beam-developers/model-inputs/calibration-v2/person-attributes-from-reg-with-spatial-group.csv"
outputPath  = "person-attributes-from-reg-with-spatial-group.csv"
