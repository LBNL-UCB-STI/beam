...
directory_input = os.path.expanduser('~/Data/FREIGHT/sfbay/frism/Tour_plan_inputs_V3_7day_sample/')
directory_output = os.path.expanduser('~/Data/FREIGHT/sfbay/beam_freight_sample/')
