...
directory_input = os.path.expanduser('~/Data/FREIGHT/austin/frism/Tour_plan_AT_2022_05_2_sample/')
directory_output = os.path.expanduser('~/Data/FREIGHT/austin/beam_freight_sample/')
