...
makePlotsFolder="makeplots3"

def getDfForPlt(_plt_setup2, _output_folder):
    if not os.path.exists('{}/{}'.format(_output_folder,makePlotsFolder)):
        os.makedirs('{}/{}'.format(_output_folder,makePlotsFolder))
...
def pltModeSplitByTrips(_plt_setup2, _output_folder):
    ...
    output_png = '{}/{}/{}.modesplit_trips.png'.format(_output_folder,makePlotsFolder, _plt_setup2['name'])
    output_csv = '{}/{}/{}.modesplit_trips.csv'.format(_output_folder,makePlotsFolder, _plt_setup2['name'])
...
def tableSummary(_plt_setup2, _output_folder):
    ...
    (df, top_labels_xpos, bottom_labels_xpos) = getDfForPlt(_plt_setup2, _output_folder)
    output_csv = '{}/{}/{}.summary.csv'.format(_output_folder,makePlotsFolder, _plt_setup2['name'])
...
def pltAveragePersonSpeed_allModes(_plt_setup2, _output_folder):
    pltAverageSpeed_internal(_plt_setup2, _output_folder,'average_person_speed_all_modes','personAverageSpeedAllModes')

def pltAveragePersonSpeed_car(_plt_setup2, _output_folder):
    pltAverageSpeed_internal(_plt_setup2, _output_folder,'average_person_speed_only_car','personAverageSpeedOnlyCar')

def pltAverageLDVSpeed(_plt_setup2, _output_folder):
    pltAverageSpeed_internal(_plt_setup2, _output_folder,'average_ldv_speed','averageSpeedLDV')
...
def pltAverageSpeed_internal(_plt_setup2, _output_folder, outputFileName, plotOption ):
    plot_size = _plt_setup2['plot_size']
    top_labels = _plt_setup2['top_labels']
    bottom_labels = _plt_setup2['bottom_labels']
    nb_scenarios = len(_plt_setup2['scenarios_id'])
    ...
    angle = 12
    (df, top_labels_xpos, bottom_labels_xpos) = getDfForPlt(_plt_setup2, _output_folder)
    output_png = '{}/{}/{}.{}.png'.format(_output_folder,makePlotsFolder, _plt_setup2['name'],outputFileName)
    output_csv = '{}/{}/{}.{}.csv'.format(_output_folder,makePlotsFolder, _plt_setup2['name'],outputFileName)
...
def pltLdvRhOccupancy(_plt_setup2, _output_folder):
    ...
    angle = 12
    (df, top_labels_xpos, bottom_labels_xpos) = getDfForPlt(_plt_setup2, _output_folder)
    output_png = '{}/{}/{}.ldv_rh_occupancy.png'.format(_output_folder,makePlotsFolder, _plt_setup2['name'])
    output_csv = '{}/{}/{}.ldv_rh_occupancy.csv'.format(_output_folder,makePlotsFolder, _plt_setup2['name'])
...
def pltLdvRhOccupancyByVMT(_plt_setup2, _output_folder):
    ...
    angle = 12
    (df, top_labels_xpos, bottom_labels_xpos) = getDfForPlt(_plt_setup2, _output_folder)
    output_png = '{}/{}/{}.ldv_rh_occupancy_vmt.png'.format(_output_folder,makePlotsFolder, _plt_setup2['name'])
    output_csv = '{}/{}/{}.ldv_rh_occupancy_vmt.csv'.format(_output_folder,makePlotsFolder, _plt_setup2['name'])
...
def pltLdvPersonHourTraveled(_plt_setup2, _output_folder):
    ...
    angle = 12
    (df, top_labels_xpos, bottom_labels_xpos) = getDfForPlt(_plt_setup2, _output_folder)
    output_png = '{}/{}/{}.ldv_person_hours_traveled.png'.format(_output_folder,makePlotsFolder, _plt_setup2['name'])
    output_csv = '{}/{}/{}.ldv_person_hours_traveled.csv'.format(_output_folder,makePlotsFolder, _plt_setup2['name'])
...
def pltModeSplitInPHT(_plt_setup2, _output_folder):
    pltModeSplitInPHT_internal(_plt_setup2, _output_folder,_plt_setup2['expansion_factor'],'modesplit_pht',1 / 1000000,'Person Hours Traveled (millions)')
...
def pltModeSplitInPHTPerCapita(_plt_setup2, _output_folder):
    (df, top_labels_xpos, bottom_labels_xpos) = getDfForPlt(_plt_setup2, _output_folder)
    pltModeSplitInPHT_internal(_plt_setup2, _output_folder,1/df['population'].values,'modesplit_pht_per_capita',1,'Person Hours Traveled')
...
def pltModeSplitInPMT_internal(_plt_setup2, _output_folder,factor,fileNameLabel,scale,ylabel):
    ...
    angle = 12
    (df, top_labels_xpos, bottom_labels_xpos) = getDfForPlt(_plt_setup2, _output_folder)
    output_png = '{}/{}/{}.{}.png'.format(_output_folder,makePlotsFolder, _plt_setup2['name'],fileNameLabel)
    output_csv = '{}/{}/{}.{}.csv'.format(_output_folder,makePlotsFolder, _plt_setup2['name'],fileNameLabel)
...
def pltModeSplitInPHT_internal(_plt_setup2, _output_folder,factor,fileNameLabel,scale,ylabel):
    plot_size = _plt_setup2['plot_size']
    top_labels = _plt_setup2['top_labels']
    bottom_labels = _plt_setup2['bottom_labels']
    nb_scenarios = len(_plt_setup2['scenarios_id'])
...
def pltModeSplitInVMT_withoutNonMotorizedMode(_plt_setup2, _output_folder):
    pltModeSplitInVMT_internal(_plt_setup2, _output_folder,_plt_setup2['expansion_factor'],'modesplit_vmt_withoutNonMotorizedMode',1 / 1000000,'Vehicle Miles Traveled (millions)',1,False)

def pltModeSplitInVMTPerCapita_withoutNonMotorizedMode(_plt_setup2, _output_folder):
    (df, top_labels_xpos, bottom_labels_xpos) = getDfForPlt(_plt_setup2, _output_folder)
    pltModeSplitInVMT_internal(_plt_setup2, _output_folder,1/df['population'].values,'modesplit_vmt_per_capita_withoutNonMotorizedMode',1,'Vehicle Miles Traveled',1/_plt_setup2['expansion_factor']/df['population'].values,False)

def pltModeSplitInVMT(_plt_setup2, _output_folder):
    pltModeSplitInVMT_internal(_plt_setup2, _output_folder,_plt_setup2['expansion_factor'],'modesplit_vmt',1 / 1000000,'Vehicle Miles Traveled (millions)',1,True)
    
def pltModeSplitInVMTPerCapita(_plt_setup2, _output_folder):
    (df, top_labels_xpos, bottom_labels_xpos) = getDfForPlt(_plt_setup2, _output_folder)
    pltModeSplitInVMT_internal(_plt_setup2, _output_folder,1/df['population'].values,'modesplit_vmt_per_capita',1,'Vehicle Miles Traveled',1/_plt_setup2['expansion_factor']/df['population'].values,True)
    
def pltModeSplitInVMT_internal(_plt_setup2, _output_folder,factor,fileNameLabel,scale,ylabel,transitFactor,withNonMotorizedMode):
    plot_size = _plt_setup2['plot_size']
    top_labels = _plt_setup2['top_labels']
    bottom_labels = _plt_setup2['bottom_labels']
    nb_scenarios = len(_plt_setup2['scenarios_id'])
...
def pltLdvTechnologySplitInVMT(_plt_setup2, _output_folder):
    ...
    angle = 12
    (df, top_labels_xpos, bottom_labels_xpos) = getDfForPlt(_plt_setup2, _output_folder)
    output_png = '{}/{}/{}.ldv_technologysplit_vmt.png'.format(_output_folder,makePlotsFolder, _plt_setup2['name'])
    output_csv = '{}/{}/{}.ldv_technologysplit_vmt.csv'.format(_output_folder,makePlotsFolder, _plt_setup2['name'])
...
def pltRHWaitTime(_plt_setup2, _output_folder):
    ...
    angle = 12
    (df, top_labels_xpos, bottom_labels_xpos) = getDfForPlt(_plt_setup2, _output_folder)
    output_png = '{}/{}/{}.rh_wait_time.png'.format(_output_folder,makePlotsFolder, _plt_setup2['name'])
    output_csv = '{}/{}/{}.rh_wait_time.csv'.format(_output_folder,makePlotsFolder, _plt_setup2['name'])
...
def pltOverallAverageSpeed(_plt_setup2, _output_folder):
    plot_size = _plt_setup2['plot_size']
    top_labels = _plt_setup2['top_labels']
    bottom_labels = _plt_setup2['bottom_labels']
    nb_scenarios = len(_plt_setup2['scenarios_id'])
    ...
    output_png = '{}/{}/{}.avg_speed.png'.format(_output_folder,makePlotsFolder, _plt_setup2['name'])
    output_csv = '{}/{}/{}.avg_speed.csv'.format(_output_folder,makePlotsFolder, _plt_setup2['name'])
...
def pltRHEmptyPooled(_plt_setup2, _output_folder):
    ...
    angle = 12
    (df, top_labels_xpos, bottom_labels_xpos) = getDfForPlt(_plt_setup2, _output_folder)
    output_png = '{}/{}/{}.rh_empty_shared.png'.format(_output_folder,makePlotsFolder, _plt_setup2['name'])
    output_csv = '{}/{}/{}.rh_empty_shared.csv'.format(_output_folder,makePlotsFolder, _plt_setup2['name'])
...
def pltEnergyPerCapita(_plt_setup2, _output_folder):
    ...
    angle = 12
    (df, top_labels_xpos, bottom_labels_xpos) = getDfForPlt(_plt_setup2, _output_folder)
    output_png = '{}/{}/{}.energy_source_percapita.png'.format(_output_folder,makePlotsFolder, _plt_setup2['name'])
    output_csv = '{}/{}/{}.energy_source_percapita.csv'.format(_output_folder,makePlotsFolder, _plt_setup2['name'])
