...
class SPM_Control():
    ...
    def get_evse_setpoint(self, t_dep, energy_req, min_power, max_power, soc_ess):
        ...
        try:
            ...
            [p_evse_setpoint, p_ess_setpoint] = self.get_heuristic_evse_setpoint(t_dep, energy_req, min_power, max_power, soc_ess)
    ...
    def get_heuristic_evse_setpoint(self, t_dep, energy_req, min_power, max_power, soc_ess):
        ...
        p_evse_setpoint = np.minimum((max_power)*min_pwr_req_evse/total_min_pwr_req_evse, self.max_power_evse)
        ...
        p_evse_setpoint = np.minimum((max_power-p_ess_setpoint)*min_pwr_req_evse/total_min_pwr_req_evse, self.max_power_evse)
