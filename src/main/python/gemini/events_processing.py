...
filename = '~/Data/GEMINI/2021Oct29/BATCH1/events-raw/3.events.SC4Bis.csv.gz'
...
data_filtered2.to_csv('~/Data/GEMINI/2021Oct29/BATCH1/events/filtered.3.events.SC4Bis.csv.gz')
print("END")
