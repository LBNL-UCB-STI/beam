...
filename = '~/Data/GEMINI/2021Oct29/BATCH1/events-raw/0.events.SC4Bis2.csv.gz'
...
data_filtered2.to_csv('~/Data/GEMINI/2021Oct29/BATCH1/events/filtered.0.events.SC4Bis2.csv.gz')
print("END")
