...
filename = '~/Data/GEMINI/2022Feb/BATCH1/events-raw/0.events.SC4.csv.gz'
...
data_filtered2.to_csv('~/Data/GEMINI/2022Feb/BATCH1/events-raw/filtered.0.events.SC4.csv.gz')
print("END")
