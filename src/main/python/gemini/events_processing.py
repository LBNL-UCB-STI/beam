...
filename = '~/Data/GEMINI/2022Feb/BATCH1/events-raw/0.events.SC4a.csv.gz'
...
data_filtered2.to_csv('~/Data/GEMINI/2022Feb/BATCH1/events/filtered.0.events.SC4a.csv.gz')
print("END")
