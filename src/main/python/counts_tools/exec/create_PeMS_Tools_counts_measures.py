...
# This script creates MATSim validation count measures (mean, median, etc) for a range of dates and specific weekdays
...
if __name__ == '__main__':
    ...
    out_prefix = conf.get('Paths', 'out_prefix')  # Where to write the counts file
    ...
    utils.counts.create_PeMS_Tools_counts_measures(station_TS_dir,
                                                   stat_link_map_file,
                                                   date_list,
                                                   counts_name,
                                                   counts_desc,
                                                   counts_year,
                                                   aggregation_list = ['mean', 'median', 'std'],
