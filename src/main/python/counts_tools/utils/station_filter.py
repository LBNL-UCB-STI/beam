...
class StationFilter(object):
    ...
    Many of the filters involve looping through the station linkStartTime series. Adding all the filters first allows us to only
    ...
    def __init__(self, ts_path, meta_path):
        ...
        self.ts_df = None  # DataFrame of single station linkStartTime series
        ...
        # Flags
        self.iter_time_seris = False  # Flag to indicate whether we need to iterate through all the linkStartTime series files,
        # which is expensive
    ...
    def run_filters(self):
        ...
        # Get list of all stations in the linkStartTime series folder
        o_dir = os.getcwd()
