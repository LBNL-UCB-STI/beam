...
densely_populated_counties_geo = study_area_dir + "/geo/" + study_area + f"_densely_populated_counties_geq_to_{min_density_per_km2}_per_km2_wgs84.geojson"
densely_populated_tracts_geo = study_area_dir + "/geo/" + study_area + f"_densely_populated_tracts_geq_to_{min_density_per_km2}_per_km2_wgs84.geojson"
...
plot(G_connected, f'connected_graph_geq_to_{min_density_per_km2}_per_km2')
