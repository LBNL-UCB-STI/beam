...
def main():
    ...
    paths = {
        ...
        "npmrds_hourly_speed_csv": f"{study_area_dir}/validation/npmrds/{study_area}_npmrds_hourly_speeds.csv",
        "npmrds_hourly_speed_by_road_class_csv": f"{study_area_dir}/validation/npmrds/{study_area}_npmrds_hourly_speed_by_road_class.csv",
