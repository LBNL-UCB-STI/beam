...
import beam.transEnergySim.analysis.energyConsumption.EnergyConsumptionOutputLog;
...
//		previousLinkEntered = new HashMap<Id, Id>();
	...
	private void handleEnergyConsumption(Id<Vehicle> vehicleId, Id<Link> linkId, double linkLeaveTime) {
		...
		double energyConsumptionInJoule = vehicle.updateEnergyUse(link.getLength(), averageSpeedDrivenInMetersPerSecond);
