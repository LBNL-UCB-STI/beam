...
public class PreChargeEvent extends Event implements IdentifiableDecisionEvent {
	...
	public PreChargeEvent(double time, PlugInVehicleAgent agent, ChargingPlug plug) {
		super(time);
		this.agent = agent;
