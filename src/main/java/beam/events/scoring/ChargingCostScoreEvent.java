...
public class ChargingCostScoreEvent extends EVScoringEvent implements IdentifiableDecisionEvent {
	...
	public ChargingCostScoreEvent(double time, Id<Person> personId, int decisionEventId, double score) {
