            ...
            for (TransitRoute matsimRoute : matsimLine.getRoutes().values()) {
                ...
                for (Departure matsimDeparture : matsimRoute.getDepartures().values()) {
                    ...
                    for (TransitRouteStop trs : matsimRoute.getStops()) {
                        ...
                        gtfsStopTime.arrival_time = (int) (firstDepartureTime + trs.getArrivalOffset().orElse(Double.NEGATIVE_INFINITY));
                        gtfsStopTime.departure_time = (int) (firstDepartureTime + trs.getDepartureOffset().orElse(Double.NEGATIVE_INFINITY));
