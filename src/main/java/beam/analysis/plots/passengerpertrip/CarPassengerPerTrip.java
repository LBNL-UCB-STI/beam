...
public class CarPassengerPerTrip implements IGraphPassengerPerTrip{
    ...
    public void collectEvent(Event event) {
        ...
        Integer numPassengers = Integer.parseInt(event.getAttributes().get(PathTraversalEvent.ATTRIBUTE_NUM_PASS));
    ...
    public void process(IterationEndsEvent event) throws IOException {
        ...
        System.out.println(this.getClass().getName() + " ->  Count of events collected -> " + eventCounter);
