...
public class TransitionFromDrivingToDriving extends BaseTransition {
	...
	public TransitionFromDrivingToDriving(State fromState, State toState, Boolean isContingent) {
		super(fromState, toState, isContingent);
	}
	public TransitionFromDrivingToDriving(BaseState fromState, BaseState toState, boolean isContingent, GraphVizGraph graph, GraphVizScope scope) {
