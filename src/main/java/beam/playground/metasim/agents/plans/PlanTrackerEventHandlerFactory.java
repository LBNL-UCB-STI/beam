...
public interface PlanTrackerEventHandlerFactory {

	PlanTrackerEventHandler create();

	public class Default implements PlanTrackerEventHandlerFactory {
		...
		@Override
		public PlanTrackerEventHandler create() {
			return new PlanTrackerEventHandler(beamServicesProvider.get());
		}
	}
}
