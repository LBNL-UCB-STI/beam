...
public class BeamRuntimeNotifications {
	...
	private static Logger log = Logger.getLogger(BeamRuntimeNotifications.class);
	...
	BeamRuntimeNotifications(MyRunnable runnable) {
		this.runnable = runnable;
	}

	static void run(MyRunnable runnable) {
		new BeamRuntimeNotifications(runnable).run();
	}
