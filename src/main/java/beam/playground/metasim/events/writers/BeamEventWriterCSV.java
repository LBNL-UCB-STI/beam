...
public class BeamEventWriterCSV extends BeamEventWriterBase {
	IntegerValueHashMap<String> attributeToColumnIndexMapping = new IntegerValueHashMap<>();
	
	public BeamEventWriterCSV(String outfilename, BeamEventLogger eventLogger, MatsimServices services, BeamServices beamServices, Class<?> eventTypeToLog) {
