...
public class BeamEventWriterXML extends BeamEventWriterBase {

	public BeamEventWriterXML(String outfilename, BeamEventLogger beamEventLogger, MatsimServices matsimServices, BeamServices beamServices, Class<?> eventTypeToLog) {
