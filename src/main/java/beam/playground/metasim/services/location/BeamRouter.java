...
public class BeamRouter implements RoutingModule {
...
//			this(EVGlobalData.data.RELAXED_TRAVEL_TIME_FILEPATH,EVGlobalData.data.ROUTER_CACHE_READ_FILEPATH);
		 ...
		 */
		public BeamRouter(String travelTimeFunctionSerialPath, String routerCacheSerialPath){
...
//			}
		 ...
		 */
		public BeamRouter(TravelTimeCalculator ttCalculator){
