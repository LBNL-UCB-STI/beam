...
public class JsonFriendlyEventWriterXML implements EventWriter, BasicEventHandler {
	private final BufferedWriter out;

	public JsonFriendlyEventWriterXML(final String outfilename) {
	 ...
	 * @param stream
	 */
	public JsonFriendlyEventWriterXML(final PrintStream stream ) {
