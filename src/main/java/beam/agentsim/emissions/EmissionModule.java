 ...
 *                                                                         *
 * *********************************************************************** */
package beam.agentsim.emissions;
...
import static beam.agentsim.emissions.EmissionUtils.createIndexFromKey;
...
//		}
    ...
    private void createEmissionHandler() {
        ...
        WarmEmissionAnalysisModule.WarmEmissionAnalysisModuleParameter parameterObject =
                new WarmEmissionAnalysisModule.WarmEmissionAnalysisModuleParameter(avgHbefaWarmTable, detailedHbefaWarmTable, hbefaRoadTrafficSpeeds, warmPollutants,
                        emissionConfigGroup);
        ColdEmissionAnalysisModule.ColdEmissionAnalysisModuleParameter parameterObject2 = new ColdEmissionAnalysisModule.ColdEmissionAnalysisModuleParameter(avgHbefaColdTable, detailedHbefaColdTable, coldPollutants,
                emissionConfigGroup);
    ...
    private void loadRoadTypeMappings() {
        ...
        switch (this.emissionConfigGroup.getHbefaRoadTypeSource()) {
            case fromOsm:
                ...
                roadTypeMapping = OsmHbefaMapping.build();
    ...
    private Map<HbefaWarmEmissionFactorKey, HbefaWarmEmissionFactor> createAvgHbefaWarmTable(URL filename) {
        ...
        try {
            BufferedReader br = IOUtils.getBufferedReader(filename.toString().replaceFirst("file:/", "/"));
