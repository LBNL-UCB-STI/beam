...
/**
 *
 * This is a copy of PointToPointQuery from R5.
 *
 * We are _not_ aiming to keep it mergeable with the R5 version, because we were advised to program against
 * the layer against which this class is programmed.
 *
 * So we are free to edit in in place, remove stuff we don't need,
 * and eventually in-line it fully into our code.
 *
 */
public class BeamPointToPointQuery {
    private static final Logger LOG = LoggerFactory.getLogger(BeamPointToPointQuery.class);
