...
/**
 * An implementation of DominatingList, retaining pareto-optimal paths on linkStartTime and fare.
 */
public class BeamDominatingList implements DominatingList {
    ...
    private boolean betterOrEqual(McRaptorSuboptimalPathProfileRouter.McRaptorState dominator, McRaptorSuboptimalPathProfileRouter.McRaptorState dominatee) {
        ...
        if (dominator.time <= dominatee.time) {
            // this route is as good or better on linkStartTime
    ...
    public boolean add(McRaptorSuboptimalPathProfileRouter.McRaptorState newState) {
        // if it is past the linkStartTime limit, drop it
        ...
        for (Iterator<McRaptorSuboptimalPathProfileRouter.McRaptorState> it = states.iterator(); it.hasNext(); ) {
            ...
            // equal if they both get you on the same red line train - they have the same linkStartTime, and the same fare situation
