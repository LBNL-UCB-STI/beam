...
public class ChargingSitePolicyBlink extends ChargingSitePolicyBasic {

	public ChargingSitePolicyBlink(String extraDataAsXML) throws JDOMException, IOException {
