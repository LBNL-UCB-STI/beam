...
public class ChargingSitePolicyChargePoint extends ChargingSitePolicyBasic {

	public ChargingSitePolicyChargePoint(String extraDataAsXML) throws JDOMException, IOException {
