...
events <- readCsv(pp(freightWorkDir, "/0.events.csv.gz"))
...
## DEBUG
# nrow(freight_pt)
# nrow(freight_pt[grepl("-emergency-",vehicle)])
...
ggsave(pp(freightWorkDir,'/b2c-stops.png'),p,width=9,height=5,units='in')
