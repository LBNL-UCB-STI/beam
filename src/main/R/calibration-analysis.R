...
calib.name <- 'calibration_2017-06-25_23-34-50-1k-agents-v1'
...
both <- join.on(cp,load.all[iter==646 & time>=27 & time<=51],c('time','spatial.group','site.type','charger.type'),c('time','spatial.group','site.type','charger.type'),c('num.plugged.in','charging.load.in.kw'),'pred.')
