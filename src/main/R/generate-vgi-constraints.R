...
# Base
#out.dirs[['base']] <- c('/Users/critter/Documents/beam/beam-output/calibration/calibration_2017-07-31_19-29-25-final-base-for-plexos/',0)

#out.dirs[['morework-100pct']] <- c('/Users/critter/Documents/beam/beam-output/calibration/calibration_2017-11-06_21-28-24-morework100/',0)
out.dirs[['morework-100pct-tou-night']] <- c('/Users/critter/Documents/beam/beam-output/calibration/calibration_2017-11-06_21-28-24-morework100/',0)
out.dirs[['morework-100pct-tou-both']] <- c('/Users/critter/Documents/beam/beam-output/calibration/calibration_2017-11-06_21-28-24-morework100/',0)
#out.dirs[['morework-100pct-sameloc']] <- c('/Users/critter/Documents/beam/beam-output/calibration/calibration_2017-11-07_14-21-26-morework100-sameloc/',0)
out.dirs[['morework-100pct-sameloc-tou-night']] <- c('/Users/critter/Documents/beam/beam-output/calibration/calibration_2017-11-07_14-21-26-morework100-sameloc/',0)
out.dirs[['morework-100pct-sameloc-tou-both']] <- c('/Users/critter/Documents/beam/beam-output/calibration/calibration_2017-11-07_14-21-26-morework100-sameloc/',0)
#out.dirs[['morework-200pct']] <- c('/Users/critter/Documents/beam/beam-output/calibration/calibration_2017-08-05_11-58-25-morework200/',0)
...
for(scen in scens){
  ...
  wdays <- c('Mon'=1,'Tus'=2,'Wed'=3,'Thu'=4,'Fri'=5,'Sat'=6,'Sun'=7)
  ...
  p <- ggplot(virt[day<10],aes(x=hr,y=max/1e6))+geom_line()+geom_line(aes(y=min/1e6),colour='red')+facet_wrap(veh.type~final.type)
  pdf.scale <- .6
...
if(F){
  ...
  for(scen.base in c('morework-100pct','morework-100pct-sameloc')){
    the.utility <- scenarios$Electric.Utility[3]
    pen <- scenarios$penetration[1]
    veh.split <- scenarios$veh.type.split[1]
    reservoirs.max <- list()
