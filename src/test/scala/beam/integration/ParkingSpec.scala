...
class ParkingSpec
  ...
  "Parking system " must {
    ...
    "very expensive parking should reduce driving" taggedAs Retryable in { // flakey test
    ...
    "no parking stalls should reduce driving" taggedAs Retryable in { // flakey test
