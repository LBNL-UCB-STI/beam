...
class NetworkCoordinatorTest extends AnyFunSuite with Matchers {
  ...
  private val highwayType: Network.OverwriteRoadTypeProperties = Network.OverwriteRoadTypeProperties(
    enabled = true,
    livingStreet = OverwriteRoadTypeProperties.LivingStreet(capacity = Some(1), lanes = Some(2), speed = Some(3), alpha = Some(1), beta = Some(2)),
    ...
    motorwayLink = MotorwayLink(capacity = Some(10), lanes = Some(11), speed = Some(12), alpha = Some(1), beta = Some(2)),
    ...
    secondaryLink = SecondaryLink(capacity = Some(25), lanes = Some(26), speed = Some(27), alpha = Some(1), beta = Some(2)),
    tertiary = Tertiary(capacity = Some(28), lanes = Some(29), speed = Some(30), alpha = Some(1), beta = Some(2)),
    tertiaryLink = TertiaryLink(capacity = Some(31), lanes = Some(32), speed = Some(33), alpha = Some(1), beta = Some(2)),
    ...
    unclassified = Unclassified(capacity = Some(40), lanes = Some(41), speed = Some(42), alpha = Some(1), beta = Some(2))
  )
