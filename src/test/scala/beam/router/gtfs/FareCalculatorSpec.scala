...
class FareCalculatorSpec extends WordSpecLike with BeforeAndAfterAll  {

  var fareCalculator: FareCalculator = _

  override def beforeAll: Unit = {
    val fareGTFS: Path = Paths.get("test", "input", "fares")
    fareCalculator = new FareCalculator(fareGTFS.toString)
  }
