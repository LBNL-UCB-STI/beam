...
public class NestedLogitTest extends TestCase {
    ...
    public void testNestedLogit() {
        ...
        String xmlTestString = "<nestedLogit name=\"top\">"
                ...
                + "			<param name=\"linkStartTime\" type=\"MULTIPLIER\">1.0</param>"
