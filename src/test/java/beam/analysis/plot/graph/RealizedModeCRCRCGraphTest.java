...
import static beam.analysis.plot.graph.GraphTestRealizedUtil.createDummySimWithCRCRCXML;
import static org.junit.Assert.assertEquals;

public class RealizedModeCRCRCGraphTest {

    private RealizedModeStats realizedModeStats = new RealizedModeStats();

    @BeforeClass
    public static void setUpCRC() {
        createDummySimWithCRCRCXML();
    }
