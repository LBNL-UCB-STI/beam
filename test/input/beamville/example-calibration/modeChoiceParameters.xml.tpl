        ...
        <multinomialLogit name="mnl">
            <alternative name="car">
                <utility>
                    ...
                    <param name="queueStartTime" type="MULTIPLIER">{{ mnl_car_time }}</param>
                </utility>
            </alternative>
            <alternative name="drive_transit">
                <utility>
                    ...
                    <param name="queueStartTime" type="MULTIPLIER">{{ mnl_drive_transit_time }}</param>
            ...
            <alternative name="walk_transit">
                <utility>
                    ...
                    <param name="queueStartTime" type="MULTIPLIER">{{ mnl_walk_transit_time }}</param>
            ...
            <alternative name="ride_hail">
                <utility>
                    ...
                    <param name="queueStartTime" type="MULTIPLIER">{{ mnl_ride_hail_time }}</param>
                </utility>
            </alternative>
            <alternative name="walk">
                <utility>
                    ...
                    <param name="queueStartTime" type="MULTIPLIER">{{ mnl_walk_time }}</param>
                </utility>
            </alternative>
            <alternative name="bike">
                <utility>
                    ...
                    <param name="queueStartTime" type="MULTIPLIER">{{ mnl_bike_time }}</param>
                </utility>
            </alternative>
        </multinomialLogit>
    </parameters>
