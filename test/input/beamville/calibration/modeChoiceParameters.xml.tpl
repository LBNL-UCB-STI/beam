    ...
    <parameters>
        <multinomialLogit name="mnl">
            ...
            <alternative name="transit">
                <utility>
                    <param name="intercept" type="INTERCEPT">{{ mnl_transit_intercept }}</param>
                    <param name="cost" type="MULTIPLIER">{{ mnl_transit_cost }}</param>
                    <param name="time" type="MULTIPLIER">{{ mnl_transit_time }}</param>
                    <param name="transfer" type="MULTIPLIER">{{ mnl_transit_transfer }}</param>
                </utility>
            </alternative>
