...
You can schedule any Jenkins job for periodic runs. To configure periodic build follow the steps below:
...
4. You have to specify a schedule and follows the similar syntax of cron job as a line consists of 5 fields separated by TAB or whitespace::
...
To schedule once daily every 24 hours for week days we need to specify some thing like::
...
As you specify the schedule, warning would be replaced with a test that describe the schedule.
