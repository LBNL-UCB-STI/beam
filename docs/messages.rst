...
VisualizingApp can convert these files to different diagrams. It creates a `PlantUML`_ files that can be easily converted to pictures. You can run it with gradle with the following command::
