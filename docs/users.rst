...
* matsim.conversion.defaultHouseholdIncome (a double to be used for default household incomes)
...
* beam.routing.r5.mNetBuilder.toCRS = "epsg:26914" (the local EPSG CRS used for distance calculations, should be in units of meters and should be the CRS used in the network, population and shape files)
...
The tools should produce the following outputs
