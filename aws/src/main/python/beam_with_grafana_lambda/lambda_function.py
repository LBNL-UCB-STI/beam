...
write_files:
    ...
    - content: |
          #!/bin/bash
          cd /home/ubuntu/git/beam/metrics2.0
          apt get install docker-compose
          docker-compose up &
      path: /tmp/startGrafanaInfluxDB.sh
    - content: |
...
runcmd:
  ...
  - chmod +x /tmp/startGrafanaInfluxDB.sh
  - echo "starting grafana and influx db"
  - tmp/startGrafanaInfluxDB.sh &
