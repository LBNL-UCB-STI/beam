...
pushd ${BEAM_ROOT}
    ...
    CONFIG_PATH="production/application-sfbay/experiments/ev-fleet-qos-S60/runs/run.chargers_taz-parking_S60_P250_R75_F10k/beam.conf"
    BEAM_OUTPUT="production/application-sfbay/experiments/ev-fleet-qos-S60/runs/run.chargers_taz-parking_S60_P250_R75_F10k/output"
