...
pushd ${BEAM_ROOT}
    ...
    CONFIG_PATH="production/application-sfbay/experiments/ev-fleet-qos-S80/runs/run.chargers_taz-parking_S80_P50_R75_F10k/beam.conf"
    BEAM_OUTPUT="production/application-sfbay/experiments/ev-fleet-qos-S80/runs/run.chargers_taz-parking_S80_P50_R75_F10k/output"
