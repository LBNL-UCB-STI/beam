...
pushd ${BEAM_ROOT}
    ...
    CONFIG_PATH="production/application-sfbay/experiments/ev-fleet-qos-S90/runs/run.chargers_taz-parking_S90_P50_R300_F5k/beam.conf"
    BEAM_OUTPUT="production/application-sfbay/experiments/ev-fleet-qos-S90/runs/run.chargers_taz-parking_S90_P50_R300_F5k/output"
